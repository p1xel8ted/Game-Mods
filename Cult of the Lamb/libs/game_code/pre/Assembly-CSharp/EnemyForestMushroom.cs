...
public class EnemyForestMushroom : BaseMonoBehaviour
{
  ...
  private void Start() => this.StartCoroutine((IEnumerator) this.SpawnIn());
  ...
  private IEnumerator SpawnIn()
  {
    ...
    {
      enemyForestMushroom.Player = GameObject.FindWithTag("Player");
      if ((UnityEngine.Object) enemyForestMushroom.Player != (UnityEngine.Object) null)
  ...
  private void Update() => this.SeperateMushrooms();
