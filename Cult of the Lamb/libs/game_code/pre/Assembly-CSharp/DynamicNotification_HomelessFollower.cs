...
public class DynamicNotification_HomelessFollower : DynamicNotificationData
{
  ...
  {
    if ((double) this.PrevTotalCount == (double) this.TotalCount || !DataManager.Instance.ShowCultFaith || !(bool) (UnityEngine.Object) BaseLocationManager.Instance || !BaseLocationManager.Instance.StructuresPlaced || !BaseLocationManager.Instance.FollowersSpawned)
      return;
