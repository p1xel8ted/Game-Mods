...
public class GraphicsSettings : UISubmenuBase
{
  ...
  private List<string> _lowHigh = new List<string>()
  {
    "UI/Settings/Graphics/QualitySettingsOption/Low",
    "UI/Settings/Graphics/QualitySettingsOption/High"
  };
  private List<string> _lowMediumHigh = new List<string>()
  {
    "UI/Settings/Graphics/QualitySettingsOption/Low",
    "UI/Settings/Graphics/QualitySettingsOption/Medium",
    "UI/Settings/Graphics/QualitySettingsOption/High"
  };
  private List<string> _lowMediumHighUltraCustom = new List<string>()
  {
    "UI/Settings/Graphics/QualitySettingsOption/Low",
    "UI/Settings/Graphics/QualitySettingsOption/Medium",
    "UI/Settings/Graphics/QualitySettingsOption/High",
  ...
  private List<string> _framerateSettings = new List<string>()
  {
    "30",
    "60",
    "<sprite name=\"icon_Infinity\">"
  };
  private List<string> _fullscreenModes = new List<string>()
  {
  ...
  private void Start()
  {
    ...
    foreach (Vector2 availableResolution in ScreenUtilities.GetAvailableResolutions())
      content.Add(availableResolution.ToResolutionString());
  ...
  protected override void OnHideStarted() => this._scrollRect.enabled = false;
