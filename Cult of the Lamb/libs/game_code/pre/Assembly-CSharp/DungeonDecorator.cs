...
public class DungeonDecorator : BaseMonoBehaviour
{
  ...
  private void OnEnable() => DungeonDecorator.instance = this;

  private void OnDisable() => DungeonDecorator.instance = (DungeonDecorator) null;
      ...
      for (int index2 = 0; index2 < this.height; ++index2)
      {
        switch (r.StructuresOld[index1, index2])
        {
          ...
          case 9:
            ...
            break;
          case 10:
            Object.Instantiate<GameObject>(Resources.Load("Prefabs/Environment/Base/Rocks/ROCK_" + (object) Random.Range(0, 3)) as GameObject, GameObject.FindGameObjectWithTag("Structures Layer").transform, true).transform.position = this.gridLayout.CellToWorld(new Vector3Int(index1 - this.width / 2, index2 - this.height / 2, 0)) + this.gridLayout.cellSize / 2f;
            break;
        }
      }
    }
