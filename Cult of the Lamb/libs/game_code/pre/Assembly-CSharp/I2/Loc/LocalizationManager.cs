...
public static class LocalizationManager
{
  ...
  {
    foreach (LanguageSource languageSource in (LanguageSource[]) Resources.FindObjectsOfTypeAll((System.Type) typeof (LanguageSource)))
    {
  ...
  {
    Localize[] objectsOfTypeAll = (Localize[]) Resources.FindObjectsOfTypeAll((System.Type) typeof (Localize));
    int index = 0;
