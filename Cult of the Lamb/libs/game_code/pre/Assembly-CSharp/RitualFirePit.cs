...
public class RitualFirePit : Ritual
{
  ...
  protected override UpgradeSystem.Type RitualType => UpgradeSystem.Type.Ritual_FirePit;
  ...
  private IEnumerator RitualRoutine()
  {
    ...
    KeyboardLightingManager.TransitionAllKeys(Color.black, Color.red, 1.2f);
    ...
    ritualFirePit.fireSFXLoop = AudioManager.Instance.CreateLoop("event:/fire/big_fire", firePit.gameObject, true);
    yield return (object) new WaitForSeconds(1.2f);
    KeyboardLightingManager.TransitionAllKeys(Color.red, Color.red, 4f);
    ...
    KeyboardLightingManager.TransitionAllKeys(Color.red, Color.black, 2f);
    ...
    AudioManager.Instance.PlayOneShot("event:/cooking/fire_start", firePit.gameObject);
    AudioManager.Instance.StopLoop(ritualFirePit.fireSFXLoop);
