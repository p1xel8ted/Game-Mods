...
public class RitualFightpit : Ritual
{
  ...
  protected override UpgradeSystem.Type RitualType => UpgradeSystem.Type.Ritual_Fightpit;
  ...
  private IEnumerator RitualRoutine()
  {
    ...
    followerSelectInstance1.Show(Ritual.GetFollowersAvailableToAttendSermon(), followerSelectionType: ritualFightpit.RitualType);
    ...
    List<FollowerBrain> blackList = new List<FollowerBrain>();
    blackList.Add(RitualFightpit.contestant1.Brain);
    int ritualType = (int) ritualFightpit.RitualType;
    selectMenuController4.Show(availableToAttendSermon, blackList, followerSelectionType: (UpgradeSystem.Type) ritualType);
    UIFollowerSelectMenuController selectMenuController5 = followerSelectInstance2;
    selectMenuController5.OnFollowerSelected = selectMenuController5.OnFollowerSelected + (Action<FollowerInfo>) (followerInfo =>
    {
    ...
    selectMenuController6.OnCancel = selectMenuController6.OnCancel + (System.Action) (() =>
    {
      GameManager.GetInstance().StartCoroutine((IEnumerator) this.RitualFinished(true, -1, -1));
      this.CancelFollowers();
    });
    UIFollowerSelectMenuController selectMenuController7 = followerSelectInstance2;
    selectMenuController7.OnHidden = selectMenuController7.OnHidden + (System.Action) (() => followerSelectInstance2 = (UIFollowerSelectMenuController) null);
