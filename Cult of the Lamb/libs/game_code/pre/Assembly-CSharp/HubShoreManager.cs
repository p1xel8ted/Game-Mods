...
public class HubShoreManager : BaseMonoBehaviour
{
  ...
  private void OnEnable()
  {
    ...
    this.CompleteCrystalQuestConvo.SetActive(ObjectiveManager.HasCustomObjectiveOfType(Objectives.CustomQuestTypes.LighthouseReturn));
  ...
  private void CloseShop() => this.Shop.SetActive(false);
  ...
  public void GiveCrystalQuest()
  {
    ...
    {
      CustomTerm = LocalizationManager.GetTranslation("Objectives/Custom/CrystalForLighthouse")
    });
