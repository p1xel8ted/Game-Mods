  ...
  IDeselectHandler
{
  ...
  public void Init(DoctrineResponse d)
  {
    ...
    this.ResponseText.text = $"\"{LocalizationManager.Sources[0].GetTranslation($"DoctrineUpgradeSystem/{(object) d.SermonCategory}{(object) d.RewardLevel}_Response{(d.isFirstChoice ? (object) "A" : (object) "B")}")}\"";
