...
public class Inteaction_DoorRoomDoor : Interaction
{
  ...
  private void Start()
  {
    ...
    this.Bark.Entries[0].TermToSpeak = $"{LocalizationManager.Sources[0].GetTranslation(this.Bark.Entries[0].TermToSpeak)} - {(object) num1}/4x <sprite name=\"icon_key\">";
  ...
  private IEnumerator EnterTemple()
  {
    ...
    {
      Debug.Log((object) ("ADD ME! " + (object) inteactionDoorRoomDoor.Location));
