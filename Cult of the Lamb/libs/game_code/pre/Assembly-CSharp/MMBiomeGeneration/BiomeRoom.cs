...
public class BiomeRoom
{
  ...
  public int NumConnections
  {
    get
    {
      ...
      if (this.N_Room.Connected)
        ++numConnections;
      if (this.E_Room.Connected)
        ++numConnections;
      if (this.S_Room.Connected)
        ++numConnections;
      if (this.W_Room.Connected)
        ++numConnections;
  ...
  {
    if (PrevRoom != null && (UnityEngine.Object) PrevRoom.GameObject != (UnityEngine.Object) this.GameObject)
