...
public class FollowerTask_Pray : FollowerTask
{
  ...
  public override PriorityCategory GetPriorityCategory(
    ...
    FollowerBrain brain)
  {
    return FollowerRole == FollowerRole.Worshipper ? PriorityCategory.WorkPriority : PriorityCategory.Low;
  }
  ...
  public override void OnDoingBegin(Follower follower)
  {
    ...
    if ((UnityEngine.Object) shrine == (UnityEngine.Object) null)
    {
      ...
      SoulsToDeposit += this._brain.Info.XPLevel;
  ...
  protected IEnumerator GiveDevotionRoutine(BuildingShrine shrine, Follower follower)
  {
    ...
    int SoulsToDeposit = 0;
    SoulsToDeposit += followerTaskPray._brain.Info.XPLevel;
    while (--SoulsToDeposit >= 0)
    {
      SoulCustomTarget.Create(shrine.ReceiveSoulPosition, follower.transform.position, Color.white, (System.Action) (() => this.DepositSoul(1, SoulsToDeposit == 0)), 0.2f);
  ...
  {
    int num = 0 + this._brain.Info.XPLevel;
    while (--num >= 0)
