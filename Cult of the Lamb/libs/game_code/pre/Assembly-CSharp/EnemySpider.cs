...
public class EnemySpider : UnitObject
{
  ...
  protected virtual IEnumerator AttackRoutine()
  {
    ...
    if (!((UnityEngine.Object) enemySpider.TargetEnemy == (UnityEngine.Object) null))
    {
      ...
      while (++CurrentAttack <= enemySpider.NumberOfAttacks)
      {
        ...
        yield return (object) new WaitForSeconds(enemySpider.AttackDuration / enemySpider.Spine.timeScale);
        enemySpider.damageColliderEvents.SetActive(false);
        yield return (object) new WaitForSeconds(0.5f / enemySpider.Spine.timeScale);
      }
      yield return (object) new WaitForSeconds(enemySpider.AttackDuration * 0.5f / enemySpider.Spine.timeScale);
  ...
  private IEnumerator ApplyForceRoutine(GameObject Attacker)
  {
    ...
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) new WaitForSeconds(0.5f / enemySpider.Spine.timeScale);
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
