...
public class UIWeaponCardFeature : BaseMonoBehaviour
{
  ...
  public void Selected(Buttons Button, string Skin)
  {
    ...
    else
    {
      ...
      this.Description.text = TarotCards.LocalisedDescription(buttonsUiCardManager.Card.Type, 0);
    }
  }
  ...
  public void Selected(UICardManagerCard Card, string Skin)
  {
    ...
    else
    {
      ...
      this.Description.text = TarotCards.LocalisedDescription(Card.Card.Type, 0);
    }
  }
}
