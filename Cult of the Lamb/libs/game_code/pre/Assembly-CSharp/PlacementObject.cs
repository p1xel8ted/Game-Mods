...
public class PlacementObject : BaseMonoBehaviour
{
  ...
  private void Start()
  {
    ...
    Addressables.InstantiateAsync((object) this.ToBuildAsset, Vector3.zero, Quaternion.identity, this.transform).Completed += (Action<AsyncOperationHandle<GameObject>>) (obj =>
    {
  ...
  private void OnEnable() => PlacementObject.Instance = this;
