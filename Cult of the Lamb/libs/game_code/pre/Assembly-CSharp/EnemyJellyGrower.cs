...
public class EnemyJellyGrower : EnemyExploder
{
  ...
  private IEnumerator ShootRoutine()
  {
    ...
    while ((double) ++i < (double) enemyJellyGrower.NumberOfShotsToFire)
    {
      ...
      enemyJellyGrower.GrenadeBullet.Play(-1f, Angle, Random.Range(enemyJellyGrower.ShootDistanceRange.x, enemyJellyGrower.ShootDistanceRange.y), Random.Range(enemyJellyGrower.GravSpeed - 0.5f, enemyJellyGrower.GravSpeed + 0.5f));
      randomStartAngle = Mathf.Repeat(randomStartAngle + 360f / enemyJellyGrower.NumberOfShotsToFire, 360f);
