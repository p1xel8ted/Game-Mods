...
public class UIHeartStatue : BaseMonoBehaviour
{
  ...
  private void OnFollowerUpdated(int followerID) => UIHeartStatue.UpdateSpiritHearts();
  ...
  public virtual IEnumerator DoUpgrade()
  {
    ...
    Debug.Log((object) ("DataManager.Instance.ShrineHeart  " + (object) DataManager.Instance.ShrineHeart));
  ...
  public virtual void UpdateDisplayIcons()
  {
    ...
    {
      if ((double) index1 < (double) DataManager.Instance.PLAYER_SPIRIT_TOTAL_HEARTS / 2.0)
