...
#nullable disable
public class ProjectileCircle : BaseMonoBehaviour
{
  [SerializeField]
  ...
  public void InitDelayed(GameObject target, float radius, float shootDelay, System.Action onShoot = null)
  {
    this.projectile = this.GetComponent<Projectile>();
    float degree = 0.0f;
    float num = 360f / (float) this.projectiles.Length;
  ...
  private IEnumerator EnableProjectiles(GameObject target, float delay, System.Action onShoot)
  {
