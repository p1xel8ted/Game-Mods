...
public class Interaction_Missionaries : Interaction
{
  ...
  private void OnBrainAssigned() => this.UpdateSlots();
  ...
  public override void OnSecondaryInteract(StateMachine state)
  {
    ...
    missionMenuInstance.Show(this.StructureInfo.MultipleFollowerIDs);
  ...
  {
    int num = this.StructureInfo.MultipleFollowerIDs.Count + this.transitoningIDs.Count;
    return this.StructureInfo.Type == StructureBrain.TYPES.MISSIONARY && num >= 1 || this.StructureInfo.Type == StructureBrain.TYPES.MISSIONARY_II && num >= 2 || this.StructureInfo.Type == StructureBrain.TYPES.MISSIONARY_III && num >= 3;
  }
