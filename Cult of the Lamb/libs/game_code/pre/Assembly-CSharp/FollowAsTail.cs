...
public class FollowAsTail : BaseMonoBehaviour
{
  ...
  private void Update()
  {
    ...
    else
    {
      if ((Object) this.meshRenderer != (Object) null)
      {
        ...
        if ((Object) this.FollowObject.transform.parent != (Object) null && (Object) this.FollowObject.transform.parent.GetComponent<UnitObject>() != (Object) null)
          this.meshRenderer.enabled = this.FollowObject.gameObject.activeInHierarchy;
        else if ((bool) (Object) this.FollowObject.GetComponent<MeshRenderer>())
          this.meshRenderer.enabled = this.FollowObject.GetComponent<MeshRenderer>().enabled;
      }
      if ((double) Vector3.Distance(this.transform.position, this.FollowObject.position) >= (double) this.Distance)
        this.UpdatePosition();
  ...
  private void OnPoisoned() => this.simpleSpineFlash.Tint(Color.green);
