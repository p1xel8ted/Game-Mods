...
public class UIWeaponCard : BaseMonoBehaviour
{
  ...
  public void Show(TarotCards.TarotCard Card)
  {
    ...
    this.EffectText.text = TarotCards.LocalisedDescription(Card.CardType, 0);
    ...
    {
      this.Spine.material = this.NormalMaterial;
      Debug.Log((object) ("Upgrade Index not set: " + (object) Card.UpgradeIndex));
    }
  ...
  public IEnumerator Play(TarotCards.TarotCard Card, Vector3 Position)
  {
    ...
    uiWeaponCard.EffectText.text = TarotCards.LocalisedDescription(Card.CardType, Card.UpgradeIndex);
