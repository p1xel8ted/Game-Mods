...
public class UICardManager : BaseMonoBehaviour
{
  ...
  private void Start()
  {
    this.SoulsCount.text = "<sprite name=\"icon_spirits\"> " + (object) Inventory.Souls;
  ...
  private void UpdateCard(UICardManager.ButtonsUICardManager CurrentButton)
  {
  ...
  private IEnumerator UnlockCard(
