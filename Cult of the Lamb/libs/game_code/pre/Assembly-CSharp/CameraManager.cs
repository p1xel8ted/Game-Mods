...
public class CameraManager : BaseMonoBehaviour
{
  ...
  private void OnEnable() => CameraManager.instance = this;

  private void Start() => CameraManager.shakeAmount = 0.0f;

  private void Update() => this.DoShake();

  private void TestShake() => CameraManager.shakeCamera(this.TestShakeAmount);
  ...
  private IEnumerator DoShakeCameraForDuration(
    float intensityMin,
    float intensityMax,
    float duration,
    bool StackShakes = true)
