  ...
  protected virtual IEnumerator ActiveRoutine()
  {
    ...
    while (true)
    {
      ...
      else
      {
        ...
        if ((double) (enemyBat.AttackCoolDown -= Time.deltaTime) < 0.0)
        {
...
label_17:
  ...
  protected virtual IEnumerator AttackRoutine()
  {
    ...
    {
      yield return (object) new WaitForSeconds(enemyBat1.postAttackDelay);
  ...
  protected virtual IEnumerator ApplyForceRoutine(GameObject Attacker)
  {
    ...
    yield return (object) new WaitForSeconds(enemyBat.KnockbackDuration);
    enemyBat.DisableForces = false;
  ...
  protected virtual bool ShouldStartCharging() => false;
