...
public class RewardsItem
{
  ...
  private List<RewardsItem.ChestRewards> GoodReward = new List<RewardsItem.ChestRewards>()
  {
  ...
  public InventoryItem.ITEM_TYPE ReturnItemType(RewardsItem.ChestRewards chestRewardType)
  {
    switch (chestRewardType)
    {
      ...
      case RewardsItem.ChestRewards.FOLLOWER_NECKLASE:
        return DataManager.AllNecklaces[UnityEngine.Random.Range(0, DataManager.AllNecklaces.Count)];
      ...
      case RewardsItem.ChestRewards.BASE_DECORATION:
        return DataManager.GetDecorationsAvailableCategory(PlayerFarming.Location) ? InventoryItem.ITEM_TYPE.FOUND_ITEM_DECORATION : InventoryItem.ITEM_TYPE.NONE;
  ...
  {
    return item == InventoryItem.ITEM_TYPE.LOG || item == InventoryItem.ITEM_TYPE.STONE || item == InventoryItem.ITEM_TYPE.GOLD_REFINED || item == InventoryItem.ITEM_TYPE.LOG_REFINED || item == InventoryItem.ITEM_TYPE.STONE_REFINED;
  }
  ...
  public RewardsItem.ChestRewards GetGoodReward(bool includeTarot = true, bool IsBoss = false)
  {
      ...
      switch (goodReward)
      {
        ...
        case RewardsItem.ChestRewards.FOLLOWER_SKIN:
          if (IsBoss)
          {
            ...
            Debug.Log((object) "NO available Skins");
            return RewardsItem.ChestRewards.GOLD;
          }
          continue;
        case RewardsItem.ChestRewards.BASE_DECORATION:
          ...
          Debug.Log((object) "NO available decorations");
          return RewardsItem.ChestRewards.GOLD;
        case RewardsItem.ChestRewards.TAROT:
          if (includeTarot)
    ...
    return RewardsItem.ChestRewards.NONE;
  }
