...
public class EnemyGuardian2 : UnitObject
{
  ...
  private IEnumerator ActivateIE()
  {
    ...
    enemyGuardian2.TargetObject = GameObject.FindWithTag("Player");
  ...
  private IEnumerator ShootRingsTargeted()
  {
    ...
    {
      Projectile component = UnityEngine.Object.Instantiate<ProjectileCircle>(enemyGuardian2.projectilePatternRings, enemyGuardian2.transform.parent).GetComponent<Projectile>();
      ...
      component.GetComponent<ProjectileCircle>().InitDelayed(PlayerFarming.Instance.gameObject, enemyGuardian2.projectilePatternRingsRadius, enemyGuardian2.projectilePatternShootDelay, new System.Action(enemyGuardian2.\u003CShootRingsTargeted\u003Eb__47_0));
  ...
  private IEnumerator ShootRingsScattered()
  {
    ...
    for (int i = 0; (double) i < (double) UnityEngine.Random.Range(enemyGuardian2.projectilePatternScatteredAmount.x, enemyGuardian2.projectilePatternScatteredAmount.y); ++i)
    {
      ...
      // ISSUE: reference to a compiler-generated method
      component.GetComponent<ProjectileCircle>().InitDelayed(i % 4 == 0 ? PlayerFarming.Instance.gameObject : (GameObject) null, enemyGuardian2.projectileScatteredRadius, 0.0f, new System.Action(enemyGuardian2.\u003CShootRingsScattered\u003Eb__48_0));
  ...
  private IEnumerator TeleportAndShoot()
  {
    ...
    while (Loop)
    {
      ...
      while (num++ < 32 /*0x20*/ && (bool) Physics2D.Raycast((Vector2) enemyGuardian2.transform.position, Utils.DegreeToVector2(degree), distance, (int) enemyGuardian2.layerToCheck))
        degree += Mathf.Repeat((float) UnityEngine.Random.Range(0, 360), 360f);
  ...
  private IEnumerator TrapPattern0()
  {
    ...
    while (++i < 10)
    {
      GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(enemyGuardian2.Trap);
