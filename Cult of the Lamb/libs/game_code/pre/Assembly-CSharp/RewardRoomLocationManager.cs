...
public class RewardRoomLocationManager : LocationManager
{
  ...
  [Space]
  [SerializeField]
  private RewardRoomLocationManager.ExtraSpawnable[] extraSpawnables = new RewardRoomLocationManager.ExtraSpawnable[0];
  private PlacementRegion placementRegion;
  private static List<global::StructuresData> createdStructures = new List<global::StructuresData>();
