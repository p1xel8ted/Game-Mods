...
public class Interaction_Lore_Professor : Interaction
{
  ...
  private List<List<Interaction_Lore_Professor.EnemyAndPosition>> Rounds = new List<List<Interaction_Lore_Professor.EnemyAndPosition>>();
  ...
  public override void OnInteract(StateMachine state)
  {
    ...
    this.spoken = true;
    this.Label = "";
    state.GetComponent<PlayerFarming>().GoToAndStop(new GameObject()
    {
      transform = {
