...
public class ExternalTools : IExternalTools
{
  ...
  public void PS4Input_GetSpecialControllerInformation(
    int id,
    int padIndex,
    object controllerInformation)
  {
  }
  ...
  public Vector3 PS4Input_AimGetLastAcceleration(int id) => Vector3.zero;

  public Vector3 PS4Input_AimGetLastGyro(int id) => Vector3.zero;

  public Vector4 PS4Input_AimGetLastOrientation(int id) => Vector4.zero;

  public int PS4Input_AimGetUsersHandles(int maxNumberControllers, int[] handles) => 0;

  public int PS4Input_AimGetUsersHandles2(int maxNumberControllers, int[] handles) => 0;

  public bool PS4Input_AimIsConnected(int id) => false;
  ...
  public int PS4Input_MoveSetLightSphere(int id, int index, int red, int green, int blue) => 0;

  public int PS4Input_MoveSetVibration(int id, int index, int motor) => 0;
