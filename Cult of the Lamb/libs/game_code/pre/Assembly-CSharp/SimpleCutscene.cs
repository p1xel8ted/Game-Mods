...
public class SimpleCutscene : BaseMonoBehaviour
{
  ...
  {
    this.Cutscene.Add(new SimpleCutscene.CutsceneScene("Scene " + (object) (this.Cutscene.Count + 1)));
  }
  ...
  private IEnumerator AnimateRoutine(SimpleCutscene.CutsceneObject c)
  {
    SimpleCutscene simpleCutscene = this;
  ...
  private IEnumerator DestroyAfterDelay(SimpleCutscene.CutsceneObject c, float Duration)
  {
    yield return (object) new WaitForSeconds(Duration);
    UnityEngine.Object.Destroy((UnityEngine.Object) c.Spine.gameObject);
  }

  private IEnumerator MoveRoutine(SimpleCutscene.CutsceneObject c)
  {
    float Progress = 0.0f;
