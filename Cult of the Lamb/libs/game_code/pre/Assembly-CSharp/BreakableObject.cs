...
public class BreakableObject : BaseMonoBehaviour
{
  ...
  private void OnEnable() => BreakableObject.BreakableObjects.Add(this);

  private void OnDisable() => BreakableObject.BreakableObjects.Remove(this);
  ...
  private void Start() => this.HP = this.TotalHP;
  ...
  private IEnumerator HitRoutine(Health h)
  {
    ...
    if (breakableObject.soundMaterial != SoundConstants.SoundMaterial.None)
