...
#nullable disable
public class RitualUnlockCurse : Ritual
{
  private int NumGivingDevotion;

  protected override UpgradeSystem.Type RitualType => UpgradeSystem.Type.Ritual_UnlockCurse;
  ...
  {
    RitualUnlockCurse ritualUnlockCurse = this;
    ...
    ritualUnlockCurse.NumGivingDevotion = 0;
    ...
    while (ritualUnlockCurse.NumGivingDevotion > 0)
    ...
    PlayerFarming.Instance.GetComponent<Rigidbody2D>().velocity = Vector2.zero;
