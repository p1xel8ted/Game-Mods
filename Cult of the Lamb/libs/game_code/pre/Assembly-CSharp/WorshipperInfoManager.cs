  ...
  public void SetOutfit(WorshipperInfoManager.Outfit outfit, bool Hooded)
  {
    ...
    switch (outfit)
    {
      ...
      case WorshipperInfoManager.Outfit.Follower:
        ...
        {
          newSkin.AddSkin(this.Spine.Skeleton.Data.FindSkin("Clothes/Robes_Lvl" + (object) this.v_i.Level));
          break;
        }
        newSkin.AddSkin(this.Spine.Skeleton.Data.FindSkin("Clothes/NoHouse_Lvl" + (object) this.v_i.Level));
        break;
    }
    if (Hooded)
    {
      newSkin.AddSkin(this.Spine.Skeleton.Data.FindSkin("Clothes/Hooded_Lvl" + (object) this.v_i.Level));
      this.IsHooded = true;
    }
    else
      this.IsHooded = false;
