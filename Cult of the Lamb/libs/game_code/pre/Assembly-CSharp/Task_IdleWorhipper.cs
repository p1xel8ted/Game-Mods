...
public class Task_IdleWorhipper : Task
{
  ...
  private IEnumerator DoConversation()
  {
    ...
    if (taskIdleWorhipper.Score >= 2)
    {
      ...
      {
        taskIdleWorhipper.w.SetAnimation($"Conversations/react-{taskIdleWorhipper.GetRelationshipAnimationGoodConversation(taskIdleWorhipper.Relationship.Relationship)}{(object) UnityEngine.Random.Range(1, 4)}", false);
        taskIdleWorhipper.cTarget.w.SetAnimation($"Conversations/react-{taskIdleWorhipper.GetRelationshipAnimationGoodConversation(taskIdleWorhipper.cRelationship.Relationship)}{(object) UnityEngine.Random.Range(1, 4)}", false);
        seconds = 2f;
      }
    ...
    else
    {
      ...
      {
        taskIdleWorhipper.w.SetAnimation($"Conversations/react-{taskIdleWorhipper.GetRelationshipAnimationBadConversation(taskIdleWorhipper.Relationship.Relationship)}{(object) UnityEngine.Random.Range(1, 4)}", false);
        taskIdleWorhipper.cTarget.w.SetAnimation($"Conversations/react-{taskIdleWorhipper.GetRelationshipAnimationBadConversation(taskIdleWorhipper.cRelationship.Relationship)}{(object) UnityEngine.Random.Range(1, 4)}", false);
        seconds = 2f;
      }
  ...
  {
    Speaker.SetAnimation(TalkNice ? $"Conversations/talk-{this.GetRelationshipAnimationGoodConversation(Relationship)}{(object) UnityEngine.Random.Range(1, 4)}" : $"Conversations/talk-{this.GetRelationshipAnimationBadConversation(Relationship)}{(object) UnityEngine.Random.Range(1, 4)}", true);
  ...
  private float HateThreshold => Villager_Info.RelationshipHateThreshold;

  private float FriendThreshold => Villager_Info.RelationshipFriendThreshold;

  private float LoveThreshold => Villager_Info.RelationshipLoveThreshold;
}
