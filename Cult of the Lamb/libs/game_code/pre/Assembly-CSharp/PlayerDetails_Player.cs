...
public class PlayerDetails_Player : BaseMonoBehaviour
{
  ...
  private void OnEnable()
  {
    ...
    if (this.Cards.Count == 0)
      this.InitTrinketCards();
    else
      this.SetTrinketsCards();
    this.GetWeapon();
    this.GetAbility();
  }
  ...
  public void SetTrinketsCards()
  {
    ...
    {
      while (++index < DataManager.Instance.PlayerRunTrinkets.Count)
      {
        if (index < 9)
        {
          Debug.Log((object) DataManager.Instance.PlayerRunTrinkets[index].CardType);
          TarotCards tarotCards = TarotCards.Create(DataManager.Instance.PlayerRunTrinkets[index].CardType, true);
    ...
    {
      while (++index < 9 - DataManager.Instance.PlayerRunTrinkets.Count)
      {
