...
public class Interaction_KeyPieceDungeon : Interaction
{
  ...
  public override void OnInteract(StateMachine state)
  {
    ...
    PlayerFarming.Instance.GoToAndStop(this.PlayerPosition, this.gameObject, GoToCallback: (System.Action) (() => this.StartCoroutine((IEnumerator) this.PlayerPickUpBook())));
  }
