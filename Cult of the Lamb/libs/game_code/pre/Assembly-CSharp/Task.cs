...
public class Task
{
  ...
  public virtual void DoAttack(float AttackRange, StateMachine.State NextState = StateMachine.State.RecoverFromAttack)
  {
    ...
    Addressables.InstantiateAsync((object) "Assets/Prefabs/Enemies/Weapons/Swipe.prefab").Completed += (Action<AsyncOperationHandle<GameObject>>) (obj =>
    {
      ...
      component.Init(Position, (float) Angle, (Health.Team) team, health, (Action<Health, Health.AttackTypes>) null, (float) Radius);
    });
  }
