...
public class DeathCatClone : UnitObject
{
  ...
  private void Reveal() => this.StartCoroutine((IEnumerator) this.RevealIE());
    ...
    Health.AttackFlags AttackFlags)
  {
    ...
    this.StopAllCoroutines();
    this.enabled = false;
    GameManager.GetInstance().StartCoroutine((IEnumerator) this.DieIE());
    if ((bool) (UnityEngine.Object) this.projectileCross)
      GameManager.GetInstance().StartCoroutine((IEnumerator) this.projectileCross.DisableProjectiles());
  ...
  private IEnumerator DieIE()
  {
    ...
    yield return (object) deathCatClone.StartCoroutine((IEnumerator) deathCatClone.DamagedRoutineIE(false));
    ...
    GameManager.GetInstance().OnConversationNew();
    GameManager.GetInstance().OnConversationNext(deathCatClone.gameObject, 14f);
    yield return (object) deathCatClone.StartCoroutine((IEnumerator) deathCatClone.TeleportOutIE());
  ...
  private IEnumerator ShootProjectileRingsIE()
  {
    ...
    {
      Projectile component = UnityEngine.Object.Instantiate<ProjectileCircle>(deathCatClone.projectilePatternRings, deathCatClone.transform.parent).GetComponent<Projectile>();
      ...
      component.GetComponent<ProjectileCircle>().InitDelayed(PlayerFarming.Instance.gameObject, deathCatClone.projectilePatternRingsRadius * 2f, 0.0f);
      yield return (object) new WaitForSeconds(0.5f);
    }
    yield return (object) new WaitForSeconds(0.5f);
  ...
  {
    this.currentAttackRoutine = this.StartCoroutine((IEnumerator) this.ShootProjectileCrossIE());
  }
  ...
  private IEnumerator ShootProjectileCrossIE()
  {
    ...
    deathCatClone.Spine.AnimationState.SetAnimation(0, deathCatClone.shootAnimation, false);
    deathCatClone.Spine.AnimationState.AddAnimation(0, deathCatClone.idleAnimation, true, 0.0f);
    deathCatClone.projectileCross = UnityEngine.Object.Instantiate<ProjectileCross>(deathCatClone.projectilePatternCross, deathCatClone.transform.parent);
    ...
    yield return (object) deathCatClone.StartCoroutine((IEnumerator) deathCatClone.projectileCross.DisableProjectiles());
  ...
  private void ShootProjectileSwirls()
  {
    this.Spine.AnimationState.SetAnimation(0, this.shootAnimation, false);
    this.Spine.AnimationState.AddAnimation(0, this.idleAnimation, true, 0.0f);
    this.currentAttackRoutine = this.StartCoroutine((IEnumerator) this.ShootProjectileSwirlsIE());
  }
  ...
  private IEnumerator ShootProjectileSwirlsIE()
  {
    DeathCatClone deathCatClone = this;
    yield return (object) new WaitForSeconds(0.5f);
    yield return (object) deathCatClone.StartCoroutine((IEnumerator) deathCatClone.swirls.ShootIE());
    yield return (object) new WaitForSeconds(1f);
    deathCatClone.currentAttackRoutine = (Coroutine) null;
  }
  ...
  private void ShootProjectileBouncers()
  {
    this.Spine.AnimationState.SetAnimation(0, this.shootAnimation, false);
    this.Spine.AnimationState.AddAnimation(0, this.idleAnimation, true, 0.0f);
    this.currentAttackRoutine = this.StartCoroutine((IEnumerator) this.ShootProjectileBouncersIE());
  }
  ...
  private IEnumerator ShootProjectileBouncersIE()
  {
    DeathCatClone deathCatClone = this;
    yield return (object) new WaitForSeconds(0.5f);
    yield return (object) deathCatClone.StartCoroutine((IEnumerator) deathCatClone.bouncers.ShootIE());
    deathCatClone.currentAttackRoutine = (Coroutine) null;
  }
  ...
  private void ShootProjectileCircles()
  {
    this.Spine.AnimationState.SetAnimation(0, this.shootAnimation, false);
    this.Spine.AnimationState.AddAnimation(0, this.idleAnimation, true, 0.0f);
    this.StartCoroutine((IEnumerator) this.ShootProjectileCirclesIE());
  }
  ...
  private IEnumerator ShootProjectileCirclesIE()
  {
    DeathCatClone deathCatClone = this;
    yield return (object) new WaitForSeconds(0.5f);
    yield return (object) deathCatClone.StartCoroutine((IEnumerator) deathCatClone.circles.ShootIE());
  ...
  private void ShootProjectileCirclesFast()
  {
    this.Spine.AnimationState.SetAnimation(0, this.shootAnimation, false);
    this.Spine.AnimationState.AddAnimation(0, this.idleAnimation, true, 0.0f);
    this.currentAttackRoutine = this.StartCoroutine((IEnumerator) this.ShootProjectileCirclesFastIE());
  }
  ...
  private IEnumerator ShootProjectileCirclesFastIE()
  {
    DeathCatClone deathCatClone = this;
    yield return (object) new WaitForSeconds(0.5f);
    yield return (object) deathCatClone.StartCoroutine((IEnumerator) deathCatClone.circlesFast.ShootIE());
  ...
  private void ShootProjectilePulse()
  {
    this.Spine.AnimationState.SetAnimation(0, this.shootAnimation, false);
    this.Spine.AnimationState.AddAnimation(0, this.idleAnimation, true, 0.0f);
    this.currentAttackRoutine = this.StartCoroutine((IEnumerator) this.ShootProjectilePulseIE());
  }
  ...
  private IEnumerator ShootProjectilePulseIE()
  {
    DeathCatClone deathCatClone = this;
    yield return (object) new WaitForSeconds(0.5f);
    yield return (object) deathCatClone.StartCoroutine((IEnumerator) deathCatClone.pulse.ShootIE());
    deathCatClone.currentAttackRoutine = (Coroutine) null;
  }
  ...
  private IEnumerator ShootProjectileRingsTripleIE()
  {
    ...
    for (int index = 0; index < UnityEngine.Random.Range(5, 9); ++index)
    {
      ...
      component.GetComponent<ProjectileCircle>().InitDelayed(PlayerFarming.Instance.gameObject, deathCatClone.projectilePatternRingsRadius, shootDelay, new System.Action(deathCatClone.\u003CShootProjectileRingsTripleIE\u003Eb__101_0));
    }
  ...
  {
    this.currentAttackRoutine = this.StartCoroutine((IEnumerator) this.TrapPatternChasePlayerIE());
  }
  ...
  private IEnumerator TrapPatternChasePlayerIE()
  {
    ...
    int i = -1;
    float Dist = 1f;
    deathCatClone.state.facingAngle = Utils.GetAngle(deathCatClone.transform.position, PlayerFarming.Instance.transform.position);
    float facingAngle = deathCatClone.state.facingAngle;
    while (++i < 20)
    {
      GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(deathCatClone.trapPrefab);
      gameObject.GetComponent<TrapSpikesSpawnOthers>();
      float angle = Utils.GetAngle(deathCatClone.transform.position + Position, PlayerFarming.Instance.transform.position);
  ...
  {
    this.currentAttackRoutine = this.StartCoroutine((IEnumerator) this.TrapPattern0IE());
  }
  ...
  {
    this.currentAttackRoutine = this.StartCoroutine((IEnumerator) this.TrapPattern1IE());
  }
  ...
  {
    this.currentAttackRoutine = this.StartCoroutine((IEnumerator) this.TrapPattern2IE());
  }
  ...
  {
    this.currentAttackRoutine = this.StartCoroutine((IEnumerator) this.TrapScatteredIE());
  }
  ...
  private IEnumerator TrapScatteredIE(int c = 0)
  {
    ...
    for (int i = 0; i < UnityEngine.Random.Range(30, 40); ++i)
    {
      ...
      if (rand == i)
        b = PlayerFarming.Instance.transform.position;
      spawnedTrapsPositions.Add(b);
      UnityEngine.Object.Instantiate<GameObject>(deathCatClone.trapPrefab).transform.position = b;
      yield return (object) new WaitForSeconds(0.05f);
    }
    if (c < 3 && UnityEngine.Random.Range(0, 2) == 0)
    {
      deathCatClone.currentAttackRoutine = deathCatClone.StartCoroutine((IEnumerator) deathCatClone.TrapScatteredIE(c + 1));
    }
    else
    {
      yield return (object) new WaitForSeconds(1f);
  ...
  {
    this.currentAttackRoutine = this.StartCoroutine((IEnumerator) this.TeleportAttack0IE());
  }

  private IEnumerator TeleportAttack0IE()
  {
    DeathCatClone deathCatClone = this;
    yield return (object) deathCatClone.StartCoroutine((IEnumerator) deathCatClone.TeleportToPositionIE(deathCatClone.GetPositionAwayFromPlayer()));
    deathCatClone.isMoving = false;
    deathCatClone.Spine.AnimationState.SetAnimation(0, deathCatClone.shootAnimation, false);
    deathCatClone.Spine.AnimationState.AddAnimation(0, deathCatClone.idleAnimation, true, 0.0f);
  ...
  {
    this.currentAttackRoutine = this.StartCoroutine((IEnumerator) this.TeleportAttack1IE());
  }
  ...
  private IEnumerator TeleportAttack1IE()
  {
    ...
    yield return (object) deathCatClone.StartCoroutine((IEnumerator) deathCatClone.TeleportToPositionIE(deathCatClone.GetPositionAwayFromPlayer()));
    deathCatClone.isMoving = false;
    yield return (object) (deathCatClone.currentAttackRoutine = deathCatClone.StartCoroutine((IEnumerator) deathCatClone.ShootProjectileRingsIE()));
    deathCatClone.isMoving = true;
    deathCatClone.currentAttackRoutine = (Coroutine) null;
  }
  ...
  {
    this.currentAttackRoutine = this.StartCoroutine((IEnumerator) this.TeleportAttack12E());
  }
  ...
  private IEnumerator TeleportAttack12E()
  {
    ...
    yield return (object) deathCatClone.StartCoroutine((IEnumerator) deathCatClone.TeleportToPositionIE(deathCatClone.GetPositionAwayFromPlayer()));
    deathCatClone.isMoving = false;
    yield return (object) (deathCatClone.currentAttackRoutine = deathCatClone.StartCoroutine((IEnumerator) deathCatClone.ShootProjectileRingsTripleIE()));
    deathCatClone.isMoving = true;
    deathCatClone.currentAttackRoutine = (Coroutine) null;
  }
  ...
  {
    this.currentAttackRoutine = this.StartCoroutine((IEnumerator) this.TeleportRandomlyIE());
  }
  ...
  private IEnumerator TeleportRandomlyIE(float endDelay = 1f)
  {
    ...
    this.\u003C\u003E1__state = -1;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) deathCatClone.StartCoroutine((IEnumerator) deathCatClone.TeleportToPositionIE(deathCatClone.GetRandomPosition(), endDelay));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
  ...
  private IEnumerator TeleportToPositionIE(Vector3 position, float endDelay = 0.0f)
  {
    ...
    yield return (object) new WaitForSeconds(0.5f);
    yield return (object) deathCatClone.StartCoroutine((IEnumerator) deathCatClone.TeleportInIE());
  ...
  {
    this.currentAttackRoutine = this.StartCoroutine((IEnumerator) this.DamagedRoutineIE(teleportAfter));
  }
  ...
  private IEnumerator DamagedRoutineIE(bool teleportAfter)
  {
    ...
    // ISSUE: reference to a compiler-generated method
    deathCatClone.distortionObject.transform.DOScale(25f, 3.5f).SetEase<TweenerCore<Vector3, Vector3, VectorOptions>>(Ease.Linear).OnComplete<TweenerCore<Vector3, Vector3, VectorOptions>>(new TweenCallback(deathCatClone.\u003CDamagedRoutineIE\u003Eb__131_0));
    yield return (object) new WaitForSeconds(1f);
    ...
    if (teleportAfter)
    {
      deathCatClone.currentAttackRoutine = deathCatClone.StartCoroutine((IEnumerator) deathCatClone.TeleportToPositionIE(Vector3.zero));
