...
public class Interaction_Trader : Interaction
{
  ...
  private void Start()
  {
    ...
    this.TraderInfo = DataManager.Instance.ReturnTrader(this.TraderInfo.location);
  ...
  private void DoSell()
  {
    ...
    UIItemSelectorOverlayController itemSelector = MonoSingleton<UIManager>.Instance.ShowItemSelector(this.TraderInfo.itemsForSale, new ItemSelector.Params()
    {
      Key = this._sellKey,
    ...
    itemSelector.OnItemChosen += (System.Action<InventoryItem.ITEM_TYPE>) (chosenItem =>
    {
      ...
      ResourceCustomTarget.Create(this.gameObject, PlayerFarming.Instance.transform.position, chosenItem, (System.Action) (() => this.FinalizeTransaction(InventoryItem.ITEM_TYPE.BLACK_GOLD, cost)));
