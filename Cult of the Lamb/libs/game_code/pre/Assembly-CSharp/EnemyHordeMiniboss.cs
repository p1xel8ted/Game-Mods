...
public class EnemyHordeMiniboss : UnitObject
{
  ...
  private EnemyHordeMiniboss.SpawnType previousSpawnType;
  private int currentEnemies;

  private int availableEnemyCount => this.maxSpawnAmount - this.currentEnemies;
  ...
  private void SpawnVerticalLine() => this.StartCoroutine((IEnumerator) this.SpawnVerticalLineIE());
