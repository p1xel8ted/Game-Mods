...
public class UICommandFollowerWheel : BaseMonoBehaviour
{
  ...
  private UICommandFollowerWheel.ActivityChoice Closest;
  private float Angle = 4.712389f;
  private float PointerDistance = 310f;
  private float PointerSpeed = 25f;
  private bool Released;

  private Player Input => RewiredInputManager.MainPlayer;
  ...
  private void OnEnable() => UICommandFollowerWheel.Instance = this;
