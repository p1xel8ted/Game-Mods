...
public class UIChoiceCard : BaseMonoBehaviour
{
  ...
  {
    this.CostText.text = this.Reward.Locked ? this.Reward.SubTitle : (this.Reward.Cost == 0 ? "" : $"{FontImageNames.GetIconByType(this.Reward.Currency)}x{(object) this.Reward.Cost}");
