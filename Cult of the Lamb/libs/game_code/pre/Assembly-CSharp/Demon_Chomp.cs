...
public class Demon_Chomp : Demon
{
  ...
  private void Update()
  {
    if ((UnityEngine.Object) this.Master == (UnityEngine.Object) null || !this.Master.gameObject.activeSelf || !this.gameObject.activeSelf || (double) GameManager.DeltaTime == 0.0 || MMConversation.isPlaying)
      return;
