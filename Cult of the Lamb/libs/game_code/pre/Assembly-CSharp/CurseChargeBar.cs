...
public class CurseChargeBar : MonoBehaviour
{
  ...
  public void ShowProjectileCharge(bool requiresCharging)
  {
    ...
    this.AreaOfDamage.transform.localScale = Vector3.one * 1.5f * 2f;
    this.AreaOfDamage.transform.DOScale(Vector3.one * 1.5f, 0.5f).SetEase<TweenerCore<Vector3, Vector3, VectorOptions>>(Ease.OutBack);
