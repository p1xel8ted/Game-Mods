...
public class EnemySpiker : UnitObject
{
  ...
  {
    float num = 100f;
    if ((UnityEngine.Object) PlayerFarming.Instance != (UnityEngine.Object) null && (double) this.ChanceToPathTowardsPlayer > 0.0 && (double) UnityEngine.Random.value < (double) this.ChanceToPathTowardsPlayer && (double) Vector3.Distance(this.transform.position, PlayerFarming.Instance.transform.position) < (double) this.DistanceToPathTowardsPlayer && this.CheckLineOfSight(PlayerFarming.Instance.transform.position, (float) this.DistanceToPathTowardsPlayer))
    {
