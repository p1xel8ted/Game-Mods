...
#nullable disable
public class CharacterBaseSnap : BaseMonoBehaviour
{
  ...
  public void LateUpdate()
  {
    if (!((Object) this.statemachine != (Object) null))
      return;
    this.transform.eulerAngles = new Vector3(0.0f, 0.0f, this.SnapToAngles ? Mathf.Round(this.statemachine.facingAngle / this.angleToSnap) * this.angleToSnap : this.statemachine.facingAngle);
