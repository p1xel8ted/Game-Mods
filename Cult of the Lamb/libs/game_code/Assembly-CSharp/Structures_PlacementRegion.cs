...
public class Structures_PlacementRegion : StructureBrain
{
  ...
  {
    if (this.Data.GridTileLookup != null && this.Data.GridTileLookup.Count != this.Data.Grid.Count)
      this.Data.UpdateDictionaryLookup();
    if (this.Data.GridTileLookup != null && this.Data.GridTileLookup.ContainsKey(Position))
      return this.Data.GridTileLookup[Position];
  ...
  public Structures_Weeds GetWeedAtLocation(Vector2Int Position)
  {
    ...
    {
      Debug.Log((object) $"WEED  {structuresWeeds.Data.GridTilePosition.ToString()}   {structuresWeeds.Data.Position.ToString()}   {Position.ToString()}");
  ...
  public void ClearStructureFromGrid(StructureBrain structure, Vector2Int gridTilePosition)
  {
    ...
    while (++num1 < bounds.x)
    {
      ...
      while (++num2 < bounds.y)
      {
        ...
        if (tileGridTile != null && structure.Data.ID == tileGridTile.ObjectID)
        {
    ...
    bool upgrade = false)
  {
    ...
    while (++num1 < structure.Bounds.x)
    {
      ...
      while (++num2 < structure.Bounds.y)
      {
        ...
        if (tileGridTile != null)
        {
          ...
          tileGridTile.Collapsed = structure.IsCollapsed;
        }
      }
    }
    switch (structure.Type)
    {
      ...
      default:
        ...
        StructureManager.StructureChanged structureAddedToGrid = StructureManager.OnStructureAddedToGrid;
        if (structureAddedToGrid == null)
          break;
        structureAddedToGrid(structure);
        break;
    }
  }
