...
public class Interaction_KeyPieceDungeon : Interaction
{
  ...
  public override void OnInteract(StateMachine state)
  {
    ...
    this.playerFarming.GoToAndStop(this.PlayerPosition, this.gameObject, GoToCallback: (System.Action) (() => this.StartCoroutine(this.PlayerPickUpBook())));
  }
  ...
  [CompilerGenerated]
  public void \u003COnInteract\u003Eb__11_0() => this.StartCoroutine(this.PlayerPickUpBook());
}
