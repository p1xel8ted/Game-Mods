...
public class MysticShopKeeperManager : BaseMonoBehaviour
{
  ...
  public static void Play()
  {
    ...
    MMTransition.Play(MMTransition.TransitionType.ChangeRoom, MMTransition.Effect.BlackFade, MMTransition.NO_SCENE, 1f, "", (System.Action) (() =>
    {
      ...
      MysticShopKeeperManager.Instance.StartCoroutine(MysticShopKeeperManager.Instance.PlayRoutine());
    }));
  }
  ...
  [CompilerGenerated]
  public void \u003CPlayRoutine\u003Eb__22_0() => this.StartCoroutine(this.ConversationCompleted());
}
