...
public class RitualUnlockWeapon : Ritual
{
  ...
  public IEnumerator HeartsOfTheFaithfulRitual()
  {
    ...
    yield return (object) ritualUnlockWeapon.StartCoroutine(ritualUnlockWeapon.WaitFollowersFormCircle());
    ...
    foreach (FollowerBrain followerBrain in Ritual.FollowerToAttendSermon)
    {
      if (followerBrain != null && followerBrain.CurrentTask != null && followerBrain.CurrentTask is FollowerTask_AttendRitual)
      {
        ...
        ritualUnlockWeapon.StartCoroutine(ritualUnlockWeapon.SpawnSouls(followerById.transform.position));
    ...
    yield return (object) ritualUnlockWeapon.StartCoroutine(ritualUnlockWeapon.EmitParticles());
    yield return (object) new WaitForSeconds(0.5f);
    ...
    foreach (FollowerBrain brain in Ritual.FollowerToAttendSermon)
    {
      ...
      num += Delay;
      ritualUnlockWeapon.StartCoroutine(ritualUnlockWeapon.DelayFollowerReaction(brain, Delay));
    }
