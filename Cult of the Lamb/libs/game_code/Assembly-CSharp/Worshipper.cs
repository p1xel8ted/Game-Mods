...
public class Worshipper : TaskDoer
{
  ...
  public ThrowWorshipper throwWorshipper;
  public List<string> EmotionalSpectrum = new List<string>()
  {
  ...
  public float TimedTimer;
  public System.Action TimedCallBack;
  public SimpleSpineAnimator simpleAnimator;
  public float TIME_END_OF_DAY = 1f;
  public float TIME_MORNING = 0.03f;
  public bool MORNING_ASLEEP = true;
  public bool EATEN_DINNNER;
  public bool TRAPPED;
  public float YellTimer;
  public bool _InRitual;
  public float AssignParticles;
  ...
  public float Faith
  {
    ...
    set
    {
      if ((double) value != (double) this.wim.v_i.Faith)
        UITextPopUp.Create(((double) value > (double) this.Faith ? "+" : "") + (value - this.Faith).ToString(), (double) value > (double) this.Faith ? Color.green : Color.red, this.gameObject, new Vector3(0.0f, 2f));
  ...
  public float FearLove
  {
    ...
    set
    {
      if ((double) value != (double) this.wim.v_i.FearLove)
        UITextPopUp.Create(((double) value > (double) this.FearLove ? "+" : "") + (value - this.FearLove).ToString(), (double) value > (double) this.FearLove ? Color.green : Color.red, this.gameObject, new Vector3(0.0f, 2f));
      this.wim.v_i.FearLove = Mathf.Clamp(value, 0.0f, 100f);
    }
  }

  public void OnDissentor(Villager_Info.StatusState State)
  {
    switch (State)
    {
  ...
  public void OnIllness(Villager_Info.StatusState Status)
  {
    switch (Status)
    {
      case Villager_Info.StatusState.Off:
  ...
  public void OnStarve(Villager_Info.StatusState Status)
  {
    switch (Status)
    {
      case Villager_Info.StatusState.Off:
  ...
  public void DissentorUp() => this.wim.v_i.Dissentor += 10f;

  public void DissentorDown() => this.wim.v_i.Dissentor -= 10f;

  public void IllnessUp() => this.wim.v_i.Illness += 10f;

  public void IllnessDown() => this.wim.v_i.Illness -= 10f;

  public void DebugCurrentTask()
  {
    Debug.Log((object) $"current task: {this.CurrentTask?.ToString()}  {(this.CurrentTask != null ? this.CurrentTask.Type.ToString() : "")}");
  }

  public void DebugCurrentState()
  {
    Debug.Log((object) ("Current state " + this.state.CURRENT_STATE.ToString()));
  }

  public void DieFromStarvation() => this.Die();

  public void DieFromIllness() => this.Die();
  ...
  public void RecoveredFromThrow()
  {
    this.state.CURRENT_STATE = StateMachine.State.Idle;
    this.BeingCarried = false;
  }
  ...
  {
    this.StartCoroutine(this.SetAnimationAtEndOfFrame(Animation, Loop));
  }

  public IEnumerator SetAnimationAtEndOfFrame(string Animation, bool Loop)
  {
  ...
  {
    this.StartCoroutine(this.AddAnimationAtEndOfFrame(Animation, Loop));
  }

  public IEnumerator AddAnimationAtEndOfFrame(string Animation, bool Loop)
  {
    yield return (object) new WaitForEndOfFrame();
  ...
  public void SleepAtDwellingOrWonder()
  {
    this.Sleep = 60f;
  ...
  public void PlayNewAssignParticles()
  {
  ...
  [CompilerGenerated]
  public void \u003CGiveItem\u003Eb__80_0()
  {
    this.TimedAnimation("cheer", 1f, (System.Action) (() => this.Dropped()));
  }

  [CompilerGenerated]
  public void \u003CGiveItem\u003Eb__80_1() => this.Dropped();
}
