...
#nullable disable
public class Interaction_FireHeart : Interaction_HeartPickupBase
{
  public float Delay = 1f;
  public string LabelName = "Fire Heart";
  ...
  public override void UpdateLocalisation()
  {
    ...
    this.LabelName = ScriptLocalization.Inventory.FIRE_HEART;
  }
  ...
  public override void OnInteract(StateMachine state)
  {
    ...
    component.FireHearts += (float) (2 * TrinketManager.GetHealthAmountMultiplier(this.playerFarming));
