...
public class PocoJsonSerializerStrategy : IJsonSerializerStrategy
{
  ...
  public static Type[] ArrayConstructorParameterTypes = new Type[1]
  {
    typeof (int)
  };
  public static string[] Iso8601Format = new string[3]
  {
  ...
  public virtual string MapClrMemberNameToJsonFieldName(string clrPropertyName) => clrPropertyName;
  ...
  public virtual IDictionary<string, KeyValuePair<Type, ReflectionUtils.SetDelegate>> SetterValueFactory(
    Type type)
  {
