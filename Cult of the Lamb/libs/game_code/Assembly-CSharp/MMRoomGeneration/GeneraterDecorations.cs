...
public class GeneraterDecorations : BaseMonoBehaviour
{
  ...
  public bool overrideBackSprite;
  public float backSpriteShapeZOffset;
  public Material overrideBackSpriteMaterial;
  public Material roomMeshMaterial;
  public bool createRoomMesh;
  public float spriteBackScaleMultiplier = 1f;
  [Range(0.0f, 1f)]
