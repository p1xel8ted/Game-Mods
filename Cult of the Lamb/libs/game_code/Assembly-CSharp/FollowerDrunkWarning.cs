...
#nullable disable
public class FollowerDrunkWarning : MonoBehaviour, IUpdateManually
{
  ...
  public void OnEnable()
  {
    ...
    FollowerBrainStats.OnDrunkStateChanged += new FollowerBrainStats.StatStateChangedEvent(this.ToggleWarning);
  }
  ...
  {
    if (newState == null || newState.Type != FollowerStateType.Drunk)
      return;
    this.StartCoroutine((IEnumerator) this.Init());
  }
  ...
  public IEnumerator Init()
  {
    ...
    if ((UnityEngine.Object) this.Follower != (UnityEngine.Object) null && this.Follower.Brain != null && this.Follower.Brain.Stats != null)
    {
      ...
      if ((currentState != null ? (currentState.Type == FollowerStateType.Drunk ? 1 : 0) : 0) != 0)
      {
        this.Show();
        yield break;
      }
  ...
  public void Update()
  {
    ...
    if (this.IsPlaying && (UnityEngine.Object) this.ProgressBar != (UnityEngine.Object) null)
    {
      ...
      float num = Mathf.Max(this.Follower.Brain.Stats.Drunk / 100f, 0.1f);
      Color color = this.Gradient.Evaluate(num);
      this.ProgressBar.color = new Color(color.r, color.g, color.b, num);
    }
    else
    {
      if (this.IsPlaying || (double) this.Follower.Brain.Stats.Drunk <= 0.0)
        return;
      this.Show();
    }
  }
