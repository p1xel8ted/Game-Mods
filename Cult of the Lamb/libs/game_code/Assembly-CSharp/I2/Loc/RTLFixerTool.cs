...
public class RTLFixerTool
{
  public static bool showTashkeel = true;
  public static bool useHinduNumbers;

  public static string RemoveTashkeel(string str, out List<TashkeelLocation> tashkeelLocation)
  {
  ...
  public static char[] ReturnTashkeel(char[] letters, List<TashkeelLocation> tashkeelLocation)
  {
  ...
  public static bool IsLeadingLetter(char[] letters, int index)
  {
  ...
  public static bool IsFinishingLetter(char[] letters, int index)
  {
  ...
  public static bool IsMiddleLetter(char[] letters, int index)
  {
