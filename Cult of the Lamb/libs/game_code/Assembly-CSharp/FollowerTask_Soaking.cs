...
#nullable disable
public class FollowerTask_Soaking : FollowerTask
{
  ...
  public override FollowerTaskType Type => FollowerTaskType.Soaking;
  ...
  {
    base.Setup(follower);
    follower.SimpleAnimator.ChangeStateAnimation(StateMachine.State.Idle, "Soaked/idle");
    follower.SimpleAnimator.ChangeStateAnimation(StateMachine.State.Moving, "Soaked/walk");
  }
