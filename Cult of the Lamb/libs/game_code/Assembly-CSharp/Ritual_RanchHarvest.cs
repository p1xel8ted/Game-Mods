...
#nullable disable
public class Ritual_RanchHarvest : Ritual
{
  public static System.Action OnRitualBegun;
  public Vector3 averagePosition;

  public override UpgradeSystem.Type RitualType => UpgradeSystem.Type.Ritual_RanchHarvest;
  ...
  {
    Ritual_RanchHarvest ritualRanchHarvest = this;
    AudioManager.Instance.PlayOneShot("event:/dlc/ritual/shearing_start");
    ...
    BiomeBaseManager.Instance.SpawnAnimal(animal, ChurchFollowerManager.Instance.RitualCenterPosition.position, false, (Interaction_Ranch) null, (Transform) null, (Action<Interaction_Ranchable>) (ranchable =>
    {
      ...
      AudioManager.Instance.PlayOneShot("event:/dlc/ritual/shearing_animal_appear");
    ...
    AudioManager.Instance.PlayOneShot("event:/dlc/ritual/shearing_animal_disappear");
    ...
    DataManager.Instance.LastRanchRitualHarvest = TimeManager.TotalElapsedGameTime;
    CultFaithManager.AddThought(Thought.Cult_RanchHarvest);
    Interaction_TempleAltar.Instance.CloseUpCamera.Reset();
    System.Action onRitualBegun = Ritual_RanchHarvest.OnRitualBegun;
    if (onRitualBegun != null)
      onRitualBegun();
    ritualRanchHarvest.CompleteRitual();
  }
