...
public class FontImageNames
{
  ...
  public const string FishCatfish = "<sprite name=\"icon_FishCatfish\">";
  public const string FishCod = "<sprite name=\"icon_FishCod\">";
  public const string FishPike = "<sprite name=\"icon_FishSpike\">";
  ...
  public const string Poop_Glow = "<sprite name=\"icon_PoopGlow\">";
  public const string Poop_Gold = "<sprite name=\"icon_PoopGold\">";
  public const string Poop_Rainbow = "<sprite name=\"icon_PoopRainbow\">";
  public const string Poop_Devotion = "<sprite name=\"icon_PoopDevotion\">";
  public const string Poop_Rotstone = "<sprite name=\"icon_PoopRotstone\">";
  ...
  public const string BeholderEyeRot = "<sprite name=\"icon_icon_BeholderEyeRot\">";
  ...
  public const string SnowChunk = "<sprite name=\"icon_SnowChunk\">";
  public const string Charcoal = "<sprite name=\"icon_Charcoal\">";
  public const string LightningShard = "<sprite name=\"icon_LightningShard\">";
  public const string MagmaStone = "<sprite name=\"icon_MagmaStone\">";
  public const string Soot = "<sprite name=\"icon_Soot\">";
  public const string ElectrifiedMagma = "<sprite name=\"icon_ElectrifiedMagma\">";
  public const string SilkThread = "<sprite name=\"icon_SilkThread\">";
  public const string Cotton = "<sprite name=\"icon_Cotton\">";
  public const string Hops = "<sprite name=\"icon_Hops\">";
  public const string Grapes = "<sprite name=\"icon_Grapes\">";
  public const string Yolk = "<sprite name=\"icon_Yolk\">";
  public const string SeedCotton = "<sprite name=\"icon_SeedCotton\">";
  public const string SeedHops = "<sprite name=\"icon_SeedHops\">";
  public const string SeedGrapes = "<sprite name=\"icon_SeedGrapes\">";
  public const string SeedSnowFruit = "<sprite name=\"icon_SeedSnowFruit\">";
  public const string SeedChilli = "<sprite name=\"icon_SeedChilli\">";
  public const string SnowFruit = "<sprite name=\"icon_SnowFruit\">";
  public const string SeedSozo = "<sprite name=\"icon_SeedSozo\">";
  public const string PleasurePoint = "<sprite name=\"icon_PleasurePoint\">";
  public const string Wool = "<sprite name=\"icon_Wool\">";
  public const string Wool_LambWar = "<sprite name=\"icon_Wool_LambWar\">";
  public const string Wool_Blacksmith = "<sprite name=\"icon_Wool_Blacksmith\">";
  public const string Wool_Tarot = "<sprite name=\"icon_Wool_Tarot\">";
  public const string Wool_Decoration = "<sprite name=\"icon_Wool_Decoration\">";
  public const string Wool_Rancher = "<sprite name=\"icon_Wool_Rancher\">";
  public const string Wool_6 = "<sprite name=\"icon_Wool_6\">";
  public const string Wool_7 = "<sprite name=\"icon_Wool_7\">";
  public const string Wool_8 = "<sprite name=\"icon_Wool_8\">";
  public const string Wool_9 = "<sprite name=\"icon_Wool_9\">";
  public const string Wool_10 = "<sprite name=\"icon_Wool_10\">";
  public const string Wool_11 = "<sprite name=\"icon_Wool_11\">";
  public const string AnimalGoat = "<sprite name=\"icon_AnimalGoat\">";
  public const string AnimalSpider = "<sprite name=\"icon_AnimalSpider\">";
  public const string AnimalTurtle = "<sprite name=\"icon_AnimalTurtle\">";
  public const string AnimalCrab = "<sprite name=\"icon_AnimalCrab\">";
  public const string AnimalSnail = "<sprite name=\"icon_AnimalSnail\">";
  public const string AnimalCow = "<sprite name=\"icon_AnimalCow\">";
  public const string AnimalLlama = "<sprite name=\"icon_AnimalLlama\">";
  public const string ForgeFlame = "<sprite name=\"icon_wood\">";
  public const string BrokenWeaponHammer = "<sprite name=\"icon_BrokenWeaponHammer\">";
  public const string BrokenWeaponSword = "<sprite name=\"icon_BrokenWeaponSword\">";
  public const string BrokenWeaponDagger = "<sprite name=\"icon_BrokenWeaponDagger\">";
  public const string BrokenWeaponGauntlets = "<sprite name=\"icon_BrokenWeaponGauntlets\">";
  public const string BrokenWeaponChains = "<sprite name=\"icon_BrokenWeaponChains\">";
  public const string BrokenWeaponBlunderbuss = "<sprite name=\"icon_BrokenWeaponBlunderbuss\">";
  public const string FixedWeaponHammer = "<sprite name=\"icon_FixedWeaponHammer\">";
  public const string FixedWeaponSword = "<sprite name=\"icon_FixedWeaponSword\">";
  public const string FixedWeaponDagger = "<sprite name=\"icon_FixedWeaponDagger\">";
  public const string FixedWeaponGauntlets = "<sprite name=\"icon_FixedWeaponGauntlets\">";
  public const string FixedWeaponChains = "<sprite name=\"icon_FixedWeaponChains\">";
  public const string FixedWeaponBlunderbuss = "<sprite name=\"FixedWeaponBlunderbuss\">";
  public const string LegendaryWeaponFragment = "<sprite name=\"icon_LegendaryWeaponFragment\">";
  public const string IllegibleLetterScylla = "<sprite name=\"icon_Letter_Scylla\">";
  public const string IllegibleLetterCharybdis = "<sprite name=\"icon_Letter_Charybdis\">";
  public const string FishingRod = "<sprite name=\"icon_FishingRod\">";
  public const string Bop = "<sprite name=\"icon_Bop\">";
  public const string YewCursed = "<sprite name=\"icon_YewCursed\">";
  public const string YewHoly = "<sprite name=\"icon_YewHoly\">";
  public const string Faith = "<sprite name=\"icon_Faith\">";
  public const string Freezing = "<sprite name=\"icon_Freezing\">";
  public const string FreezingColoured = "<sprite name=\"icon_Freezing2\">";
  public const string Soaking = "<sprite name=\"icon_Soaking\">";
  public const string SoakingColoured = "<sprite name=\"icon_Soaking2\">";
  public const string Overheating = "<sprite name=\"icon_Overheating\">";
  public const string OverheatingColoured = "<sprite name=\"icon_Overheating2\">";
  public const string Special = "<sprite name=\"icon_Special\">";
  public const string Aflame = "<sprite name=\"icon_Overheating\">";
  ...
  public const string Injured = "<sprite name=\"icon_Injured\">";
  public const string Drunk = "<sprite name=\"icon_Drunk\">";
  ...
  public const string MineRotstone = "<sprite name=\"icon_MineRotstone\">";
  ...
  public const string ExtortMoney = "<sprite name=\"icon_ExtortMoney\">";
  public const string Undertaker = "<sprite name=\"icon_Undertaker\">";
  public const string Disciple = "<sprite name=\"icon_Disciple\">";
  public const string Bully = "<sprite name=\"icon_Bully\">";
  public const string Reassure = "<sprite name=\"icon_Reassure\">";
  public const string PetFollower = "<sprite name=\"icon_PetFollower\">";
  ...
  public const string SinDoctrine = "<sprite name=\"icon_SinDoctrine\">";
  public const string SinDoctrineAlt = "<sprite name=\"icon_SinDoctrineAlt\">";
  public const string EyeHide = "<sprite name=\"icon_EyeHide\">";
  public const string EyeShow = "<sprite name=\"icon_EyeShow\">";
  public const string Remove = "<sprite name=\"icon_Remove\">";
  public const string Daycare = "<sprite name=\"icon_Daycare\">";
  public const string Walk = "<sprite name=\"icon_Walk\">";
  public const string Sacrifice = "<sprite name=\"icon_Sacrifice\">";
  public const string Harvest = "<sprite name=\"icon_Harvest\">";
  public const string Logistics = "<sprite name=\"icon_Logistics\">";
  public const string Handyman = "<sprite name=\"icon_Handyman\">";
  public const string TraitManipulator = "<sprite name=\"icon_TraitManipulator\">";
  public const string Winter = "<sprite name=\"icon_Winter\">";
  ...
  public const string MealSpicy = "<sprite name=\"icon_MealSpicy\">";
  public const string MealSnowFruit = "<sprite name=\"icon_MealSnowFruit\">";
  public const string MealBurnt = "<sprite name=\"icon_MealBurnt\">";
  ...
  public const string MealMilkBad = "<sprite name=\"icon_MealMilkBad\">";
  public const string MealMilkGood = "<sprite name=\"icon_MealMilkGood\">";
  public const string MealMilkGreat = "<sprite name=\"icon_MealMilkGreat\">";
  public const string MealEgg = "<sprite name=\"icon_MealEgg\">";
  public const string Milk = "<sprite name=\"icon_Milk\">";
  public const string DrinkBeer = "<sprite name=\"icon_DrinkBeer\">";
  public const string DrinkWine = "<sprite name=\"icon_DrinkWine\">";
  public const string DrinkGin = "<sprite name=\"icon_DrinkGin\">";
  public const string DrinkCocktail = "<sprite name=\"icon_DrinkCocktail\">";
  public const string DrinkMushroomJuice = "<sprite name=\"icon_DrinkMushroomJuice\">";
  public const string DrinkEggnog = "<sprite name=\"icon_DrinkEggnog\">";
  public const string DrinkPoopJuice = "<sprite name=\"icon_DrinkPoopJuice\">";
  public const string DrinkChilli = "<sprite name=\"icon_DrinkChilli\">";
  public const string DrinkLightning = "<sprite name=\"icon_DrinkCharged\">";
  public const string DrinkSin = "<sprite name=\"icon_DrinkSin\">";
  public const string DrinkGrass = "<sprite name=\"icon_DrinkSmoothie\">";
  public const string DrinkMilkshake = "<sprite name=\"icon_DrinkMilkshake\">";
  ...
  public const string Trait_Argumentative = "<sprite name=\"icon_Trait_Argumentative\">";
  public const string Trait_Bastard = "<sprite name=\"icon_Trait_Bastard\">";
  public const string Trait_Scared = "<sprite name=\"icon_Trait_Scared\">";
  public const string Trait_Disciple = "<sprite name=\"icon_Trait_Disciple\">";
  public const string Trait_Lustful = "<sprite name=\"icon_Trait_Lustful\">";
  public const string Trait_Celebate = "<sprite name=\"icon_Trait_Celebate\">";
  public const string Trait_GoldenPooper = "<sprite name=\"icon_Trait_GoldenPooper\">";
  public const string Trait_Terrified = "<sprite name=\"icon_Trait_Terrified\">";
  public const string Trait_Fashionable = "<sprite name=\"icon_Trait_Fashionable\">";
  public const string Trait_BornOfSin = "<sprite name=\"icon_Trait_BornOfSin\">";
  public const string Trait_BlindAllegiance = "<sprite name=\"icon_Trait_BlindAllegiance\">";
  public const string Trait_Hedonism = "<sprite name=\"icon_Trait_Hedonism\">";
  public const string Trait_Asceticism = "<sprite name=\"icon_Trait_Asceticism\">";
  public const string Trait_Unrepentant = "<sprite name=\"icon_Trait_Unrepentant\">";
  public const string Trait_Virtuous = "<sprite name=\"icon_Trait_Virtuous\">";
  public const string Trait_ViolentExtremist = "<sprite name=\"icon_Trait_ViolentExtremist\">";
  public const string Trait_DoctrinalExtremist = "<sprite name=\"icon_Trait_DoctrinalExtremist\">";
  public const string Trait_Mutated = "<sprite name=\"icon_Trait_Mutated\">";
  public const string Trait_Snorer = "<sprite name=\"icon_Trait_Snorer\">";
  public const string Trait_Insomniac = "<sprite name=\"icon_Trait_Insomniac\">";
  public const string Trait_Unlawful = "<sprite name=\"icon_Trait_Unlawful\">";
  public const string Trait_Poet = "<sprite name=\"icon_Trait_Poet\">";
  public const string Trait_ChosenChild = "<sprite name=\"icon_Trait_ChosenChild\">";
  public const string Trait_PureBlood1 = "<sprite name=\"icon_Trait_PureBlood1\">";
  public const string Trait_PureBlood2 = "<sprite name=\"icon_Trait_PureBlood2\">";
  public const string Trait_PureBlood3 = "<sprite name=\"icon_Trait_PureBlood3\">";
  public const string Trait_PureBloodAncestor = "<sprite name=\"icon_Trait_PureBloodAncestor\">";
  public const string Trait_MissionaryInspired = "<sprite name=\"icon_Trait_MissionaryInspired\">";
  public const string Trait_MissionaryTerrified = "<sprite name=\"icon_Trait_MissionaryTerrified\">";
  public const string Trait_MissionaryExcited = "<sprite name=\"icon_Trait_MissionaryExcited\">";
  public const string Trait_Pettable = "<sprite name=\"icon_Trait_Pettable\">";
  public const string Trait_Drowsy = "<sprite name=\"icon_Trait_Drowsy\">";
  public const string Trait_MarriedUnhappily = "<sprite name=\"icon_Trait_MarriedUnhappily\">";
  public const string Trait_MarriedHappily = "<sprite name=\"icon_Trait_MarriedHappily\">";
  public const string Trait_CriminalScarred = "<sprite name=\"icon_Trait_CriminalScarred\">";
  public const string Trait_CriminalReformed = "<sprite name=\"icon_Trait_CriminalReformed\">";
  public const string Trait_Spy = "<sprite name=\"icon_Trait_Spy\">";
  public const string Trait_Polyamory = "<sprite name=\"icon_Trait_Polyamory\">";
  public const string Trait_Zombie = "<sprite name=\"icon_Trait_Zombie\">";
  public const string Trait_ExistentialDread = "<sprite name=\"icon_Trait_ExistentialDread\">";
  public const string Trait_HardenedCriminal = "<sprite name=\"icon_Trait_HardenedCriminal\">";
  public const string Trait_EvangelizingCriminal = "<sprite name=\"icon_Trait_EvangelizingCriminal\">";
  public const string Trait_ProudParent = "<sprite name=\"icon_Trait_ProudParent\">";
  public const string Trait_OverwhelmedParent = "<sprite name=\"icon_Trait_OverwhelmedParent\">";
  public const string Trait_DevotedSpouse = "<sprite name=\"icon_Trait_DevotedSpouse\">";
  public const string Trait_JealousSpouse = "<sprite name=\"icon_Trait_JealousSpouse\">";
  public const string Trait_MurderouslyJealousSpouse = "<sprite name=\"icon_MurderouslyJealousSpouse\">";
  public const string Trait_BishopOfCult = "<sprite name=\"icon_BishopOfCult\">";
  public const string Trait_WarmBlooded = "<sprite name=\"icon_Trait_WarmBlooded\">";
  public const string Trait_ColdBlooded = "<sprite name=\"icon_Trait_ColdBlooded\">";
  public const string Trait_WorkThroughBlizzard = "<sprite name=\"icon_Trait_icon_Trait_WorkThroughBlizzard\">";
  public const string Trait_WinterExcited = "<sprite name=\"icon_Trait_WinterExcited\">";
  public const string Trait_Frigidophile = "<sprite name=\"icon_Trait_Frigidophile\">";
  public const string Trait_ColdEnthusiast = "<sprite name=\"icon_Trait_ColdEnthusiast\">";
  ...
  public const string Chilli = "<sprite name=\"icon_Chilli\">";
  ...
  public const string Necklace_Deaths_Door = "<sprite name=\"icon_Necklace_Deaths_Door\">";
  public const string Necklace_Winter = "<sprite name=\"icon_Necklace_Winter\">";
  public const string Necklace_Frozen = "<sprite name=\"icon_Necklace_Frozen\">";
  public const string Necklace_Weird = "<sprite name=\"icon_Necklace_Weird\">";
  public const string Necklace_Targeted = "<sprite name=\"icon_Necklace_Targeted\">";
  public const string Gift_Small = "<sprite name=\"icon_GiftSmall\">";
  public const string Gift_Medium = "<sprite name=\"icon_GiftMedium\">";
  public const string Necklace_Bell = "<sprite name=\"icon_Necklace_Bell\">";
  public const string RemoveNecklace = "<sprite name=\"icon_Necklace1\">";
  public const string Yngya_Ghost = "<sprite name=\"icon_YngyaGhost\">";
  ...
  public const string UIHeartIce = "<sprite name=\"icon_UIHeartIce\">";
  public const string UIHeartFire = "<sprite name=\"icon_UIHeartFire\">";
  ...
  public const string Animals = "<sprite name=\"icon_Animals\">";
  ...
  public const string NextArrow = "<sprite name=\"icon_NextArrow\">";
  public const string PrevArrow = "<sprite name=\"icon_PrevArrow\">";
  public static Color FundamentalistColor = new Color(1f, 0.8235294f, 0.003921569f);
  public static Color UtopianistColor = new Color(0.0f, 0.8078431f, 0.5960785f);
  public static Color MisfitColor = new Color(0.945098f, 0.0f, 0.1098039f);
  public static Color TextColor = new Color(0.9960784f, 0.9411765f, 0.827451f);
  public static Color TextRedColor = new Color(0.9960784f, 0.0f, 0.0f);
  ...
  public static string IconForRole(FollowerRole followerRole)
  {
    switch (followerRole)
    {
      case FollowerRole.Worshipper:
        return FontImageNames.IconForCommand(FollowerCommands.WorshipAtShrine);
      case FollowerRole.Lumberjack:
        return FontImageNames.IconForCommand(FollowerCommands.CutTrees);
      case FollowerRole.Farmer:
        return FontImageNames.IconForCommand(FollowerCommands.Farmer_2);
      case FollowerRole.Monk:
        return FontImageNames.IconForCommand(FollowerCommands.Study);
      case FollowerRole.StoneMiner:
        return FontImageNames.IconForCommand(FollowerCommands.ClearRubble);
      case FollowerRole.Builder:
        return FontImageNames.IconForCommand(FollowerCommands.Build);
      case FollowerRole.Forager:
      case FollowerRole.Berries:
        return FontImageNames.IconForCommand(FollowerCommands.ForageBerries);
      case FollowerRole.Chef:
        return FontImageNames.IconForCommand(FollowerCommands.Cook_2);
      case FollowerRole.Janitor:
        return FontImageNames.IconForCommand(FollowerCommands.Janitor_2);
      case FollowerRole.Refiner:
        return FontImageNames.IconForCommand(FollowerCommands.Refiner_2);
      case FollowerRole.Undertaker:
        return FontImageNames.IconForCommand(FollowerCommands.Undertaker);
      case FollowerRole.Bartender:
        return FontImageNames.IconForCommand(FollowerCommands.Brew);
      case FollowerRole.Medic:
        return FontImageNames.IconForCommand(FollowerCommands.Medic);
      case FollowerRole.Rancher:
        return FontImageNames.IconForCommand(FollowerCommands.Rancher);
      case FollowerRole.RotstoneMiner:
        return FontImageNames.IconForCommand(FollowerCommands.MineRotstone);
      default:
        return "";
    }
  }
  ...
  public static string IconForCommand(FollowerCommands followerCommands)
  {
    switch (followerCommands)
    {
      ...
      case FollowerCommands.ExtortMoney:
        return "<sprite name=\"icon_ExtortMoney\">";
      ...
      case FollowerCommands.NextPage:
        return "<sprite name=\"icon_NextArrow\">";
      ...
      case FollowerCommands.MealBurnt:
        return "<sprite name=\"icon_MealBurnt\">";
      case FollowerCommands.Bully:
        return "<sprite name=\"icon_Bully\">";
      case FollowerCommands.Reassure:
        return "<sprite name=\"icon_Reassure\">";
      ...
      case FollowerCommands.Handyman:
        return "<sprite name=\"icon_Handyman\">";
      case FollowerCommands.FeedAnimal:
        return "\uF623";
      case FollowerCommands.TraitManipulator:
        return "<sprite name=\"icon_TraitManipulator\">";
      case FollowerCommands.DrinkChilli:
        return "<sprite name=\"icon_DrinkChilli\">";
      case FollowerCommands.DrinkLightning:
        return "<sprite name=\"icon_DrinkCharged\">";
      case FollowerCommands.DrinkSin:
        return "<sprite name=\"icon_DrinkSin\">";
      case FollowerCommands.DrinkGrass:
        return "<sprite name=\"icon_DrinkSmoothie\">";
      case FollowerCommands.PrevPage:
        return "<sprite name=\"icon_PrevArrow\">";
      ...
      case FollowerCommands.NameAnimal:
        return "\uF5B7";
      case FollowerCommands.KillAnimal:
        return "\uF6F5";
      case FollowerCommands.InteractAnimal:
        return "\uF0A1";
      ...
      case FollowerCommands.Give_Turtle_Pet:
        return "<sprite name=\"icon_AnimalTurtle\">";
      case FollowerCommands.Give_Animal_Pet:
        return "<sprite name=\"icon_AnimalGoat\">";
      ...
      case FollowerCommands.FeedChilli:
        return "<sprite name=\"icon_Chilli\">";
      case FollowerCommands.FeedSnowFruit:
        return "<sprite name=\"icon_SnowFruit\">";
      case FollowerCommands.Calm:
        return "\uE05D";
      case FollowerCommands.MineRotstone:
        return "<sprite name=\"icon_MineRotstone\">";
      case FollowerCommands.MilkAnimal:
        return "\uF6C8";
      case FollowerCommands.DrinkMilkshake:
        return "<sprite name=\"icon_DrinkMilkshake\">";
      case FollowerCommands.Heal:
        return "<sprite name=\"icon_Injured\">";
      default:
        throw new ArgumentOutOfRangeException(nameof (followerCommands), (object) followerCommands, (string) null);
    }
  }
  ...
  public struct FollowerCommand
  {
    ...
    public const string RemoveItem = "<sprite name=\"icon_Remove\">";
    public const string Hide = "<sprite name=\"icon_EyeHide\">";
    public const string Show = "<sprite name=\"icon_EyeShow\">";
    public const string Bully = "<sprite name=\"icon_Bully\">";
    public const string Reassure = "<sprite name=\"icon_Reassure\">";
    public const string Ride = "\uF8C0";
    public const string FollowPlayer = "\uE1A1";
    public const string Walk = "<sprite name=\"icon_Walk\">";
    public const string Harvest = "\uF0C4";
    public const string MilkAnimal = "\uF6C8";
    public const string NameAnimal = "\uF5B7";
    public const string Logistics = "<sprite name=\"icon_Logistics\">";
    public const string Clean = "\uF2CC";
    public const string Talk = "\uF075";
    public const string MakeDemand = "\uF0A1";
    public const string BedRest = "\uE074";
    public const string Slaughter = "<sprite name=\"icon_Sacrifice\">";
    ...
    public const string SendToDaycare = "<sprite name=\"icon_Daycare\">";
    ...
    public const string RotstoneMiner = "<sprite name=\"icon_MineRotstone\">";
    public const string Undertaker = "<sprite name=\"icon_Undertaker\">";
    ...
    public const string Brew = "\uE0B3";
    public const string Rancher = "\uF8C0";
    public const string NextPage = "<sprite name=\"icon_NextArrow\">";
    public const string PrevPage = "<sprite name=\"icon_PrevArrow\">";
    public const string Meal = "<sprite name=\"icon_Meal\">";
    public const string MealGrass = "<sprite name=\"icon_MealGrass\">";
    public const string MealPoop = "<sprite name=\"icon_MealPoop\">";
    public const string MealGoodFish = "<sprite name=\"icon_MealGoodFish\">";
    ...
    public const string GodTear = "<sprite name=\"icon_GodTear\">";
    public const string Medic = "\uE3B2";
    public const string FavouriteFood = "\uF004";
  }
}
