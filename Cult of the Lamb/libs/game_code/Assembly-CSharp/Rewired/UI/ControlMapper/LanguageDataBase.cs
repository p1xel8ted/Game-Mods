...
public abstract class LanguageDataBase : ScriptableObject
{
  ...
  public abstract string GetControllerAssignmentConflictWindowMessage(
    string joystickName,
  ...
  public abstract string GetJoystickElementAssignmentPollingWindowMessage_FullAxisFieldOnly(
    string actionName);
  ...
  public abstract string GetMouseElementAssignmentPollingWindowMessage_FullAxisFieldOnly(
    string actionName);
  ...
  public abstract string GetMouseAssignmentConflictWindowMessage(
    string otherPlayerName,
  ...
  public abstract string GetElementIdentifierName(
