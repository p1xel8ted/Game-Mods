...
public class Window : MonoBehaviour
{
  ...
  public List<TMP_Text> _contentText;
  ...
  public TMP_Text titleText => this._titleText;

  public List<TMP_Text> contentText => this._contentText;
  ...
  {
    TMP_Text textComponent = (TMP_Text) null;
    ...
    Vector2 offset)
  {
    ...
    {
      GameObject gameObject = UITools.InstantiateGUIObject<TMP_Text>(prefab, this.content.transform, name, (Vector2) pivot, anchor.min, anchor.max, offset);
