...
[AddComponentMenu("")]
public class CustomButton : UnityEngine.UI.Button, ICustomSelectable, ICancelHandler, IEventSystemHandler
{
  [SerializeField]
  ...
  public override void OnSubmit(BaseEventData eventData)
  {
    ...
    else
    {
      ...
      this.StartCoroutine((IEnumerator) this.OnFinishSubmit());
    }
  }

  public new IEnumerator OnFinishSubmit()
  {
    CustomButton customButton = this;
    float fadeTime = customButton.colors.fadeDuration;
    ...
    customButton.DoStateTransition(customButton.currentSelectionState, false);
  }
