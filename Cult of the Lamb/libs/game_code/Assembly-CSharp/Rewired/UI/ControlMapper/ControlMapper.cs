...
public class ControlMapper : MonoBehaviour
{
  ...
  public Rewired.InputManager _rewiredInputManager;
  [SerializeField]
  ...
  public LanguageDataBase _language;
  [SerializeField]
  ...
  public System.Action _ThemeAppliedEvent;
  [SerializeField]
  ...
  [NonSerialized]
  public List<ThemedElement> themedElements = new List<ThemedElement>();
  [NonSerialized]
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            List<Rewired.UI.ControlMapper.ControlMapper.MappingSet> mappingSetList = new List<Rewired.UI.ControlMapper.ControlMapper.MappingSet>(this._mappingSets.Length);
            for (int index = 0; index < this._mappingSets.Length; ++index)
            {
              ...
              if (mappingSet != null && mappingSet.isValid)
                mappingSetList.Add(mappingSet);
            }
            this._mappingSets = mappingSetList.ToArray();
    ...
    bool disableFullAxis)
  {
    ...
    for (int fieldIndex = 0; fieldIndex < cols; ++fieldIndex)
    {
      ...
      inputField.SetFirstChildObjectWidth(Rewired.UI.ControlMapper.ControlMapper.LayoutElementSizeType.MinSize, 0);
    ...
    int fieldIndex)
  {
    ...
    if ((UnityEngine.Object) inputField.fieldInfo.glyphOrText != (UnityEngine.Object) null)
      inputField.fieldInfo.glyphOrText.allowedTypes = this._showGlyphs ? ControllerElementGlyphBase.AllowedTypes.All : ControllerElementGlyphBase.AllowedTypes.Text;
    return inputField;
  }
  ...
  public void Close(bool save)
  {
    ...
    this.SetUISelection((GameObject) null);
    if ((UnityEngine.Object) Rewired.UI.ControlMapper.ControlMapper.Instance == (UnityEngine.Object) this)
    ...
    int actionElementMapId)
  {
    if (this.currentPlayer == null || !(this.GetControllerMap(controllerType) is ControllerMapWithAxes controllerMap))
      return;
    ActionElementMap elementMap = ((ControllerMap) controllerMap).GetElementMap(actionElementMapId);
    if (elementMap == null)
      return;
  ...
  {
    for (int index = 0; index < this.themedElements.Count; ++index)
    {
      if (this.themedElements != null)
        this.themedElements[index].ApplyTheme();
    }
  }

  public static void Register(ThemedElement themedElement)
  {
    if ((UnityEngine.Object) themedElement == (UnityEngine.Object) null || (UnityEngine.Object) Rewired.UI.ControlMapper.ControlMapper.Instance == (UnityEngine.Object) null || Rewired.UI.ControlMapper.ControlMapper.Instance.themedElements.Contains(themedElement))
      return;
    Rewired.UI.ControlMapper.ControlMapper.Instance.themedElements.Add(themedElement);
  }

  public static void Unregister(ThemedElement themedElement)
  {
    if ((UnityEngine.Object) themedElement == (UnityEngine.Object) null || (UnityEngine.Object) Rewired.UI.ControlMapper.ControlMapper.Instance == (UnityEngine.Object) null)
      return;
    Rewired.UI.ControlMapper.ControlMapper.Instance.themedElements.Remove(themedElement);
  }
  ...
  public static Rewired.UI.ControlMapper.ControlMapper current => Rewired.UI.ControlMapper.ControlMapper.Instance;
  ...
  public class GUILabel
  {
    ...
    [CompilerGenerated]
    public TMP_Text \u003Ctext\u003Ek__BackingField;
    [CompilerGenerated]
    public RectTransform \u003CrectTransform\u003Ek__BackingField;
  ...
  public class InputMapping
  {
    ...
    public ElementAssignment ToElementAssignment()
    {
      ...
      int num1 = this.fieldInfo.axisRange == AxisRange.Negative ? 1 : 0;
      int num2 = this.aem != null ? this.aem.id : -1;
      return new ElementAssignment((ControllerType) controllerType, (ControllerElementType) elementType, elementIdentifierId, (AxisRange) axisRange, (KeyCode) keyboardKey, (ModifierKeyFlags) modifierKeyFlags, actionId, (Pole) num1, false, num2);
    }
  }
