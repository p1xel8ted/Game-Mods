...
label_9:
  ...
  public static void TryStopFollowerFight(int participantID0, int participantID1)
  {
    ...
    foreach (FollowerBrain allBrain in FollowerBrain.AllBrains)
    {
      if (!FollowerManager.FollowerLocked(in allBrain._directInfoAccess.ID) && allBrain.Info.CursedState == Thought.None && allBrain.Location == FollowerLocation.Base && allBrain.HasTrait(FollowerTrait.TraitType.Pacifist))
        followerBrainList.Add(allBrain);
    }
