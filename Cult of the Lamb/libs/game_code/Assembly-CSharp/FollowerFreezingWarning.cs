...
#nullable disable
public class FollowerFreezingWarning : MonoBehaviour, IUpdateManually
{
  ...
  public void OnEnable()
  {
    ...
    FollowerBrainStats.OnFreezingStateChanged += new FollowerBrainStats.StatStateChangedEvent(this.ToggleWarning);
  }
  ...
  {
    if (newState == null || newState.Type != FollowerStateType.Freezing)
      return;
    this.StartCoroutine((IEnumerator) this.Init());
  }
  ...
  public IEnumerator Init()
  {
    ...
    if ((UnityEngine.Object) this.Follower != (UnityEngine.Object) null && this.Follower.Brain != null && this.Follower.Brain.Stats != null)
    {
      ...
      if ((currentState != null ? (currentState.Type == FollowerStateType.Freezing ? 1 : 0) : 0) != 0)
        this.Show();
    }
  }
  ...
  {
    if ((UnityEngine.Object) this.Follower != (UnityEngine.Object) null && this.Follower.Brain != null && this.Follower.Brain.Info.CursedState == Thought.Freezing)
      this.Show();
    else
      this.Hide();
  }
  ...
  public void Update()
  {
    ...
    if ((double) this.Follower.Brain.Stats.Freezing <= 0.0)
      this.Container.SetActive(false);
    else if (this.IsPlaying && (UnityEngine.Object) this.ProgressBar != (UnityEngine.Object) null)
    {
      this.delayTimer -= Time.deltaTime;
      if ((double) this.delayTimer > 0.0)
        return;
      this.delayTimer = 0.6f;
      float num = Mathf.Max(this.Follower.Brain.Stats.Freezing / 100f, 0.1f);
      Color color = this.Gradient.Evaluate(num);
      this.ProgressBar.color = new Color(color.r, color.g, color.b, num);
    }
    else
    {
      if (this.IsPlaying || (double) this.Follower.Brain.Stats.Freezing <= 0.0)
        return;
      this.Show();
    }
  }
