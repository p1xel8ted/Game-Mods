...
public class Ritual : BaseMonoBehaviour
{
  ...
  public IEnumerator CentreAndAnimatePlayer()
  {
    ...
    if (num != 0)
    {
      ...
      ritual.StartCoroutine(ritual.CentrePlayer());
      return false;
    }
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = -1;
  ...
  public IEnumerator WaitFollowersFormCircle(bool ignoreDissenters = false, bool putOnHoods = true, float zoom = 12f)
  {
    ...
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) ritual.StartCoroutine(ritual.FollowersEnterForRitualRoutine(ignoreDissenters, putOnHoods));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
