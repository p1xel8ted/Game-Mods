...
// Type: FollowerTask_ReactClothing
...
#nullable disable
public class FollowerTask_ReactClothing : FollowerTask
{
  public int _followerID;
  public Follower _follower;

  public override FollowerTaskType Type => FollowerTaskType.ReactClothing;
  ...
  public FollowerTask_ReactClothing(int followerID)
  {
  ...
  {
    base.OnEnd();
    CultFaithManager.AddThought(Thought.ReactClothing, this._brain.Info.ID, 1f, this._brain.Info.Name);
  }
