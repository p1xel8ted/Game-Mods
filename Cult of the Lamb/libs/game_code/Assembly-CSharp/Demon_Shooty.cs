...
{
  public static List<Demon_Shooty> RotDemons = new List<Demon_Shooty>();
  public float AttackProgress;
  public float AttackAngle;
  public float AttackDelay;
  public SimpleSpineAnimator simpleSpineAnimator;
  public bool BombDropper;
  [SerializeField]
  public float baseBombCooldown = 8f;
  [SerializeField]
  public float bombCooldownReductionPerLevel = 0.15f;
  public float bombCooldown;
  public float bombTimer;
  public string upgradedSkin = "Projectile+";
  ...
  {
    Demon_Arrows.Demons.Add(this.gameObject);
    if (!this.BombDropper)
      return;
    Demon_Shooty.RotDemons.Add(this);
  }

  public void OnDisable()
  {
    Demon_Arrows.Demons.Remove(this.gameObject);
    if (!this.BombDropper)
      return;
    Demon_Shooty.RotDemons.Remove(this);
  }
  ...
  public override IEnumerator SetSkin()
  {
    ...
    {
      demonShooty.spine.skeleton.SetSkin(demonShooty.upgradedSkin);
  ...
  public void Update()
  {
    ...
    if (this.state.CURRENT_STATE == StateMachine.State.Idle || this.state.CURRENT_STATE == StateMachine.State.Moving)
    {
      ...
      if ((double) (this.AttackDelay += Time.deltaTime) > (double) this.attackDelay)
      {
    ...
    switch (this.state.CURRENT_STATE)
    {
      ...
      case StateMachine.State.SignPostAttack:
        ...
        if ((double) (this.state.Timer += Time.deltaTime) > 0.5)
        {
          ...
          if (this.BombDropper && (double) this.bombTimer >= (double) this.bombCooldown)
          {
            this.bombTimer = 0.0f;
            AudioManager.Instance.PlayOneShot("event:/dlc/tarot/rotdemon_bomb_spawn", this.transform.position);
            Bomb.CreateBomb(this.transform.position, this.MasterHealth, this.transform.parent, (float) this.Level);
          }
          else
            Addressables_wrapper.InstantiateAsync((object) "Assets/Prefabs/Enemies/Weapons/ArrowPlayer.prefab", this.spine.transform.position, Quaternion.identity, this.transform.parent, (Action<AsyncOperationHandle<GameObject>>) (obj =>
            {
  ...
  [CompilerGenerated]
  public void \u003CUpdate\u003Eb__30_0(AsyncOperationHandle<GameObject> obj)
  {
    if (LetterBox.IsPlaying)
      return;
    Projectile component = obj.Result.GetComponent<Projectile>();
