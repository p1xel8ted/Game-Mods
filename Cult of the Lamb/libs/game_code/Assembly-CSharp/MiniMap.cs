...
public class MiniMap : BaseMonoBehaviour
{
  ...
  public void OnChangeRoom()
  {
    ...
    if (!this.MoveMap || !((Object) this.CurrentIcon != (Object) null))
      return;
    this.StartCoroutine(this.MoveMiniMap(0.7f));
  }
  ...
  public void OnTrinketAdded(TarotCards.Card trinketAdded, PlayerFarming playerFarming = null)
  {
    this.CheckTelescope();
  }

  public void CheckTelescope(PlayerFarming playerFarming = null)
  {
  ...
  public Sprite GetImage(BiomeRoom room) => room.IsCustom ? this.Room_Snake : this.Room;
