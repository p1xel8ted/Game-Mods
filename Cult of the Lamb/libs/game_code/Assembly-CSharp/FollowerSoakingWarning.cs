...
#nullable disable
public class FollowerSoakingWarning : MonoBehaviour, IUpdateManually
{
  ...
  public void OnEnable()
  {
    ...
    FollowerBrainStats.OnSoakingStateChanged += new FollowerBrainStats.StatStateChangedEvent(this.ToggleWarning);
  }
  ...
  {
    if (newState == null || newState.Type != FollowerStateType.Soaked)
      return;
    this.StartCoroutine((IEnumerator) this.Init());
  }
  ...
  public IEnumerator Init()
  {
    ...
    if ((UnityEngine.Object) this.Follower != (UnityEngine.Object) null && this.Follower.Brain != null && this.Follower.Brain.Stats != null)
    {
      ...
      if ((currentState != null ? (currentState.Type == FollowerStateType.Soaked ? 1 : 0) : 0) != 0)
        this.Show();
    }
  }
  ...
  {
    if ((UnityEngine.Object) this.Follower != (UnityEngine.Object) null && this.Follower.Brain != null && this.Follower.Brain.Info.CursedState == Thought.Soaking)
      this.Show();
    else
      this.Hide();
  }
  ...
  public void Update()
  {
    ...
    if (this.IsPlaying && (UnityEngine.Object) this.ProgressBar != (UnityEngine.Object) null)
    {
      ...
      float num = Mathf.Max(this.Follower.Brain.Stats.Soaking / 100f, 0.1f);
      Color color = this.Gradient.Evaluate(num);
      this.ProgressBar.color = new Color(color.r, color.g, color.b, num);
    }
    else
    {
      if (this.IsPlaying || (double) this.Follower.Brain.Stats.Soaking <= 0.0)
        return;
      this.Show();
    }
  }
