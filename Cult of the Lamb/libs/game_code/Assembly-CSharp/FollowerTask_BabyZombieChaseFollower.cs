...
// Type: FollowerTask_BabyZombieChaseFollower
...
#nullable disable
public class FollowerTask_BabyZombieChaseFollower : FollowerTask
{
  public FollowerTask_BabyZombieChaseFollower OtherChatTask;
  ...
  public FollowerTask_BabyZombieChaseFollower(int followerID, bool leader, float maxDistance = 7f)
  {
  ...
  public override void OnStart()
  {
    ...
    if (this.IsLeader)
    {
      this.OtherChatTask = new FollowerTask_BabyZombieChaseFollower(this._brain.Info.ID, false, this.maxDistance);
      ...
      if (brainById != null)
      {
        ...
        double num = (double) this.follower.SetBodyAnimation(this._brain.Info.Age < 10 ? "Baby/Baby-zombie/baby-crawl-zombie-chase" : "Zombie/zombie-chase", true);
      }
      else
        this.End();
    }
    else
    {
      ...
      double num = (double) this.follower.SetBodyAnimation(this._brain.Info.Age < 10 ? "Baby/baby-crawl-chased" : "Baby/baby-chased", true);
    }
  }
