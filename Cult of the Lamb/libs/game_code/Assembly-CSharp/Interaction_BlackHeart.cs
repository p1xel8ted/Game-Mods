...
#nullable disable
public class Interaction_BlackHeart : Interaction_HeartPickupBase
{
  ...
  public override void OnInteract(StateMachine state)
  {
    ...
    component.BlackHearts += (float) (2 * TrinketManager.GetHealthAmountMultiplier(this.playerFarming));
