...
Hotkey-based quick access to four game menus from anywhere - no need to be at the base.
...
- **Toggle hotkeys** - Press to open, press again to close
- **Quick switch** - Press a different hotkey while a menu is open to switch directly
- **Works anywhere** - Open menus from the base, dungeons, or anywhere else
- **Configurable** - Rebind all hotkeys and enable/disable each menu individually
- **Localized** - Configuration UI and menu titles translated in all 15 supported languages
...
- The Structures menu is browse-only — you cannot place buildings from it
- Fleece customization (left/right to change variants) works while the menu is paused
- The Clothing menu works even without a Tailor building
