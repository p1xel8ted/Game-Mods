/*
Name: Terminator Rogue City Vortex Extension
Structure: UE5
Author: ChemBoy1
Version: 0.4.2
Date: 07/21/2024
...
const GAME_ID = "terminatorresistance";
const STEAMAPP_ID = "954740";
const EPICAPP_ID = "";
const GOGAPP_ID = "1662585593";
const XBOXAPP_ID = "";
const XBOXEXECNAME = "";
const EPIC_CODE_NAME = "Terminator";
const EXEC_FOLDER_NAME = "Win64";
//const EXEC_FOLDER_NAME = "WinGDK"; //XBOX Version
const GAME_NAME = "Terminator: Resistance";
const GAME_NAME_SHORT = "Terminator: Resistance";
const EXEC = "Terminator.exe";
...
const SHIPPING_EXE = `${EPIC_CODE_NAME}\\Binaries\\${EXEC_FOLDER_NAME}\\Terminator-${EXEC_FOLDER_NAME}-Shipping.exe`;
...
const CONFIG_PATH = `Terminator\\Saved\\Config\\WindowsNoEditor`;
