...
const GAME_ID = "atomicheart";
const STEAMAPP_ID = "668580";
const EPICAPP_ID = "";
const GOGAPP_ID = "";
const XBOXAPP_ID = "9N9KXP8RRPB5";
const XBOXEXECNAME = "";
const EPIC_CODE_NAME = "AtomicHeart";
const EXEC_FOLDER_NAME = "Win64";
const GAME_NAME = "Atomic Heart";
const GAME_NAME_SHORT = "Atomic Heart";
const EXEC = "AtomicHeart.exe";
