/*
Name: Code Vein Vortex Extension
Structure: UE4
Author: ChemBoy1
Version: 0.1.0
Date: 02/23/2026
...
const STEAMAPP_ID = "678960";
const EPICAPP_ID = "";
const GOGAPP_ID = "";
const XBOXAPP_ID = "";
const XBOXEXECNAME = "";
const EPIC_CODE_NAME = "CodeVein";
const EXEC_FOLDER_NAME = "Win64";
const GAME_NAME = "CODE VEIN";
const GAME_NAME_SHORT = "Code Vein";
const EXEC = "CodeVein.exe";
