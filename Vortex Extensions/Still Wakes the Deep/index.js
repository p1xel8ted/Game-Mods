/*
Name: Still Wakes the Deep Vortex Extension
Structure: UE4
Author: p1xel8ted
Version: 0.1.0
Date: 02/23/2026
...
const GAME_ID = "stillwakesthedeep";
const STEAMAPP_ID = "1622910";
const EPICAPP_ID = "";
const GOGAPP_ID = "";
const XBOXAPP_ID = "9N88DFRX8WCJ";
const XBOXEXECNAME = "";
const EPIC_CODE_NAME = "Habitat";
const EXEC_FOLDER_NAME = "Win64";
const GAME_NAME = "Still Wakes the Deep";
const GAME_NAME_SHORT = "Still Wakes the Deep";
const EXEC = "StillWakesTheDeep.exe";
...
const CONFIG_PATH = `${EPIC_CODE_NAME}\\Saved\\Config\\WindowsNoEditor`;
