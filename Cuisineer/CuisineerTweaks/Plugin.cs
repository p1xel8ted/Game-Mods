...
public class Plugin : BasePlugin
{
    ...
    internal static ConfigEntry<bool> PerformanceEnabled { get; private set; }
    internal static ConfigEntry<bool> UserInterfaceEnabled { get; private set; }
    internal static ConfigEntry<bool> InventoryEnabled { get; private set; }
    internal static ConfigEntry<bool> SaveSystemEnabled { get; private set; }
    internal static ConfigEntry<bool> GameplayEnabled { get; private set; }
    internal static ConfigEntry<bool> PlayerHealthEnabled { get; private set; }
    internal static ConfigEntry<bool> PlayerMovementEnabled { get; private set; }
    internal static ConfigEntry<bool> RestaurantEnabled { get; private set; }
    internal static ConfigEntry<bool> AttacksDamageEnabled { get; private set; }
    internal static ConfigEntry<bool> CheatsEnabled { get; private set; }
    internal static ConfigEntry<bool> ZoomEnabled { get; private set; }
    ...
    private void InitConfig()
    {
        ...
        PerformanceEnabled = Config.Bind("01. Performance", "Enabled", true,
            new ConfigDescription("Master toggle for all settings in this section."));
        ...
        UserInterfaceEnabled = Config.Bind("02. User Interface", "Enabled", true,
            new ConfigDescription("Master toggle for all settings in this section."));
        ...
        InventoryEnabled = Config.Bind("03. Inventory", "Enabled", true,
            new ConfigDescription("Master toggle for all settings in this section."));
        ...
        SaveSystemEnabled = Config.Bind("04. Save System", "Enabled", true,
            new ConfigDescription("Master toggle for all settings in this section."));
        ...
        GameplayEnabled = Config.Bind("05. Gameplay", "Enabled", true,
            new ConfigDescription("Master toggle for all settings in this section."));
        ...
        PlayerHealthEnabled = Config.Bind("06. Player Health", "Enabled", true,
            new ConfigDescription("Master toggle for all settings in this section."));
        ...
        PlayerMovementEnabled = Config.Bind("07. Player Movement", "Enabled", true,
            new ConfigDescription("Master toggle for all settings in this section."));
        ...
        RestaurantEnabled = Config.Bind("08. Restaurant", "Enabled", true,
            new ConfigDescription("Master toggle for all settings in this section."));
        ...
        AttacksDamageEnabled = Config.Bind("09. Attacks/Damage", "Enabled", true,
            new ConfigDescription("Master toggle for all settings in this section."));
        ...
        //Group 10: Cheats
        CheatsEnabled = Config.Bind("10. Cheats", "Enabled", false,
            new ConfigDescription("Master toggle for all settings in this section."));
        ...
        //Group 11: Zoom
        ZoomEnabled = Config.Bind("11. Zoom", "Enabled", true,
            new ConfigDescription("Master toggle for all settings in this section."));
