...
public static class Const
{
    ...
    internal static readonly Vector3 ShowPosition = new(-155f, -5.5f, 0);
    internal static readonly Vector3 TitlePosition = new(0f, 73f, 0f);
    internal static readonly Vector3 TitleScale = new(0.75f, 0.75f, 1f);
    internal static readonly Vector3 ArrowPosition = new(-260f, 0, 0);
