...
public class Plugin : BaseUnityPlugin
{
    ...
    private void InitConfig()
    {
        ...
        MainHudScale.SettingChanged += (_, _) => { Patches.UpdateAllScalers(); };
        ...
        ChestCanvasScale.SettingChanged += (_, _) => { Patches.UpdateAllScalers(); };
        ...
        SnaccoonCanvasScale.SettingChanged += (_, _) => { Patches.UpdateAllScalers(); };
        ...
        DoubloonShopCanvasScale.SettingChanged += (_, _) => { Patches.UpdateAllScalers(); };
        ...
        CommunityTokenShopCanvasScale.SettingChanged += (_, _) => { Patches.UpdateAllScalers(); };
        ...
        AutoFeederCanvasScale.SettingChanged += (_, _) => { Patches.UpdateAllScalers(); };
        ...
        QuestIconScale.SettingChanged += (_, _) => { Patches.UpdateAllScalers(); };
        ...
        ChatConsoleScale.SettingChanged += (_, _) => { Patches.UpdateAllScalers(); };
        ...
        GenericDialogScale.SettingChanged += (_, _) => { Patches.UpdateAllScalers(); };
        ...
        VirtualKeyboardScale.SettingChanged += (_, _) => { Patches.UpdateAllScalers(); };
        ...
        ToolbarScale.SettingChanged += (_, _) => { Patches.UpdateAllScalers(); };
        ...
        BackpackSettingsScale.SettingChanged += (_, _) => { Patches.UpdateAllScalers(); };
        ...
        ShopCanvasScale.SettingChanged += (_, _) => { Patches.UpdateAllScalers(); };
        ...
        ZoomLevel.SettingChanged += (_, _) =>
        {
            ...
            //0.25 increments
            ZoomLevel.Value = Mathf.Round(ZoomLevel.Value * 4) / 4;
