...
- Improved performance when the quest tracker is visible
- Move speed multiplier now correctly uses the game's base speed instead of a fixed value
- Museum dialogue skip now works in all languages, not just English
