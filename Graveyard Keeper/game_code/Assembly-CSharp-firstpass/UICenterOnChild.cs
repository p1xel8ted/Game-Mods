...
public class UICenterOnChild : MonoBehaviour
{
  ...
  public void Start() => this.Recenter();
  ...
  public void OnValidate() => this.nextPageThreshold = Mathf.Abs(this.nextPageThreshold);
  ...
  public void Recenter()
  {
    if ((Object) this.mScrollView == (Object) null)
    {
      ...
      if ((Object) this.mScrollView == (Object) null)
      {
        Debug.LogWarning((object) $"{this.GetType()?.ToString()} requires {typeof (UIScrollView)?.ToString()} on a parent object in order to work", (Object) this);
        this.enabled = false;
        return;
      }
      if ((bool) (Object) this.mScrollView)
  ...
  public void CenterOn(Transform target, Vector3 panelCenter)
  {
