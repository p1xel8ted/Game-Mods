...
public class UIScrollView : MonoBehaviour
{
  ...
  [SerializeField]
  [HideInInspector]
  public Vector3 scale = new Vector3(1f, 0.0f, 0.0f);
  [HideInInspector]
  [SerializeField]
  ...
  public bool mShouldMove;
  public bool mIgnoreCallbacks;
  public int mDragID = -10;
  public Vector2 mDragStartOffset = Vector2.zero;
  ...
  public bool isScrolling
  {
    get
    {
      return (double) this.mMomentum.magnitude > 9.9999997473787516E-05 || (double) Mathf.Abs(this.mScroll) > 9.9999997473787516E-05;
    }
  }
  ...
  public virtual Bounds bounds
  {
    get
    {
      if (!this.mCalculatedBounds)
      {
        ...
        this.mBounds = !this.considerChildren ? NGUIMath.CalculateRelativeWidgetBounds(this.mTrans, this.mTrans, !this.mTrans.gameObject.activeSelf, false) : NGUIMath.CalculateRelativeWidgetBounds(this.mTrans, this.mTrans);
      }
      return this.mBounds;
    }
  }
  ...
  public virtual bool shouldMoveHorizontally
  {
    get
    {
      ...
      if (this.panel.clipping == UIDrawCall.Clipping.SoftClip)
        x += this.panel.clipSoftness.x * 2f;
      return Mathf.RoundToInt(x - this.panel.width) > 0;
    }
  }
  ...
  public virtual bool shouldMoveVertically
  {
    get
    {
      ...
      if (this.panel.clipping == UIDrawCall.Clipping.SoftClip)
        y += this.panel.clipSoftness.y * 2f;
      return Mathf.RoundToInt(y - this.panel.height) > 0;
    }
  }
  ...
  public bool NeedsRestriction(bool horizontal = true, bool vertical = true)
  {
    ...
    if (!vertical)
      constrainOffset.y = 0.0f;
    return (double) constrainOffset.sqrMagnitude > 0.10000000149011612;
  }
  ...
  {
    if (!this.enabled || !NGUITools.GetActive(this.gameObject) || (double) this.scrollWheelFactor == 0.0 || !this.shouldMove)
      return;
    this.DisableSpring();
    this.mShouldMove |= this.shouldMove;
  ...
  {
    this.mScroll = this.momentumAmount = 0.0f;
    this.mMomentum = Vector3.zero;
  }
