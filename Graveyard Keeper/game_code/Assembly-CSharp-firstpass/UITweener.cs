...
public abstract class UITweener : MonoBehaviour
{
  ...
  public List<EventDelegate> mTemp;
  ...
  public virtual void Start() => this.DoUpdate();
  ...
  public void DoUpdate()
  {
    ...
    if ((double) num2 < (double) this.mStartTime)
      return;
    this.mFactor += (double) this.duration == 0.0 ? 1f : this.amountPerDelta * num1;
  ...
  public void OnDisable() => this.mStarted = false;
  ...
  public float BounceLogic(float val)
  {
  ...
  public abstract void OnUpdate(float factor, bool isFinished);
