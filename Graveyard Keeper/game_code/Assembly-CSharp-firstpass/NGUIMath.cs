...
public static class NGUIMath
{
  ...
  public static Color IntToColor(int val)
  {
    ...
    return Color.black with
    {
      ...
      g = num * (float) (val >> 16 /*0x10*/ & (int) byte.MaxValue),
  ...
  {
    return NGUIMath.CalculateRelativeWidgetBounds(trans, trans, !trans.gameObject.activeSelf);
  }
  ...
  {
    return NGUIMath.CalculateRelativeWidgetBounds(relativeTo, content, !content.gameObject.activeSelf);
  }
  ...
  [DebuggerStepThrough]
  [DebuggerHidden]
  public static void CalculateRelativeWidgetBounds(
    Transform content,
    bool considerInactive,
    bool isRoot,
    ...
    bool considerChildren)
  {
    if ((Object) content == (Object) null || !considerInactive && !NGUITools.GetActive(content.gameObject))
      return;
    UIPanel component1 = isRoot ? (UIPanel) null : content.GetComponent<UIPanel>();
    if ((Object) component1 != (Object) null && !component1.enabled)
      return;
    if ((Object) component1 != (Object) null && component1.clipping != UIDrawCall.Clipping.None)
    {
    ...
    {
      UIWidget component2 = content.GetComponent<UIWidget>();
      if ((Object) component2 != (Object) null && component2.enabled)
      {
        ...
        if (!considerChildren && (Object) component2.GetComponent<ConsiderChildren>() == (Object) null)
          return;
      }
      int index1 = 0;
      for (int childCount = content.childCount; index1 < childCount; ++index1)
        NGUIMath.CalculateRelativeWidgetBounds(content.GetChild(index1), considerInactive, false, ref toLocal, ref vMin, ref vMax, ref isSet, considerChildren);
    }
  }
