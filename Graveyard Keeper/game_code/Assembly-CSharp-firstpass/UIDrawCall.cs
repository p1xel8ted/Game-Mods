...
{
  public static BetterList<UIDrawCall> mActiveList = new BetterList<UIDrawCall>();
  public static BetterList<UIDrawCall> mInactiveList = new BetterList<UIDrawCall>();
  [HideInInspector]
  [NonSerialized]
  ...
  public int[] mIndices;
  [NonSerialized]
  public UIDrawCall.ShadowMode mShadowMode;
  [NonSerialized]
  public bool mRebuildMat = true;
  [NonSerialized]
  public bool mLegacyShader;
  [NonSerialized]
  public int mRenderQueue = 3000;
  [NonSerialized]
  public int mTriangles;
  [NonSerialized]
  public bool isDirty;
  [NonSerialized]
  public bool mTextureClip;
  [NonSerialized]
  public bool mIsNew = true;
  ...
  public const int maxIndexBufferCache = 10;
  public static List<int[]> mCache = new List<int[]>(10);
  public MaterialPropertyBlock mBlock;
  public static int[] ClipRange = (int[]) null;
  public static int[] ClipArgs = (int[]) null;
  public static int dx9BugWorkaround = -1;
  ...
  public int finalRenderQueue
  {
    get
    {
      return !((UnityEngine.Object) this.mDynamicMat != (UnityEngine.Object) null) ? this.mRenderQueue : this.mDynamicMat.renderQueue;
    }
  }
  ...
  public Texture mainTexture
  {
    ...
    set
    {
      ...
      this.mBlock.SetTexture("_MainTex", value ?? (Texture) Texture2D.whiteTexture);
    }
  }
  ...
  public void SetClipping(int index, Vector4 cr, Vector2 soft, float angle)
  {
  ...
  public void OnEnable() => this.mRebuildMat = true;
  ...
  public static UIDrawCall Create(string name)
  {
  ...
  public static void ClearAll()
  {
    ...
    while (size > 0)
    {
      ...
      if ((bool) (UnityEngine.Object) mActive)
      {
        if (isPlaying)
          NGUITools.SetActive(mActive.gameObject, false);
        else
          NGUITools.DestroyImmediate((UnityEngine.Object) mActive.gameObject);
      }
    }
  ...
  public static void ReleaseInactive()
  {
    ...
    while (size > 0)
    {
      ...
      if ((bool) (UnityEngine.Object) mInactive)
        NGUITools.DestroyImmediate((UnityEngine.Object) mInactive.gameObject);
    }
  ...
  public static int Count(UIPanel panel)
  {
    ...
    {
      if ((UnityEngine.Object) UIDrawCall.mActiveList[i].manager == (UnityEngine.Object) panel)
        ++num;
    }
    return num;
  }
