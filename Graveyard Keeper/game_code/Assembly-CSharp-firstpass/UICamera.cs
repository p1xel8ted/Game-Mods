...
public class UICamera : MonoBehaviour
{
  ...
  public static bool mDisableController = false;
  public static Vector2 mLastPos = Vector2.zero;
  ...
  public static UICamera.ControlScheme mLastScheme = UICamera.ControlScheme.Mouse;
  public static int currentTouchID = -100;
  public static KeyCode mCurrentKey = KeyCode.Alpha0;
  public static UICamera.MouseOrTouch currentTouch = (UICamera.MouseOrTouch) null;
  public static bool mInputFocus = false;
  public static GameObject mGenericHandler;
  ...
  public static UICamera.MouseOrTouch[] mMouse = new UICamera.MouseOrTouch[3]
  {
  ...
  public static List<int> mTouchIDs = new List<int>();
  public static int mWidth = 0;
  public static int mHeight = 0;
  public static GameObject mTooltip = (GameObject) null;
  public Camera mCam;
  public static float mTooltipTime = 0.0f;
  public float mNextRaycast;
  public static bool isDragging = false;
  public static int mLastInteractionCheck = -1;
  public static bool mLastInteractionResult = false;
  public static int mLastFocusCheck = -1;
  public static bool mLastFocusResult = false;
  public static int mLastOverCheck = -1;
  public static bool mLastOverResult = false;
  public static GameObject mRayHitObject;
  public static GameObject mHover;
  public static GameObject mSelected;
  public static UICamera.DepthEntry mHit = new UICamera.DepthEntry();
  public static BetterList<UICamera.DepthEntry> mHits = new BetterList<UICamera.DepthEntry>();
  public static RaycastHit[] mRayHits;
  public static Collider2D[] mOverlap;
  public static Plane m2DPlane = new Plane(Vector3.back, 0.0f);
  public static float mNextEvent = 0.0f;
  public static int mNotifying = 0;
  public static bool disableControllerCheck = true;
  public static bool mUsingTouchEvents = true;
  ...
  {
    get => UICamera.list == null || UICamera.list.size == 0 ? (UICamera) null : UICamera.list[0];
  }
  ...
  public static Ray currentRay
  {
    get
    {
      return !((UnityEngine.Object) UICamera.currentCamera != (UnityEngine.Object) null) || UICamera.currentTouch == null ? new Ray() : UICamera.currentCamera.ScreenPointToRay((Vector3) UICamera.currentTouch.pos);
    }
  }
  ...
  public static bool inputHasFocus
  {
    get
    {
      return UICamera.mInputFocus && (bool) (UnityEngine.Object) UICamera.mSelected && UICamera.mSelected.activeInHierarchy;
    }
  }
  ...
  public bool handlesEvents => (UnityEngine.Object) UICamera.eventHandler == (UnityEngine.Object) this;
  ...
  {
    return !((UnityEngine.Object) go == (UnityEngine.Object) null) && !((UnityEngine.Object) go == (UnityEngine.Object) UICamera.fallThrough) && (UnityEngine.Object) NGUITools.FindInParents<UIRoot>(go) != (UnityEngine.Object) null;
  }
  ...
  public static bool isOverUI
  {
    get
    {
      ...
      if (UICamera.mLastOverCheck != frameCount)
      {
        ...
        {
          if (UICamera.IsPartOfUI(UICamera.mMouse[index2].current))
          {
            UICamera.mLastOverResult = true;
            return UICamera.mLastOverResult;
          }
  ...
  public static GameObject hoveredObject
  {
    ...
    set
    {
      ...
      if ((bool) (UnityEngine.Object) UICamera.mHover)
      {
        ...
        if (flag)
        {
          UICamera uiCamera = (UnityEngine.Object) UICamera.mHover != (UnityEngine.Object) null ? UICamera.FindCameraForLayer(UICamera.mHover.layer) : UICamera.list[0];
  ...
  public static GameObject selectedObject
  {
    ...
    set
    {
      ...
      else
      {
        ...
        {
          UICamera uiCamera = (UnityEngine.Object) UICamera.mSelected != (UnityEngine.Object) null ? UICamera.FindCameraForLayer(UICamera.mSelected.layer) : UICamera.list[0];
          if ((UnityEngine.Object) uiCamera != (UnityEngine.Object) null)
          {
            UICamera.current = uiCamera;
            UICamera.currentCamera = uiCamera.cachedCamera;
  ...
  public static int CompareFunc(UICamera a, UICamera b)
  {
  ...
  public static Rigidbody FindRootRigidbody(Transform trans)
  {
  ...
  public static Rigidbody2D FindRootRigidbody2D(Transform trans)
  {
    for (; (UnityEngine.Object) trans != (UnityEngine.Object) null && !((UnityEngine.Object) trans.GetComponent<UIPanel>() != (UnityEngine.Object) null); trans = trans.parent)
    {
          ...
          if (!float.IsNaN(viewportPoint.x) && !float.IsNaN(viewportPoint.y) && (double) viewportPoint.x >= 0.0 && (double) viewportPoint.x <= 1.0 && (double) viewportPoint.y >= 0.0 && (double) viewportPoint.y <= 1.0)
          {
            ...
            else if (uiCamera.eventType == UICamera.EventType.UI_3D)
            {
              ...
              if (num > 1)
              {
                for (int index2 = 0; index2 < num; ++index2)
                {
                  ...
                  if ((UnityEngine.Object) component != (UnityEngine.Object) null)
                  {
                    if (!component.isVisible || component.hitCheck != null && !component.hitCheck(UICamera.mRayHits[index2].point))
                      continue;
                  }
                  else
                  {
            ...
            else if (uiCamera.eventType == UICamera.EventType.UI_2D && UICamera.m2DPlane.Raycast(ray, out enter))
            {
              ...
              if (num > 1)
              {
                ...
                {
                  GameObject gameObject = UICamera.mOverlap[index3].gameObject;
                  UIWidget component = gameObject.GetComponent<UIWidget>();
                  if ((UnityEngine.Object) component != (UnityEngine.Object) null)
                  {
  ...
  public static bool IsVisible(Vector3 worldPoint, GameObject go)
  {
  ...
  public static bool IsVisible(ref UICamera.DepthEntry de)
  {
  ...
  public static int GetDirection(KeyCode up, KeyCode down)
  {
  ...
  public static int GetDirection(KeyCode up0, KeyCode up1, KeyCode down0, KeyCode down1)
  {
  ...
  public static int GetDirection(string axis)
  {
  ...
  public void OnDisable() => UICamera.list.Remove(this);
  ...
  public void ProcessEvents()
  {
    ...
    if (this.useMouse && (UnityEngine.Object) UICamera.mHover != (UnityEngine.Object) null)
    {
      ...
      if (UICamera.currentScheme == UICamera.ControlScheme.Mouse && UICamera.showTooltips && (double) UICamera.mTooltipTime != 0.0 && !UIPopupList.isOpen && (UnityEngine.Object) UICamera.mMouse[0].dragged == (UnityEngine.Object) null && ((double) UICamera.mTooltipTime < (double) RealTime.time || UICamera.GetKey(KeyCode.LeftShift) || UICamera.GetKey(KeyCode.RightShift)))
      {
  ...
  public void ProcessMouse()
  {
    ...
    if (!flag1 & flag3 && !this.stickyTooltip | flag4)
    {
      ...
      else if ((UnityEngine.Object) UICamera.mTooltip != (UnityEngine.Object) null)
        UICamera.ShowTooltip((GameObject) null);
    }
  ...
  public void ProcessFakeTouches()
  {
  ...
  public void ProcessPress(bool pressed, float click, float drag)
  {
    if (pressed)
    {
  ...
  public void ProcessRelease(bool isMouse, float drag)
  {
    if (UICamera.currentTouch == null)
      return;
  ...
  public bool HasCollider(GameObject go)
  {
  ...
  public void ProcessTouch(bool pressed, bool released)
  {
    ...
    if ((UnityEngine.Object) UICamera.currentTouch.pressed != (UnityEngine.Object) null)
    {
      ...
      if ((double) UICamera.currentTouch.deltaTime <= (double) this.tooltipDelay || !((UnityEngine.Object) UICamera.currentTouch.pressed == (UnityEngine.Object) UICamera.currentTouch.current) || (double) UICamera.mTooltipTime == 0.0 || UICamera.currentTouch.dragStarted)
        return;
      UICamera.mTooltipTime = 0.0f;
      UICamera.currentTouch.clickNotification = UICamera.ClickNotification.None;
  ...
  public class MouseOrTouch
  {
    ...
    public bool isOverUI
    {
      get
      {
        return (UnityEngine.Object) this.current != (UnityEngine.Object) null && (UnityEngine.Object) this.current != (UnityEngine.Object) UICamera.fallThrough && (UnityEngine.Object) NGUITools.FindInParents<UIRoot>(this.current) != (UnityEngine.Object) null;
      }
    }
  }
