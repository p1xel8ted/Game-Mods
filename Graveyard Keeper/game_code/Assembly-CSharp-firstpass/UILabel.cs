...
public class UILabel : UIWidget
{
  ...
  [HideInInspector]
  [SerializeField]
  public UILabel.Effect mEffectStyle;
  [SerializeField]
  [HideInInspector]
  ...
  [HideInInspector]
  [SerializeField]
  public Vector2 mEffectDistance = Vector2.one;
  [HideInInspector]
  [SerializeField]
  public UILabel.Overflow mOverflow;
  [HideInInspector]
  [SerializeField]
  ...
  [SerializeField]
  [HideInInspector]
  public bool mUseFloatSpacing;
  [HideInInspector]
  [SerializeField]
  public float mFloatSpacingX;
  [SerializeField]
  [HideInInspector]
  public float mFloatSpacingY;
  [HideInInspector]
  [SerializeField]
  public bool mOverflowEllipsis;
  [HideInInspector]
  [SerializeField]
  public int mOverflowWidth;
  [SerializeField]
  [HideInInspector]
  public UILabel.Modifier mModifier;
  [HideInInspector]
  [SerializeField]
  public bool mShrinkToFit;
  [HideInInspector]
  [SerializeField]
  public int mMaxLineWidth;
  [SerializeField]
  [HideInInspector]
  ...
  [NonSerialized]
  public Font mActiveTTF;
  [NonSerialized]
  public float mDensity = 1f;
  [NonSerialized]
  public bool mShouldBeProcessed = true;
  [NonSerialized]
  public string mProcessedText;
  [NonSerialized]
  public bool mPremultiply;
  [NonSerialized]
  public Vector2 mCalculatedSize = Vector2.zero;
  [NonSerialized]
  public float mScale = 1f;
  [NonSerialized]
  public int mFinalFontSize;
  [NonSerialized]
  public int mLastWidth;
  [NonSerialized]
  public int mLastHeight;
  public UILabel.ModifierFunc customModifier;
  public static BetterList<UILabel> mList = new BetterList<UILabel>();
  public static Dictionary<Font, int> mFontUsage = new Dictionary<Font, int>();
  [NonSerialized]
  public static BetterList<UIDrawCall> mTempDrawcalls;
  public static bool mTexRebuildAdded = false;
  public static List<Vector3> mTempVerts = new List<Vector3>();
  public static List<int> mTempIndices = new List<int>();

  public int finalFontSize
  {
    get
    {
      return (bool) (UnityEngine.Object) this.trueTypeFont ? Mathf.RoundToInt(this.mScale * (float) this.mFinalFontSize) : Mathf.RoundToInt((float) this.mFinalFontSize * this.mScale);
    }
  }
  ...
  public override Texture mainTexture
  {
    ...
    {
      if ((UnityEngine.Object) this.mFont != (UnityEngine.Object) null)
        return (Texture) this.mFont.texture;
  ...
  public Font trueTypeFont
  {
    get
    {
      ...
      return !((UnityEngine.Object) this.mFont != (UnityEngine.Object) null) ? (Font) null : this.mFont.dynamicFont;
    }
    set
    {
  ...
  {
    get => (UnityEngine.Object) this.mFont ?? (UnityEngine.Object) this.mTrueTypeFont;
    set
    {
  ...
  public int defaultFontSize
  {
    get
    {
      ...
      return !((UnityEngine.Object) this.mFont != (UnityEngine.Object) null) ? 16 /*0x10*/ : this.mFont.defaultSize;
    }
  }
  ...
  public bool keepCrisp
  {
    get
    {
      return (UnityEngine.Object) this.trueTypeFont != (UnityEngine.Object) null && this.keepCrispWhenShrunk != UILabel.Crispness.Never;
    }
  }
  ...
  public bool isValid
  {
    get => (UnityEngine.Object) this.mFont != (UnityEngine.Object) null || (UnityEngine.Object) this.mTrueTypeFont != (UnityEngine.Object) null;
  }
  ...
  public void SetActiveFont(Font fnt)
  {
  ...
  public static void OnFontChanged(Font font)
  {
    for (int i = 0; i < UILabel.mList.size; ++i)
    {
      ...
      if ((UnityEngine.Object) m != (UnityEngine.Object) null)
      {
        ...
        {
          trueTypeFont.RequestCharactersInTexture(m.mText, m.mFinalFontSize, m.mFontStyle);
          m.MarkAsChanged();
          if ((UnityEngine.Object) m.panel == (UnityEngine.Object) null)
            m.CreatePanel();
          if (UILabel.mTempDrawcalls == null)
            UILabel.mTempDrawcalls = new BetterList<UIDrawCall>();
          if ((UnityEngine.Object) m.drawCall != (UnityEngine.Object) null && !UILabel.mTempDrawcalls.Contains(m.drawCall))
            UILabel.mTempDrawcalls.Add(m.drawCall);
        }
      }
    }
    if (UILabel.mTempDrawcalls == null)
      return;
    int i1 = 0;
    for (int size = UILabel.mTempDrawcalls.size; i1 < size; ++i1)
    {
      UIDrawCall mTempDrawcall = UILabel.mTempDrawcalls[i1];
      if ((UnityEngine.Object) mTempDrawcall.panel != (UnityEngine.Object) null)
        mTempDrawcall.panel.FillDrawCall(mTempDrawcall);
    }
  ...
  public override void UpgradeFrom265()
  {
    ...
    else
    {
      ...
      if (this.mFinalFontSize > 0)
      {
        ...
        for (int index = this.mFinalFontSize; index > 0; index = num3 - 1)
        {
          ...
          bool flag2 = NGUIText.WrapText(this.printedText, out this.mProcessedText, false, false, this.mOverflowEllipsis);
  ...
  public override void OnFill(List<Vector3> verts, List<Vector2> uvs, List<Color> cols)
  {
    ...
    if (NGUIText.symbolStyle == NGUIText.SymbolStyle.NoEffect)
    {
      for (int index = 0; index < cols.Count; ++index)
      {
        ...
        if ((double) col.r == 1.0 && (double) col.g == 0.0 && (double) col.b == 1.0 && (double) col.a == 0.0)
          cols[index] = new Color(1f, 1f, 1f, this.finalAlpha);
      }
    }
    ...
    float y)
  {
    ...
    c.a *= this.finalAlpha;
    if ((UnityEngine.Object) this.bitmapFont != (UnityEngine.Object) null && this.bitmapFont.premultipliedAlphaShader)
      c = NGUITools.ApplyPMA(c);
    Color color1 = c;
  ...
  public new void OnApplicationPause(bool paused)
  {
