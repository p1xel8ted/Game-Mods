...
public class UIColorPicker : MonoBehaviour
{
  ...
  [NonSerialized]
  public int mHeight;
  public static AnimationCurve mRed;
  public static AnimationCurve mGreen;
  public static AnimationCurve mBlue;
  ...
  public void Sample()
  {
    Vector3 position = this.mTrans.InverseTransformPoint(this.mCam.cachedCamera.ScreenToWorldPoint((Vector3) UICamera.lastEventPosition));
