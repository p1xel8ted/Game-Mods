...
// Type: NodeCanvas.Framework.Internal.ReflectedAction`5
...
{
  public ReflectedWrapper.ActionCall<T1, T2, T3, T4, T5> call;
  ...
  {
    this.call = this.GetMethod().RTCreateDelegate<ReflectedWrapper.ActionCall<T1, T2, T3, T4, T5>>(instance);
  }
