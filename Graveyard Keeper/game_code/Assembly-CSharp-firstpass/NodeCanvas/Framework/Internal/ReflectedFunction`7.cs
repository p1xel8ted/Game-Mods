...
// Type: NodeCanvas.Framework.Internal.ReflectedFunction`7
...
{
  public ReflectedWrapper.FunctionCall<T1, T2, T3, T4, T5, T6, TResult> call;
  ...
  {
    this.call = this.GetMethod().RTCreateDelegate<ReflectedWrapper.FunctionCall<T1, T2, T3, T4, T5, T6, TResult>>(instance);
  }

  public override object Call()
  {
    return (object) (this.result.value = this.call(this.p1.value, this.p2.value, this.p3.value, this.p4.value, this.p5.value, this.p6.value));
  }
}
