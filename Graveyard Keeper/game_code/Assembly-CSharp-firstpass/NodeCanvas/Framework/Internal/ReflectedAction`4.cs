...
// Type: NodeCanvas.Framework.Internal.ReflectedAction`4
...
{
  public ReflectedWrapper.ActionCall<T1, T2, T3, T4> call;
  ...
  {
    this.call = this.GetMethod().RTCreateDelegate<ReflectedWrapper.ActionCall<T1, T2, T3, T4>>(instance);
  }
