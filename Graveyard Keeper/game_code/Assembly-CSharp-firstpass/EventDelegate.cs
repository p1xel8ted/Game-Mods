...
public class EventDelegate
{
  ...
  [SerializeField]
  public EventDelegate.Parameter[] mParameters;
  public bool oneShot;
  [NonSerialized]
  public EventDelegate.Callback mCachedCallback;
  [NonSerialized]
  public bool mRawDelegate;
  [NonSerialized]
  public bool mCached;
  [NonSerialized]
  public MethodInfo mMethod;
  [NonSerialized]
  public ParameterInfo[] mParameterInfos;
  [NonSerialized]
  public object[] mArgs;
  public static int s_Hash = nameof (EventDelegate).GetHashCode();
  ...
  public static string GetMethodName(EventDelegate.Callback callback) => callback.Method.Name;

  public static bool IsValid(EventDelegate.Callback callback)
  {
    return callback != null && MethodInfo.op_Inequality(callback.Method, (MethodInfo) null);
  }
  ...
  public void Set(EventDelegate.Callback call)
  {
    this.Clear();
  ...
  public void Cache()
  {
    ...
    this.mMethod = (MethodInfo) null;
    for (; System.Type.op_Inequality(type, (System.Type) null); type = type.BaseType)
    {
      try
      {
        this.mMethod = type.GetMethod(this.mMethodName, BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
        if (MethodInfo.op_Inequality(this.mMethod, (MethodInfo) null))
          break;
      }
      catch (Exception ex)
      {
    ...
    if (MethodInfo.op_Equality(this.mMethod, (MethodInfo) null))
      Debug.LogError((object) $"Could not find method '{this.mMethodName}' on {this.mTarget.GetType()?.ToString()}", (UnityEngine.Object) this.mTarget);
    else if (System.Type.op_Inequality(this.mMethod.ReturnType, typeof (void)))
    {
      Debug.LogError((object) $"{this.mTarget.GetType()?.ToString()}.{this.mMethodName} must have a 'void' return type.", (UnityEngine.Object) this.mTarget);
    }
    else
    {
  ...
  public bool Execute()
  {
    ...
    else
    {
      ...
      catch (ArgumentException ex)
      {
        ...
        string str2 = $"{(!((UnityEngine.Object) this.mTarget == (UnityEngine.Object) null) ? $"{str1}{this.mTarget.GetType()?.ToString()}.{this.mMethod.Name}" : str1 + this.mMethod.Name)}: {ex.Message}" + "\n  Expected: ";
        string str3;
        if (this.mParameterInfos.Length == 0)
        {
      ...
      get
      {
        ...
        if (!this.cached)
        {
          ...
          if (this.obj != (UnityEngine.Object) null && !string.IsNullOrEmpty(this.field))
          {
            ...
            if (PropertyInfo.op_Equality(this.propInfo, (PropertyInfo) null))
              this.fieldInfo = type.GetField(this.field);
          }
        }
        if (PropertyInfo.op_Inequality(this.propInfo, (PropertyInfo) null))
          return this.propInfo.GetValue((object) this.obj, (object[]) null);
        if (FieldInfo.op_Inequality(this.fieldInfo, (FieldInfo) null))
          return this.fieldInfo.GetValue((object) this.obj);
        if (this.obj != (UnityEngine.Object) null)
          return (object) this.obj;
        return System.Type.op_Inequality(this.expectedType, (System.Type) null) && this.expectedType.IsValueType ? (object) null : Convert.ChangeType((object) null, this.expectedType);
      }
