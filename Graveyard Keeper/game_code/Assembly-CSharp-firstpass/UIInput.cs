...
public class UIInput : MonoBehaviour
{
  ...
  [NonSerialized]
  public bool mDoInit = true;
  [NonSerialized]
  public NGUIText.Alignment mAlignment = NGUIText.Alignment.Left;
  [NonSerialized]
  public bool mLoadSavedValue = true;
  public static int mDrawStart = 0;
  public static string mLastIME = "";
  [NonSerialized]
  public int mSelectionStart;
  [NonSerialized]
  public int mSelectionEnd;
  [NonSerialized]
  public UITexture mHighlight;
  [NonSerialized]
  public UITexture mCaret;
  [NonSerialized]
  public Texture2D mBlankTex;
  [NonSerialized]
  public float mNextBlink;
  [NonSerialized]
  public float mLastAlpha;
  [NonSerialized]
  public string mCached = "";
  [NonSerialized]
  public int mSelectMe = -1;
  [NonSerialized]
  public int mSelectTime = -1;
  [NonSerialized]
  public bool mStarted;
  [NonSerialized]
  public UIInputOnGUI mOnGUI;
  [NonSerialized]
  public UICamera mCam;
  [NonSerialized]
  public bool mEllipsis;
  public static int mIgnoreKey = 0;
  ...
  public bool inputShouldBeHidden
  {
    get
    {
      return this.hideInput && (UnityEngine.Object) this.label != (UnityEngine.Object) null && !this.label.multiLine && this.inputType != UIInput.InputType.Password;
    }
  }
  ...
  public void SaveToPlayerPrefs(string val)
  {
  ...
  {
    int length = Mathf.Min(this.mSelectionStart, this.mSelectionEnd, this.mValue.Length);
