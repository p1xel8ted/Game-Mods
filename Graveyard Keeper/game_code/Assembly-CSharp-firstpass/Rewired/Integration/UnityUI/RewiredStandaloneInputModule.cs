...
public sealed class RewiredStandaloneInputModule : RewiredPointerInputModule
{
  ...
  public bool isTouchAllowed => this.isTouchSupported && this.m_allowTouchInput;
  ...
  {
    if (!ReInput.isReady || !this.m_HasFocus && this.ShouldIgnoreEventsOnNoFocus())
      return;
  ...
  public bool SendMoveEventToSelectedObject()
  {
    ...
    if (flag2)
    {
      eventData = this.GetAxisEventData(rawMoveVector.x, rawMoveVector.y, 0.6f);
  ...
  public void CheckButtonOrKeyMovement(float time, out bool downHorizontal, out bool downVertical)
  {
