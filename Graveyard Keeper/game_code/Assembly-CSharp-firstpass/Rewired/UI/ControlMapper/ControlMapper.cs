...
public class ControlMapper : MonoBehaviour
{
  ...
  [SerializeField]
  public Rewired.UI.ControlMapper.ControlMapper.MappingSet[] _mappingSets = new Rewired.UI.ControlMapper.ControlMapper.MappingSet[1]
  {
  ...
  public bool _allowElementAssignmentSwap;
  [SerializeField]
  [Tooltip("The width in relative pixels of the Action label column.")]
  public int _actionLabelWidth = 200;
  [SerializeField]
  ...
  public Rewired.UI.ControlMapper.ControlMapper.InputBehaviorSettings[] _inputBehaviorSettings;
  [SerializeField]
  ...
  public Rewired.UI.ControlMapper.ControlMapper.Prefabs prefabs;
  [SerializeField]
  [Tooltip("A list of references to elements in the hierarchy. You should not have to modify this.")]
  public Rewired.UI.ControlMapper.ControlMapper.References references;
  [SerializeField]
  ...
  public System.Action _ScreenClosedEvent;
  public System.Action _ScreenOpenedEvent;
  public System.Action _PopupWindowOpenedEvent;
  public System.Action _PopupWindowClosedEvent;
  public System.Action _InputPollingStartedEvent;
  public System.Action _InputPollingEndedEvent;
  [SerializeField]
  ...
  public static Rewired.UI.ControlMapper.ControlMapper Instance;
  public bool initialized;
  public int playerCount;
  public Rewired.UI.ControlMapper.ControlMapper.InputGrid inputGrid;
  public Rewired.UI.ControlMapper.ControlMapper.WindowManager windowManager;
  public int currentPlayerId;
  public int currentMapCategoryId;
  public List<Rewired.UI.ControlMapper.ControlMapper.GUIButton> playerButtons;
  public List<Rewired.UI.ControlMapper.ControlMapper.GUIButton> mapCategoryButtons;
  public List<Rewired.UI.ControlMapper.ControlMapper.GUIButton> assignedControllerButtons;
  public Rewired.UI.ControlMapper.ControlMapper.GUIButton assignedControllerButtonsPlaceholder;
  ...
  public Rewired.UI.ControlMapper.ControlMapper.InputMapping pendingInputMapping;
  public Rewired.UI.ControlMapper.ControlMapper.AxisCalibrator pendingAxisCalibration;
  ...
  public System.Action _restoreDefaultsDelegate;
  ...
  public bool isFocused => this.initialized && !this.windowManager.isWindowOpen;

  public bool inputAllowed => (double) this.blockInputOnFocusEndTime <= (double) Time.unscaledTime;
  ...
  public Player currentPlayer => ReInput.players.GetPlayer(this.currentPlayerId);
  ...
  public Rewired.UI.ControlMapper.ControlMapper.MappingSet currentMappingSet
  {
    get
    {
  ...
  public Joystick currentJoystick => ReInput.controllers.GetJoystick(this.currentJoystickId);

  public bool isJoystickSelected => this.currentJoystickId >= 0;
  ...
  public bool showMapCategories => this._mappingSets != null && this._mappingSets.Length > 1;
  ...
  public void OnScreenOpenActionPressed(InputActionEventData data) => this.Open();
  ...
  public void OnBeginElementAssignment(
  ...
  public void OnElementAssignmentConflictReplaceConfirmed(
    int windowId,
  ...
  public void OnElementAssignmentAddConfirmed(
    int windowId,
    Rewired.UI.ControlMapper.ControlMapper.InputMapping mapping,
    ElementAssignment assignment)
  {
  ...
  public void ShowAssignControllerWindow()
  {
    ...
    window.AddContentText(this.prefabs.windowContentText, UIPivot.TopCenter, Rewired.UI.UIAnchor.TopHStretch, new Vector2(0.0f, -100f), this._language.assignControllerWindowMessage);
    window.AddContentText(this.prefabs.windowContentText, UIPivot.BottomCenter, Rewired.UI.UIAnchor.BottomHStretch, Vector2.zero, "");
  ...
  public void ShowControllerAssignmentConflictWindow(int controllerId)
  {
    ...
    for (int index = 0; index < players.Count; ++index)
    {
      ...
      {
        otherPlayerName = players[index].descriptiveName;
        break;
      }
    }
    ...
    window.AddContentText(this.prefabs.windowContentText, UIPivot.TopCenter, Rewired.UI.UIAnchor.TopHStretch, new Vector2(0.0f, -100f), this._language.GetControllerAssignmentConflictWindowMessage(joystick.name, otherPlayerName, this.currentPlayer.descriptiveName));
    UnityAction unityAction = (UnityAction) (() => this.OnWindowCancel(window.id));
    window.cancelCallback = unityAction;
    window.CreateButton(this.prefabs.fitButton, UIPivot.BottomLeft, Rewired.UI.UIAnchor.BottomLeft, Vector2.zero, this._language.yes, (UnityAction) (() => this.OnControllerAssignmentConfirmed(window.id, this.currentPlayer, controllerId)), unityAction, true);
  ...
  public void ShowBeginElementAssignmentReplacementWindow(
    InputFieldInfo fieldInfo,
    InputAction action,
    ControllerMap map,
    ActionElementMap aem,
    string actionName)
  {
    ...
    window.AddContentText(this.prefabs.windowContentText, UIPivot.TopCenter, Rewired.UI.UIAnchor.TopHStretch, new Vector2(0.0f, -100f), guiInputField.GetLabel());
    UnityAction unityAction = (UnityAction) (() => this.OnWindowCancel(window.id));
    window.cancelCallback = unityAction;
    window.CreateButton(this.prefabs.fitButton, UIPivot.BottomLeft, Rewired.UI.UIAnchor.BottomLeft, Vector2.zero, this._language.replace, (UnityAction) (() => this.OnBeginElementAssignment(fieldInfo, map, aem, actionName)), unityAction, true);
    window.CreateButton(this.prefabs.fitButton, UIPivot.BottomCenter, Rewired.UI.UIAnchor.BottomCenter, Vector2.zero, this._language.remove, (UnityAction) (() => this.OnRemoveElementAssignment(window.id, map, aem)), unityAction, false);
  ...
  public void ShowCreateNewElementAssignmentWindow(
    InputFieldInfo fieldInfo,
    InputAction action,
    ControllerMap map,
    string actionName)
  ...
  public void ShowElementAssignmentPrePollingWindow()
  {
    ...
    window.AddContentText(this.prefabs.windowContentText, UIPivot.TopCenter, Rewired.UI.UIAnchor.TopHStretch, new Vector2(0.0f, -100f), this._language.elementAssignmentPrePollingWindowMessage);
    if ((UnityEngine.Object) this.prefabs.centerStickGraphic != (UnityEngine.Object) null)
      window.AddContentImage(this.prefabs.centerStickGraphic, UIPivot.BottomCenter, Rewired.UI.UIAnchor.BottomCenter, new Vector2(0.0f, 40f));
    window.AddContentText(this.prefabs.windowContentText, UIPivot.BottomCenter, Rewired.UI.UIAnchor.BottomHStretch, Vector2.zero, "");
  ...
  public void ShowJoystickElementAssignmentPollingWindow()
  {
    ...
    window.CreateTitleText(this.prefabs.windowTitleText, Vector2.zero, this.pendingInputMapping.actionName);
    window.AddContentText(this.prefabs.windowContentText, UIPivot.TopCenter, Rewired.UI.UIAnchor.TopHStretch, new Vector2(0.0f, -100f), text);
    window.AddContentText(this.prefabs.windowContentText, UIPivot.BottomCenter, Rewired.UI.UIAnchor.BottomHStretch, Vector2.zero, "");
  ...
  public void ShowKeyboardElementAssignmentPollingWindow()
  {
    ...
    if ((UnityEngine.Object) window == (UnityEngine.Object) null)
      return;
    window.CreateTitleText(this.prefabs.windowTitleText, Vector2.zero, this.pendingInputMapping.actionName);
    window.AddContentText(this.prefabs.windowContentText, UIPivot.TopCenter, Rewired.UI.UIAnchor.TopHStretch, new Vector2(0.0f, -100f), this._language.GetKeyboardElementAssignmentPollingWindowMessage(this.pendingInputMapping.actionName));
    window.AddContentText(this.prefabs.windowContentText, UIPivot.TopCenter, Rewired.UI.UIAnchor.TopHStretch, new Vector2(0.0f, (float) -((double) window.GetContentTextHeight(0) + 50.0)), "");
    window.AddContentText(this.prefabs.windowContentText, UIPivot.BottomCenter, Rewired.UI.UIAnchor.BottomHStretch, Vector2.zero, "");
  ...
  public void ShowElementAssignmentConflictWindow(
    ElementAssignment assignment,
    bool skipOtherPlayers)
  {
    if (this.pendingInputMapping == null)
    ...
    {
      window.CreateButton(this.prefabs.fitButton, UIPivot.BottomLeft, Rewired.UI.UIAnchor.BottomLeft, Vector2.zero, this._language.replace, (UnityAction) (() => this.OnElementAssignmentConflictReplaceConfirmed(window.id, this.pendingInputMapping, assignment, skipOtherPlayers, false)), unityAction, true);
      if (this._allowElementAssignmentConflicts)
        window.CreateButton(this.prefabs.fitButton, UIPivot.BottomCenter, Rewired.UI.UIAnchor.BottomCenter, Vector2.zero, this._language.add, (UnityAction) (() => this.OnElementAssignmentAddConfirmed(window.id, this.pendingInputMapping, assignment)), unityAction, false);
      else if (this.ShowSwapButton(window.id, this.pendingInputMapping, assignment, skipOtherPlayers))
        window.CreateButton(this.prefabs.fitButton, UIPivot.BottomCenter, Rewired.UI.UIAnchor.BottomCenter, Vector2.zero, this._language.swap, (UnityAction) (() => this.OnElementAssignmentConflictReplaceConfirmed(window.id, this.pendingInputMapping, assignment, skipOtherPlayers, true)), unityAction, false);
      window.CreateButton(this.prefabs.fitButton, UIPivot.BottomRight, Rewired.UI.UIAnchor.BottomRight, Vector2.zero, this._language.cancel, unityAction, unityAction, false);
    }
    this.windowManager.Focus(window);
  }
  ...
  public void ShowMouseAssignmentConflictWindow()
  {
    ...
    window.AddContentText(this.prefabs.windowContentText, UIPivot.TopCenter, Rewired.UI.UIAnchor.TopHStretch, new Vector2(0.0f, -100f), this._language.GetMouseAssignmentConflictWindowMessage(otherPlayerName, this.currentPlayer.descriptiveName));
    UnityAction unityAction = (UnityAction) (() => this.OnWindowCancel(window.id));
    window.cancelCallback = unityAction;
    window.CreateButton(this.prefabs.fitButton, UIPivot.BottomLeft, Rewired.UI.UIAnchor.BottomLeft, Vector2.zero, this._language.yes, (UnityAction) (() => this.OnMouseAssignmentConfirmed(window.id, this.currentPlayer)), unityAction, true);
    window.CreateButton(this.prefabs.fitButton, UIPivot.BottomRight, Rewired.UI.UIAnchor.BottomRight, Vector2.zero, this._language.no, unityAction, unityAction, false);
    this.windowManager.Focus(window);
  }
  ...
  public void ShowCalibrateAxisStep1Window()
  {
    ...
    window.AddContentText(this.prefabs.windowContentText, UIPivot.TopCenter, Rewired.UI.UIAnchor.TopHStretch, new Vector2(0.0f, -100f), this._language.GetCalibrateAxisStep1WindowMessage(joystick.AxisElementIdentifiers[axisIndex].name));
    if ((UnityEngine.Object) this.prefabs.centerStickGraphic != (UnityEngine.Object) null)
      window.AddContentImage(this.prefabs.centerStickGraphic, UIPivot.BottomCenter, Rewired.UI.UIAnchor.BottomCenter, new Vector2(0.0f, 40f));
    window.AddContentText(this.prefabs.windowContentText, UIPivot.BottomCenter, Rewired.UI.UIAnchor.BottomHStretch, Vector2.zero, "");
  ...
  public void ShowCalibrateAxisStep2Window()
  {
    ...
    window.AddContentText(this.prefabs.windowContentText, UIPivot.TopCenter, Rewired.UI.UIAnchor.TopHStretch, new Vector2(0.0f, -100f), this._language.GetCalibrateAxisStep2WindowMessage(joystick.AxisElementIdentifiers[axisIndex].name));
    if ((UnityEngine.Object) this.prefabs.moveStickGraphic != (UnityEngine.Object) null)
      window.AddContentImage(this.prefabs.moveStickGraphic, UIPivot.BottomCenter, Rewired.UI.UIAnchor.BottomCenter, new Vector2(0.0f, 40f));
    window.AddContentText(this.prefabs.windowContentText, UIPivot.BottomCenter, Rewired.UI.UIAnchor.BottomHStretch, Vector2.zero, "");
  ...
  public void CreateInputFieldColumn(
    string name,
          ...
          for (int index2 = 0; index2 < actionCategoryIds.Count; ++index2)
          {
            ...
            if (actionCategory != null && actionCategory.userAssignable && this.CountIEnumerable<InputAction>(ReInput.mapping.UserAssignableActionsInCategory(actionCategory.id)) != 0)
            {
              if (this._showActionCategoryLabels)
              {
                ...
                Rewired.UI.ControlMapper.ControlMapper.GUILabel label = this.CreateLabel(actionCategory.descriptiveName, gridActionColumn, new Vector2(0.0f, (float) y1));
              ...
              foreach (InputAction inputAction in ReInput.mapping.UserAssignableActionsInCategory(actionCategory.id, true))
              {
                if (inputAction.type == InputActionType.Axis)
                {
                  if (this._showFullAxisInputFields)
                  {
                    Rewired.UI.ControlMapper.ControlMapper.GUILabel label = this.CreateLabel(inputAction.descriptiveName, gridActionColumn, new Vector2(0.0f, (float) y1));
                    label.rectTransform.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, (float) this._inputRowHeight);
                  ...
                  if (this._showSplitAxisInputFields)
                  {
                    Rewired.UI.ControlMapper.ControlMapper.GUILabel label1 = this.CreateLabel(!string.IsNullOrEmpty(inputAction.positiveDescriptiveName) ? inputAction.positiveDescriptiveName : inputAction.descriptiveName + " +", gridActionColumn, new Vector2(0.0f, (float) y1));
                    ...
                    y1 -= this._inputRowHeight;
                    Rewired.UI.ControlMapper.ControlMapper.GUILabel label2 = this.CreateLabel(!string.IsNullOrEmpty(inputAction.negativeDescriptiveName) ? inputAction.negativeDescriptiveName : inputAction.descriptiveName + " -", gridActionColumn, new Vector2(0.0f, (float) y1));
            ...
            if (action != null && action.userAssignable)
            {
              ...
              if (actionCategory != null && actionCategory.userAssignable)
              {
                if (action.type == InputActionType.Axis)
                {
                  if (this._showFullAxisInputFields)
                  {
                    Rewired.UI.ControlMapper.ControlMapper.GUILabel label = this.CreateLabel(action.descriptiveName, gridActionColumn, new Vector2(0.0f, (float) y1));
                    label.rectTransform.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, (float) this._inputRowHeight);
                  ...
                  if (this._showSplitAxisInputFields)
                  {
                    Rewired.UI.ControlMapper.ControlMapper.GUILabel label3 = this.CreateLabel(action.positiveDescriptiveName, gridActionColumn, new Vector2(0.0f, (float) y1));
                    ...
                    Rewired.UI.ControlMapper.ControlMapper.GUILabel label4 = this.CreateLabel(action.negativeDescriptiveName, gridActionColumn, new Vector2(0.0f, (float) y2));
  ...
  public void CreateInputFieldSet(
    Transform parent,
    int mapCategoryId,
    InputAction action,
    AxisRange axisRange,
  ...
  public void PopulateInputFieldGroup(
      ...
      if (actionElementMap.elementType == ControllerElementType.Button)
      {
        if (actionSet.axisRange != AxisRange.Full)
        {
          if (actionSet.axisRange == AxisRange.Positive)
          {
            ...
            continue;
          this.inputGrid.PopulateField(this.currentMapCategoryId, actionSet.actionId, actionSet.axisRange, controllerType, controllerId, index, actionElementMap.id, actionElementMap.elementIdentifierName, false);
        }
        else
          continue;
      }
      else if (actionElementMap.elementType == ControllerElementType.Axis)
      {
        if (actionSet.axisRange == AxisRange.Full)
        {
          if (actionElementMap.axisRange == AxisRange.Full)
            this.inputGrid.PopulateField(this.currentMapCategoryId, actionSet.actionId, actionSet.axisRange, controllerType, controllerId, index, actionElementMap.id, actionElementMap.elementIdentifierName, actionElementMap.invert);
          else
            continue;
        }
  ...
  public void DisableInputFieldGroup(
    Rewired.UI.ControlMapper.ControlMapper.InputActionSet actionSet,
    ControllerType controllerType,
    int fieldCount)
  {
  ...
  public void ResetInputGridScrollBar()
  {
  ...
  public void DrawPlayersGroup()
  {
    ...
    for (int playerId = 0; playerId < this.playerCount; ++playerId)
    {
      ...
      if (player != null)
      {
        Rewired.UI.ControlMapper.ControlMapper.GUIButton guiButton = new Rewired.UI.ControlMapper.ControlMapper.GUIButton(UITools.InstantiateGUIObject<ButtonInfo>(this.prefabs.button, this.references.playersGroup.content, $"Player{playerId.ToString()}Button"));
  ...
  public void RedrawControllerGroup()
  {
    ...
    if (this.ShowAssignedControllers())
    {
      ...
      {
        Rewired.UI.ControlMapper.ControlMapper.GUIButton button = this.CreateButton(joystick.name, this.references.assignedControllersGroup.content, Vector2.zero);
  ...
  {
    this.CreateLabel(category.descriptiveName, this.references.inputGridActionColumn, new Vector2(0.0f, (float) (rowCount * this._inputRowHeight) * -1f));
    ++rowCount;
  }

  public Rewired.UI.ControlMapper.ControlMapper.GUILabel CreateLabel(
    string labelText,
    Transform parent,
    Vector2 offset)
  {
  ...
  public Rewired.UI.ControlMapper.ControlMapper.GUIButton CreateButton(
    string labelText,
    Transform parent,
    Vector2 offset)
  {
  ...
  public Rewired.UI.ControlMapper.ControlMapper.GUIButton CreateFitButton(
    string labelText,
    Transform parent,
    Vector2 offset)
  {
  ...
  public Rewired.UI.ControlMapper.ControlMapper.GUIInputField CreateInputField(
    Transform parent,
    Vector2 offset,
    string label,
    int actionId,
  ...
  public Rewired.UI.ControlMapper.ControlMapper.GUIToggle CreateToggle(
    GameObject prefab,
    Transform parent,
    Vector2 offset,
    string label,
  ...
  public GameObject InitializeNewGUIGameObject(
  ...
  public Window OpenWindow(bool closeOthers) => this.OpenWindow(string.Empty, closeOthers);
    ...
    bool closeOthers)
  {
    ...
    window.AddContentText(this.prefabs.windowContentText, UIPivot.TopCenter, Rewired.UI.UIAnchor.TopHStretch, new Vector2(0.0f, -100f), message);
    UnityAction unityAction = (UnityAction) (() => this.OnWindowCancel(window.id));
    window.cancelCallback = unityAction;
    window.CreateButton(this.prefabs.fitButton, UIPivot.BottomLeft, Rewired.UI.UIAnchor.BottomLeft, Vector2.zero, confirmText, (UnityAction) (() => this.OnRestoreDefaultsConfirmed(window.id)), unityAction, false);
  ...
  public bool HasElementAssignmentConflicts(
    Player player,
    Rewired.UI.ControlMapper.ControlMapper.InputMapping mapping,
    ElementAssignment assignment,
    bool skipOtherPlayers)
  ...
  public bool IsBlockingAssignmentConflict(
    Rewired.UI.ControlMapper.ControlMapper.InputMapping mapping,
    ElementAssignment assignment,
    bool skipOtherPlayers)
  {
  ...
  public bool CreateConflictCheck(
    Rewired.UI.ControlMapper.ControlMapper.InputMapping mapping,
    ElementAssignment assignment,
  ...
  public void PollKeyboardForAssignment(
    ...
    out string label)
  {
    ...
    else
    {
      ...
      if (num == 1)
      {
        if ((double) ReInput.controllers.Keyboard.GetKeyTimePressed(controllerPollingInfo2.keyboardKey) > 1.0)
          pollingInfo = controllerPollingInfo2;
        else
          label = Keyboard.GetKeyName(controllerPollingInfo2.keyboardKey);
      }
      else
        label = Keyboard.ModifierKeyFlagsToString(flags);
    }
  }

  public bool GetFirstElementAssignmentConflict(
    ElementAssignmentConflictCheck conflictCheck,
  ...
  public void ClearVarsOnPlayerChange() => this.currentJoystickId = -1;

  public void ClearVarsOnJoystickChange() => this.currentJoystickId = -1;
  ...
  public void SetActionAxisInverted(
    bool state,
    ControllerType controllerType,
  ...
  public ControllerMap GetControllerMapOrCreateNew(
    ControllerType controllerType,
    int controllerId,
    int layoutId)
  {
  ...
  public void SubscribeRewiredInputEventAllPlayers(
    int actionId,
    Action<InputActionEventData> callback)
  {
    ...
    {
      Debug.LogWarning((object) $"Rewired Control Mapper: {actionId.ToString()} is not a valid Action id!");
    }
    else
    {
  ...
  public void UnsubscribeRewiredInputEventAllPlayers(
    int actionId,
    Action<InputActionEventData> callback)
  {
  ...
  public bool IsAllowedAssignment(
  ...
  public int GetControllerInputFieldCount(ControllerType controllerType)
  {
    switch (controllerType)
    {
      case ControllerType.Keyboard:
  ...
  public bool SwapIsSameInputRange(
  ...
  {
    return (UnityEngine.Object) Rewired.UI.ControlMapper.ControlMapper.Instance == (UnityEngine.Object) null ? (LanguageData) null : Rewired.UI.ControlMapper.ControlMapper.Instance._language;
  }
  ...
  public abstract class GUIElement
  {
    ...
    public List<Rewired.UI.ControlMapper.ControlMapper.GUIElement> children;
    [CompilerGenerated]
  ...
  public class GUIButton : Rewired.UI.ControlMapper.ControlMapper.GUIElement
  {
    public UnityEngine.UI.Button button => this.selectable as UnityEngine.UI.Button;
    ...
    public GUIButton(UnityEngine.UI.Button button, Text label)
  ...
  public class GUIInputField : Rewired.UI.ControlMapper.ControlMapper.GUIElement
  {
    [CompilerGenerated]
    public Rewired.UI.ControlMapper.ControlMapper.GUIToggle \u003Ctoggle\u003Ek__BackingField;
    ...
    public Rewired.UI.ControlMapper.ControlMapper.GUIToggle toggle
    {
      get => this.\u003Ctoggle\u003Ek__BackingField;
      set => this.\u003Ctoggle\u003Ek__BackingField = value;
    }
    ...
    public GUIInputField(UnityEngine.UI.Button button, Text label)
      : base((Selectable) button, label)
    {
      this.Init();
    }
  ...
  public class GUIToggle : Rewired.UI.ControlMapper.ControlMapper.GUIElement
  {
    public UnityEngine.UI.Toggle toggle => this.selectable as UnityEngine.UI.Toggle;
    ...
    public GUIToggle(UnityEngine.UI.Toggle toggle, Text label)
  ...
  {
    [CompilerGenerated]
    public GameObject \u003CgameObject\u003Ek__BackingField;
    [CompilerGenerated]
    public Text \u003Ctext\u003Ek__BackingField;
    [CompilerGenerated]
    public RectTransform \u003CrectTransform\u003Ek__BackingField;

    public GameObject gameObject
    {
      get => this.\u003CgameObject\u003Ek__BackingField;
      set => this.\u003CgameObject\u003Ek__BackingField = value;
    }
  ...
  public class MappingSet
  {
    ...
    public Rewired.UI.ControlMapper.ControlMapper.MappingSet.ActionListMode _actionListMode;
    [SerializeField]
  ...
  public class InputBehaviorSettings
  {
    ...
    public UnityEngine.Sprite _joystickAxisSensitivityIcon;
    [SerializeField]
    [Tooltip("The icon to display next to the slider. Set to none for no icon.")]
    public UnityEngine.Sprite _mouseXYAxisSensitivityIcon;
    [SerializeField]
    ...
    public UnityEngine.Sprite joystickAxisSensitivityIcon => this._joystickAxisSensitivityIcon;

    public UnityEngine.Sprite mouseXYAxisSensitivityIcon => this._mouseXYAxisSensitivityIcon;
  ...
  public class References
  {
    ...
    [SerializeField]
    public UnityEngine.UI.Button _removeControllerButton;
    [SerializeField]
    public UnityEngine.UI.Button _assignControllerButton;
    [SerializeField]
    public UnityEngine.UI.Button _calibrateControllerButton;
    [SerializeField]
    public UnityEngine.UI.Button _doneButton;
    [SerializeField]
    public UnityEngine.UI.Button _restoreDefaultsButton;
    [SerializeField]
    ...
    [CompilerGenerated]
    public LayoutElement \u003CinputGridLayoutElement\u003Ek__BackingField;
    [CompilerGenerated]
    public Transform \u003CinputGridActionColumn\u003Ek__BackingField;
    [CompilerGenerated]
    public Transform \u003CinputGridKeyboardColumn\u003Ek__BackingField;
    [CompilerGenerated]
    public Transform \u003CinputGridMouseColumn\u003Ek__BackingField;
    [CompilerGenerated]
    public Transform \u003CinputGridControllerColumn\u003Ek__BackingField;
    [CompilerGenerated]
    public Transform \u003CinputGridHeader1\u003Ek__BackingField;
    [CompilerGenerated]
    public Transform \u003CinputGridHeader2\u003Ek__BackingField;
    [CompilerGenerated]
    public Transform \u003CinputGridHeader3\u003Ek__BackingField;
    [CompilerGenerated]
    public Transform \u003CinputGridHeader4\u003Ek__BackingField;
    ...
    public Text controllerNameLabel => this._controllerNameLabel;
    ...
    {
      get => this.\u003CinputGridLayoutElement\u003Ek__BackingField;
      set => this.\u003CinputGridLayoutElement\u003Ek__BackingField = value;
    }

    public Transform inputGridActionColumn
    {
      get => this.\u003CinputGridActionColumn\u003Ek__BackingField;
      set => this.\u003CinputGridActionColumn\u003Ek__BackingField = value;
    }

    public Transform inputGridKeyboardColumn
    {
      get => this.\u003CinputGridKeyboardColumn\u003Ek__BackingField;
      set => this.\u003CinputGridKeyboardColumn\u003Ek__BackingField = value;
    }

    public Transform inputGridMouseColumn
    {
      get => this.\u003CinputGridMouseColumn\u003Ek__BackingField;
      set => this.\u003CinputGridMouseColumn\u003Ek__BackingField = value;
    }

    public Transform inputGridControllerColumn
    {
      get => this.\u003CinputGridControllerColumn\u003Ek__BackingField;
      set => this.\u003CinputGridControllerColumn\u003Ek__BackingField = value;
    }

    public Transform inputGridHeader1
    {
      get => this.\u003CinputGridHeader1\u003Ek__BackingField;
      set => this.\u003CinputGridHeader1\u003Ek__BackingField = value;
    }

    public Transform inputGridHeader2
    {
      get => this.\u003CinputGridHeader2\u003Ek__BackingField;
      set => this.\u003CinputGridHeader2\u003Ek__BackingField = value;
    }

    public Transform inputGridHeader3
    {
      get => this.\u003CinputGridHeader3\u003Ek__BackingField;
      set => this.\u003CinputGridHeader3\u003Ek__BackingField = value;
    }

    public Transform inputGridHeader4
    {
      get => this.\u003CinputGridHeader4\u003Ek__BackingField;
      set => this.\u003CinputGridHeader4\u003Ek__BackingField = value;
    }
  ...
  public class InputMapping
  {
    ...
    [CompilerGenerated]
    public InputFieldInfo \u003CfieldInfo\u003Ek__BackingField;
    [CompilerGenerated]
    public ControllerMap \u003Cmap\u003Ek__BackingField;
    [CompilerGenerated]
    public ActionElementMap \u003Caem\u003Ek__BackingField;
    [CompilerGenerated]
    public ControllerType \u003CcontrollerType\u003Ek__BackingField;
    [CompilerGenerated]
    public int \u003CcontrollerId\u003Ek__BackingField;
    [CompilerGenerated]
    public ControllerPollingInfo \u003CpollingInfo\u003Ek__BackingField;
    [CompilerGenerated]
    public ModifierKeyFlags \u003CmodifierKeyFlags\u003Ek__BackingField;
    ...
    public InputFieldInfo fieldInfo
    {
      ...
      set => this.\u003CfieldInfo\u003Ek__BackingField = value;
    }

    public ControllerMap map
    {
      get => this.\u003Cmap\u003Ek__BackingField;
      set => this.\u003Cmap\u003Ek__BackingField = value;
    }

    public ActionElementMap aem
    {
      get => this.\u003Caem\u003Ek__BackingField;
      set => this.\u003Caem\u003Ek__BackingField = value;
    }
    ...
    {
      get => this.\u003CpollingInfo\u003Ek__BackingField;
      set => this.\u003CpollingInfo\u003Ek__BackingField = value;
    }

    public ModifierKeyFlags modifierKeyFlags
    {
      get => this.\u003CmodifierKeyFlags\u003Ek__BackingField;
      set => this.\u003CmodifierKeyFlags\u003Ek__BackingField = value;
    }
    ...
    public string elementName
    {
      get
      {
        if (this.controllerType == ControllerType.Keyboard && this.modifierKeyFlags != ModifierKeyFlags.None)
          return $"{Keyboard.ModifierKeyFlagsToString(this.modifierKeyFlags)} + {this.pollingInfo.elementIdentifierName}";
        string elementName = this.pollingInfo.elementIdentifierName;
        ...
        if (pollingInfo.elementType == ControllerElementType.Axis)
        {
          if (this.axisRange == AxisRange.Positive)
          {
            ...
            elementName = pollingInfo.elementIdentifier.positiveName;
          }
          else if (this.axisRange == AxisRange.Negative)
          {
            pollingInfo = this.pollingInfo;
            elementName = pollingInfo.elementIdentifier.negativeName;
          }
        }
        return elementName;
      }
  ...
  {
    public List<Rewired.UI.ControlMapper.ControlMapper.IndexedDictionary<TKey, TValue>.Entry> list;
  ...
  {
    public Rewired.UI.ControlMapper.ControlMapper.InputGridEntryList list;
  ...
  {
    public Rewired.UI.ControlMapper.ControlMapper.IndexedDictionary<int, Rewired.UI.ControlMapper.ControlMapper.InputGridEntryList.MapCategoryEntry> entries;
    ...
    public Rewired.UI.ControlMapper.ControlMapper.InputGridEntryList.ActionEntry AddActionEntry(
      int mapCategoryId,
      InputAction action,
      AxisRange axisRange)
    {
    ...
    public Rewired.UI.ControlMapper.ControlMapper.InputGridEntryList.ActionCategoryEntry AddActionCategoryEntry(
      int mapCategoryId,
      int actionCategoryId)
    {
      Rewired.UI.ControlMapper.ControlMapper.InputGridEntryList.MapCategoryEntry mapCategoryEntry;
    ...
    {
      public List<Rewired.UI.ControlMapper.ControlMapper.InputGridEntryList.ActionEntry> _actionList;
      public Rewired.UI.ControlMapper.ControlMapper.IndexedDictionary<int, Rewired.UI.ControlMapper.ControlMapper.InputGridEntryList.ActionCategoryEntry> _actionCategoryList;
    ...
    {
      public Rewired.UI.ControlMapper.ControlMapper.IndexedDictionary<int, Rewired.UI.ControlMapper.ControlMapper.InputGridEntryList.FieldSet> fieldSets;
      public Rewired.UI.ControlMapper.ControlMapper.GUILabel label;
      public InputAction action;
      public AxisRange axisRange;
      public Rewired.UI.ControlMapper.ControlMapper.InputActionSet actionSet;
    ...
    public class FieldSet
    {
      ...
      public Rewired.UI.ControlMapper.ControlMapper.IndexedDictionary<int, Rewired.UI.ControlMapper.ControlMapper.GUIInputField> fields;
  ...
  public class WindowManager
  {
    ...
    public void SetFaderActive(bool state) => this.fader.SetActive(state);
