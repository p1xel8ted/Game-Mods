...
// Type: Expressive.Operators.Multiplicative.DivideOperator
...
public class DivideOperator : OperatorBase
{
  ...
  {
    return (IExpression) new BinaryExpression(BinaryExpressionType.Divide, expressions[0], expressions[1]);
  }
