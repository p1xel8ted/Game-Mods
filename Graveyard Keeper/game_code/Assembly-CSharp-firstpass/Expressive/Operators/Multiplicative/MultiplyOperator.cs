...
// Type: Expressive.Operators.Multiplicative.MultiplyOperator
...
public class MultiplyOperator : OperatorBase
{
  ...
  {
    return (IExpression) new BinaryExpression(BinaryExpressionType.Multiply, expressions[0], expressions[1]);
  }
