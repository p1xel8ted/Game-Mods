...
// Type: Expressive.Operators.Multiplicative.ModulusOperator
...
public class ModulusOperator : OperatorBase
{
  ...
  {
    get => new string[2]{ "%", "mod" };
  }

  public override IExpression BuildExpression(Token previousToken, IExpression[] expressions)
  {
    return (IExpression) new BinaryExpression(BinaryExpressionType.Modulus, expressions[0], expressions[1]);
  }
