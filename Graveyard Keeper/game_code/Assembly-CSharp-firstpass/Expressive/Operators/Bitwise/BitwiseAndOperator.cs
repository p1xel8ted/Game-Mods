...
// Type: Expressive.Operators.Bitwise.BitwiseAndOperator
...
public class BitwiseAndOperator : OperatorBase
{
  ...
  {
    return (IExpression) new BinaryExpression(BinaryExpressionType.BitwiseAnd, expressions[0], expressions[1]);
  }
