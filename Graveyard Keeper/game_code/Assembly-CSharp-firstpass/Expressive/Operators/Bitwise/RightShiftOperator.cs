...
// Type: Expressive.Operators.Bitwise.RightShiftOperator
...
public class RightShiftOperator : OperatorBase
{
  ...
  {
    return (IExpression) new BinaryExpression(BinaryExpressionType.RightShift, expressions[0], expressions[1]);
  }
