...
// Type: Expressive.Operators.Relational.GreaterThanOperator
...
public class GreaterThanOperator : OperatorBase
{
  ...
  {
    return (IExpression) new BinaryExpression(BinaryExpressionType.GreaterThan, expressions[0], expressions[1]);
  }
