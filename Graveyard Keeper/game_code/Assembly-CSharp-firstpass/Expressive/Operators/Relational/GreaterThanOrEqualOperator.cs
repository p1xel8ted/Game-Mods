...
// Type: Expressive.Operators.Relational.GreaterThanOrEqualOperator
...
public class GreaterThanOrEqualOperator : OperatorBase
{
  ...
  {
    return (IExpression) new BinaryExpression(BinaryExpressionType.GreaterThanOrEqual, expressions[0], expressions[1]);
  }
