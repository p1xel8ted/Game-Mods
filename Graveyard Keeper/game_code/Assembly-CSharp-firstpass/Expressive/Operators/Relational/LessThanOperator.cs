...
// Type: Expressive.Operators.Relational.LessThanOperator
...
public class LessThanOperator : OperatorBase
{
  ...
  {
    return (IExpression) new BinaryExpression(BinaryExpressionType.LessThan, expressions[0], expressions[1]);
  }
