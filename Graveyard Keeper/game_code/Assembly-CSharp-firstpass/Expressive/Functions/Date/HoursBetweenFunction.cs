...
// Type: Expressive.Functions.Date.HoursBetweenFunction
...
public sealed class HoursBetweenFunction : FunctionBase
{
  ...
  public override object Evaluate(IExpression[] parameters)
  {
    ...
    return (object) (Convert.ToDateTime(obj2) - dateTime).TotalHours;
  }
}
