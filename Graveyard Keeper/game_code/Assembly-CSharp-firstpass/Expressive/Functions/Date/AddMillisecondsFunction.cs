...
// Type: Expressive.Functions.Date.AddMillisecondsFunction
...
public sealed class AddMillisecondsFunction : FunctionBase
{
  ...
  public override object Evaluate(IExpression[] parameters)
  {
    ...
    return obj1 == null || obj2 == null ? (object) null : (object) Convert.ToDateTime(obj1).AddMilliseconds(Convert.ToDouble(obj2));
  }
}
