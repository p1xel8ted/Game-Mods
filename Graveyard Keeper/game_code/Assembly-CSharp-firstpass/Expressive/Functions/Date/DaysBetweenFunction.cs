...
// Type: Expressive.Functions.Date.DaysBetweenFunction
...
public sealed class DaysBetweenFunction : FunctionBase
{
  ...
  public override object Evaluate(IExpression[] parameters)
  {
    ...
    return (object) (Convert.ToDateTime(obj2) - dateTime).TotalDays;
  }
}
