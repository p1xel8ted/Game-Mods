...
// Type: Expressive.Functions.Date.MinutesBetweenFunction
...
public sealed class MinutesBetweenFunction : FunctionBase
{
  ...
  public override object Evaluate(IExpression[] parameters)
  {
    ...
    return (object) (Convert.ToDateTime(obj2) - dateTime).TotalMinutes;
  }
}
