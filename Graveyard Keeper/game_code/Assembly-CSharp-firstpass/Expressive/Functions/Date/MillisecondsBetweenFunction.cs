...
// Type: Expressive.Functions.Date.MillisecondsBetweenFunction
...
public sealed class MillisecondsBetweenFunction : FunctionBase
{
  ...
  public override object Evaluate(IExpression[] parameters)
  {
    ...
    return (object) (Convert.ToDateTime(obj2) - dateTime).TotalMilliseconds;
  }
}
