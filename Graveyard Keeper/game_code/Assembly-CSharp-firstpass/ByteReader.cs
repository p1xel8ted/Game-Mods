...
public class ByteReader
{
  public byte[] mBuffer;
  public int mOffset;
  public static BetterList<string> mTemp = new BetterList<string>();
  ...
  public static string ReadLine(byte[] buffer, int start, int count)
  {
  ...
  public string ReadLine(bool skipEmptyLines)
  {
    ...
    if (skipEmptyLines)
    {
      while (this.mOffset < length && this.mBuffer[this.mOffset] < (byte) 32 /*0x20*/)
        ++this.mOffset;
    }
