...
public class TweenLetters : UITweener
{
  ...
  public int mVertexCount = -1;
  public int[] mLetterOrder;
  public TweenLetters.LetterProperties[] mLetter;
  public TweenLetters.AnimationProperties mCurrent;
    ...
    List<Color> cols)
  {
    ...
    if (verts == null || count == 0 || (UnityEngine.Object) this.mLabel == (UnityEngine.Object) null)
      return;
      ...
      for (int index2 = 0; index2 < letterCount; ++index2)
      {
        ...
        if (firstVert < count)
        {
          ...
          for (int index4 = firstVert; index4 < firstVert + 4; ++index4)
          {
            ...
            Color col = cols[index4] with { a = num2 };
            cols[index4] = col;
          }
        }
      }
  ...
  public override void OnUpdate(float factor, bool isFinished) => this.mLabel.MarkAsChanged();

  public void SetLetterOrder(int letterCount)
  {
    if (letterCount == 0)
    {
  ...
  public void GetLetterDuration(int letterCount)
  {
  ...
  public float ScaleRange(float value, float baseMax, float limitMax) => limitMax * value / baseMax;

  public static Vector3 GetCenter(List<Vector3> verts, int firstVert, int length)
  {
