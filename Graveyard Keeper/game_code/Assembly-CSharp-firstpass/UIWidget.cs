...
public class UIWidget : UIRect
{
  ...
  [SerializeField]
  [HideInInspector]
  public UIWidget.Pivot mPivot = UIWidget.Pivot.Center;
  [SerializeField]
  [HideInInspector]
  ...
  [NonSerialized]
  public bool mPlayMode = true;
  [NonSerialized]
  public Vector4 mDrawRegion = new Vector4(0.0f, 0.0f, 1f, 1f);
  [NonSerialized]
  public Matrix4x4 mLocalToPanel;
  [NonSerialized]
  public bool mIsVisibleByAlpha = true;
  [NonSerialized]
  public bool mIsVisibleByPanel = true;
  [NonSerialized]
  public bool mIsInFront = true;
  [NonSerialized]
  ...
  [NonSerialized]
  public Vector3[] mCorners = new Vector3[4];
  [NonSerialized]
  public int mAlphaFrameID = -1;
  public int mMatrixFrame = -1;
  public Vector3 mOldV0;
  public Vector3 mOldV1;
  ...
  public virtual Texture mainTexture
  {
    ...
    set
    {
      throw new NotImplementedException(this.GetType()?.ToString() + " has no mainTexture setter");
    }
  }
  ...
  public bool hasBoxCollider
  {
    get
    {
      return (UnityEngine.Object) (this.GetComponent<Collider>() as BoxCollider) != (UnityEngine.Object) null || (UnityEngine.Object) this.GetComponent<BoxCollider2D>() != (UnityEngine.Object) null;
    }
  }
  ...
  public void UpdateFinalAlpha(int frameID)
  {
  ...
  public virtual void UpgradeFrom265()
  {
  ...
  public override void OnStart() => this.CreatePanel();
  ...
  public void OnDestroy() => this.RemoveFromPanel();
