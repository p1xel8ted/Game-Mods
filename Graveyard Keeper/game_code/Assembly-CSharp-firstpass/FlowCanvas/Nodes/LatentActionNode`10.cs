  ...
  LatentActionNodeBase
{
  ...
  public sealed override void OnRegisterDerivedPorts(FlowNode node)
  {
    ...
    ValueInput<T10> p10 = node.AddValueInput<T10>(this.parameters[9].Name);
    node.AddFlowInput("In", (FlowHandler) (f => this.Begin(this.Invoke(p1.value, p2.value, p3.value, p4.value, p5.value, p6.value, p7.value, p8.value, p9.value, p10.value), f)));
  }
}
