...
// Type: FlowCanvas.Nodes.Legacy.ReflectedFunctionNode`5
...
{
  public ReflectedMethodNode.FunctionCall<T1, T2, T3, T4, TResult> call;
  public TResult returnValue;
  public T1 instance;

  public TResult Call(T1 a, T2 b, T3 c, T4 d)
  {
    this.instance = a;
    return this.returnValue = this.call(a, b, c, d);
  }
  ...
  {
    this.call = method.RTCreateDelegate<ReflectedMethodNode.FunctionCall<T1, T2, T3, T4, TResult>>((object) null);
    ...
    if (options.callable)
    {
      ...
      {
        this.Call(p1.value, p2.value, p3.value, p4.value);
        o.Call(f);
      }));
      if (!method.IsStatic)
        node.AddValueOutput<T1>(this.GetName(method, 0), (ValueHandler<T1>) (() => this.instance));
    }
    node.AddValueOutput<TResult>("Value", (ValueHandler<TResult>) (() => !options.callable ? this.Call(p1.value, p2.value, p3.value, p4.value) : this.returnValue));
  }
}
