...
// Type: FlowCanvas.Nodes.Legacy.ReflectedFunctionNode`8
...
{
  public ReflectedMethodNode.FunctionCall<T1, T2, T3, T4, T5, T6, T7, TResult> call;
  public TResult returnValue;
  public T1 instance;

  public TResult Call(T1 a, T2 b, T3 c, T4 d, T5 e, T6 f, T7 g)
  {
    this.instance = a;
    return this.returnValue = this.call(a, b, c, d, e, f, g);
  }
  ...
  {
    this.call = method.RTCreateDelegate<ReflectedMethodNode.FunctionCall<T1, T2, T3, T4, T5, T6, T7, TResult>>((object) null);
    ...
    if (options.callable)
    {
      ...
      {
        this.Call(p1.value, p2.value, p3.value, p4.value, p5.value, p6.value, p7.value);
        o.Call(f);
      }));
      if (!method.IsStatic)
        node.AddValueOutput<T1>(this.GetName(method, 0), (ValueHandler<T1>) (() => this.instance));
    }
    node.AddValueOutput<TResult>("Value", (ValueHandler<TResult>) (() => !options.callable ? this.Call(p1.value, p2.value, p3.value, p4.value, p5.value, p6.value, p7.value) : this.returnValue));
  }
}
