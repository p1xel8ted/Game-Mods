...
// Type: FlowCanvas.Nodes.Legacy.ReflectedFunctionNode`4
...
{
  public ReflectedMethodNode.FunctionCall<T1, T2, T3, TResult> call;
  public TResult returnValue;
  public T1 instance;

  public TResult Call(T1 a, T2 b, T3 c)
  {
    this.instance = a;
    return this.returnValue = this.call(a, b, c);
  }
  ...
  {
    this.call = method.RTCreateDelegate<ReflectedMethodNode.FunctionCall<T1, T2, T3, TResult>>((object) null);
    ...
    node.AddValueOutput<TResult>("Value", (ValueHandler<TResult>) (() => !options.callable ? this.Call(p1.value, p2.value, p3.value) : this.returnValue));
  }
}
