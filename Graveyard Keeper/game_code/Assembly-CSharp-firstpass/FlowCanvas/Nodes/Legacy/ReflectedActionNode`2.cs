...
// Type: FlowCanvas.Nodes.Legacy.ReflectedActionNode`2
...
{
  public ReflectedMethodNode.ActionCall<T1, T2> call;
  public T1 instance;
  ...
  {
    this.call = method.RTCreateDelegate<ReflectedMethodNode.ActionCall<T1, T2>>((object) null);
