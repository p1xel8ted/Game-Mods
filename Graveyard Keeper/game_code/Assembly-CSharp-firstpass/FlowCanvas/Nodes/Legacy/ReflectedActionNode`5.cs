...
// Type: FlowCanvas.Nodes.Legacy.ReflectedActionNode`5
...
{
  public ReflectedMethodNode.ActionCall<T1, T2, T3, T4, T5> call;
  public T1 instance;

  public void Call(T1 a, T2 b, T3 c, T4 d, T5 e)
  {
    this.instance = a;
    this.call(a, b, c, d, e);
  }
  ...
  {
    this.call = method.RTCreateDelegate<ReflectedMethodNode.ActionCall<T1, T2, T3, T4, T5>>((object) null);
