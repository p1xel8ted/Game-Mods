...
// Type: FlowCanvas.Nodes.Legacy.ReflectedActionNode`8
...
{
  public ReflectedMethodNode.ActionCall<T1, T2, T3, T4, T5, T6, T7, T8> call;
  public T1 instance;

  public void Call(T1 a, T2 b, T3 c, T4 d, T5 e, T6 f, T7 g, T8 h)
  {
    this.instance = a;
    this.call(a, b, c, d, e, f, g, h);
  }
  ...
  {
    this.call = method.RTCreateDelegate<ReflectedMethodNode.ActionCall<T1, T2, T3, T4, T5, T6, T7, T8>>((object) null);
