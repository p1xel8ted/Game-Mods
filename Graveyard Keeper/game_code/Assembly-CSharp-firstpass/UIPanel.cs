...
public class UIPanel : UIRect
{
  ...
  [SerializeField]
  [HideInInspector]
  public Texture2D mClipTexture;
  [HideInInspector]
  [SerializeField]
  public float mAlpha = 1f;
  [HideInInspector]
  [SerializeField]
  public UIDrawCall.Clipping mClipping;
  [HideInInspector]
  [SerializeField]
  public Vector4 mClipRange = new Vector4(0.0f, 0.0f, 300f, 200f);
  [SerializeField]
  [HideInInspector]
  public Vector2 mClipSoftness = new Vector2(4f, 4f);
  [HideInInspector]
  [SerializeField]
  public int mDepth;
  [SerializeField]
  ...
  public bool mRebuild;
  public bool mResized;
  [SerializeField]
  public Vector2 mClipOffset = Vector2.zero;
  public int mMatrixFrame = -1;
  public int mAlphaFrameID;
  public int mLayer = -1;
  public static float[] mTemp = new float[4];
  public Vector2 mMin = Vector2.zero;
  public Vector2 mMax = Vector2.zero;
  public bool mSortWidgets;
  public bool mUpdateScroll;
  public bool useSortingOrder;
  public UIPanel mParentPanel;
  public static Vector3[] mCorners = new Vector3[4];
  public new static int mUpdateFrame = -1;
  [NonSerialized]
  public bool mHasMoved;
  ...
  public override void OnStart() => this.mLayer = this.cachedGameObject.layer;
  ...
  public override void OnInit()
  {
    ...
    {
      UICamera component = (UnityEngine.Object) this.anchorCamera != (UnityEngine.Object) null ? this.mCam.GetComponent<UICamera>() : (UICamera) null;
      if ((UnityEngine.Object) component != (UnityEngine.Object) null && (component.eventType == UICamera.EventType.UI_3D || component.eventType == UICamera.EventType.World_3D))
      {
  ...
  public void UpdateDrawCalls(int sortOrder)
  {
