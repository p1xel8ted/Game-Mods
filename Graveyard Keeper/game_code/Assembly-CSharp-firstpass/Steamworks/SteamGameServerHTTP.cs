...
public static class SteamGameServerHTTP
{
    ...
    string pchAbsoluteURL)
  {
    ...
    using (InteropHelp.UTF8StringHandle pchAbsoluteURL1 = new InteropHelp.UTF8StringHandle(pchAbsoluteURL))
      return (HTTPRequestHandle) NativeMethods.ISteamHTTP_CreateHTTPRequest(CSteamGameServerAPIContext.GetSteamHTTP(), eHTTPRequestMethod, pchAbsoluteURL1);
  }
    ...
    string pchHeaderValue)
  {
    ...
    using (InteropHelp.UTF8StringHandle pchHeaderName1 = new InteropHelp.UTF8StringHandle(pchHeaderName))
    {
      using (InteropHelp.UTF8StringHandle pchHeaderValue1 = new InteropHelp.UTF8StringHandle(pchHeaderValue))
        return NativeMethods.ISteamHTTP_SetHTTPRequestHeaderValue(CSteamGameServerAPIContext.GetSteamHTTP(), hRequest, pchHeaderName1, pchHeaderValue1);
    }
  }
    ...
    string pchParamValue)
  {
    ...
    using (InteropHelp.UTF8StringHandle pchParamName1 = new InteropHelp.UTF8StringHandle(pchParamName))
    {
      using (InteropHelp.UTF8StringHandle pchParamValue1 = new InteropHelp.UTF8StringHandle(pchParamValue))
        return NativeMethods.ISteamHTTP_SetHTTPRequestGetOrPostParameter(CSteamGameServerAPIContext.GetSteamHTTP(), hRequest, pchParamName1, pchParamValue1);
    }
  }
    ...
    out uint unResponseHeaderSize)
  {
    InteropHelp.TestIfAvailableGameServer();
    using (InteropHelp.UTF8StringHandle pchHeaderName1 = new InteropHelp.UTF8StringHandle(pchHeaderName))
      return NativeMethods.ISteamHTTP_GetHTTPResponseHeaderSize(CSteamGameServerAPIContext.GetSteamHTTP(), hRequest, pchHeaderName1, out unResponseHeaderSize);
  }
    ...
    uint unBufferSize)
  {
    InteropHelp.TestIfAvailableGameServer();
    using (InteropHelp.UTF8StringHandle pchHeaderName1 = new InteropHelp.UTF8StringHandle(pchHeaderName))
      return NativeMethods.ISteamHTTP_GetHTTPResponseHeaderValue(CSteamGameServerAPIContext.GetSteamHTTP(), hRequest, pchHeaderName1, pHeaderValueBuffer, unBufferSize);
  }
    ...
    uint unBodyLen)
  {
    ...
    using (InteropHelp.UTF8StringHandle pchContentType1 = new InteropHelp.UTF8StringHandle(pchContentType))
      return NativeMethods.ISteamHTTP_SetHTTPRequestRawPostBody(CSteamGameServerAPIContext.GetSteamHTTP(), hRequest, pchContentType1, pubBody, unBodyLen);
  }
    ...
    using (InteropHelp.UTF8StringHandle pchHost1 = new InteropHelp.UTF8StringHandle(pchHost))
    {
      using (InteropHelp.UTF8StringHandle pchUrl1 = new InteropHelp.UTF8StringHandle(pchUrl))
      {
        using (InteropHelp.UTF8StringHandle pchCookie1 = new InteropHelp.UTF8StringHandle(pchCookie))
          return NativeMethods.ISteamHTTP_SetCookie(CSteamGameServerAPIContext.GetSteamHTTP(), hCookieContainer, pchHost1, pchUrl1, pchCookie1);
      }
    }
  }
    ...
    string pchUserAgentInfo)
  {
    ...
    using (InteropHelp.UTF8StringHandle pchUserAgentInfo1 = new InteropHelp.UTF8StringHandle(pchUserAgentInfo))
      return NativeMethods.ISteamHTTP_SetHTTPRequestUserAgentInfo(CSteamGameServerAPIContext.GetSteamHTTP(), hRequest, pchUserAgentInfo1);
  }
