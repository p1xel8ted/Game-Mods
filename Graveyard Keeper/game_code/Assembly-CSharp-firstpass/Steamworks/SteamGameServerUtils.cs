...
public static class SteamGameServerUtils
{
  ...
  public static SteamAPICall_t CheckFileSignature(string szFileName)
  {
    ...
    using (InteropHelp.UTF8StringHandle szFileName1 = new InteropHelp.UTF8StringHandle(szFileName))
      return (SteamAPICall_t) NativeMethods.ISteamUtils_CheckFileSignature(CSteamGameServerAPIContext.GetSteamUtils(), szFileName1);
  }
    ...
    string pchExistingText)
  {
    ...
    using (InteropHelp.UTF8StringHandle pchDescription1 = new InteropHelp.UTF8StringHandle(pchDescription))
    {
      using (InteropHelp.UTF8StringHandle pchExistingText1 = new InteropHelp.UTF8StringHandle(pchExistingText))
        return NativeMethods.ISteamUtils_ShowGamepadTextInput(CSteamGameServerAPIContext.GetSteamUtils(), eInputMode, eLineInputMode, pchDescription1, unCharMax, pchExistingText1);
    }
  }
  ...
  public static bool GetEnteredGamepadTextInput(out string pchText, uint cchText)
  {
    ...
    bool gamepadTextInput = NativeMethods.ISteamUtils_GetEnteredGamepadTextInput(CSteamGameServerAPIContext.GetSteamUtils(), num, cchText);
