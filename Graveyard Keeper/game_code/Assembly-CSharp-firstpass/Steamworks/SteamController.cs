...
public static class SteamController
{
  ...
  {
    InteropHelp.TestIfAvailableClient();
    return handlesOut.Length == 16 /*0x10*/ ? NativeMethods.ISteamController_GetConnectedControllers(CSteamAPIContext.GetSteamController(), handlesOut) : throw new ArgumentException("handlesOut must be the same size as Constants.STEAM_CONTROLLER_MAX_COUNT!");
  }
  ...
  public static ControllerActionSetHandle_t GetActionSetHandle(string pszActionSetName)
  {
    ...
    using (InteropHelp.UTF8StringHandle pszActionSetName1 = new InteropHelp.UTF8StringHandle(pszActionSetName))
      return (ControllerActionSetHandle_t) NativeMethods.ISteamController_GetActionSetHandle(CSteamAPIContext.GetSteamController(), pszActionSetName1);
  }
  ...
  public static void ActivateActionSetLayer(
    ControllerHandle_t controllerHandle,
  ...
  public static void DeactivateActionSetLayer(
    ControllerHandle_t controllerHandle,
    ControllerActionSetHandle_t actionSetLayerHandle)
  {
    InteropHelp.TestIfAvailableClient();
  ...
  public static int GetActiveActionSetLayers(
    ControllerHandle_t controllerHandle,
  ...
  public static ControllerDigitalActionHandle_t GetDigitalActionHandle(string pszActionName)
  {
    ...
    using (InteropHelp.UTF8StringHandle pszActionName1 = new InteropHelp.UTF8StringHandle(pszActionName))
      return (ControllerDigitalActionHandle_t) NativeMethods.ISteamController_GetDigitalActionHandle(CSteamAPIContext.GetSteamController(), pszActionName1);
  }
  ...
  public static ControllerAnalogActionHandle_t GetAnalogActionHandle(string pszActionName)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pszActionName1 = new InteropHelp.UTF8StringHandle(pszActionName))
      return (ControllerAnalogActionHandle_t) NativeMethods.ISteamController_GetAnalogActionHandle(CSteamAPIContext.GetSteamController(), pszActionName1);
  }
