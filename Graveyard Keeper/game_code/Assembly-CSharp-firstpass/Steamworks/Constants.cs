...
public static class Constants
{
  ...
  public const int k_cubAppProofOfPurchaseKeyMax = 240 /*0xF0*/;
  ...
  public const int k_cchMaxFriendsGroupName = 64 /*0x40*/;
  public const int k_cFriendsGroupLimit = 100;
  public const int k_cEnumerateFollowersMax = 50;
  public const int k_cchPersonaNameMax = 128 /*0x80*/;
  public const int k_cwchPersonaNameMax = 32 /*0x20*/;
  public const int k_cubChatMetadataMax = 8192 /*0x2000*/;
  public const int k_cchMaxRichPresenceKeys = 20;
  public const int k_cchMaxRichPresenceKeyLength = 64 /*0x40*/;
  public const int k_cchMaxRichPresenceValueLength = 256 /*0x0100*/;
  ...
  public const int k_unServerFlagPassworded = 16 /*0x10*/;
  public const int k_unServerFlagPrivate = 32 /*0x20*/;
  ...
  public const int k_unMaxCloudFileChunkSize = 104857600 /*0x06400000*/;
  ...
  public const int k_cchPublishedFileURLMax = 256 /*0x0100*/;
  public const int k_nScreenshotMaxTaggedUsers = 32 /*0x20*/;
  public const int k_nScreenshotMaxTaggedPublishedFiles = 32 /*0x20*/;
  public const int k_cubUFSTagTypeMax = 255 /*0xFF*/;
  public const int k_cubUFSTagValueMax = 255 /*0xFF*/;
  ...
  public const int k_cchStatNameMax = 128 /*0x80*/;
  public const int k_cchLeaderboardNameMax = 128 /*0x80*/;
  public const int k_cLeaderboardDetailsMax = 64 /*0x40*/;
  public const int k_cbMaxGameServerGameDir = 32 /*0x20*/;
  public const int k_cbMaxGameServerMapName = 32 /*0x20*/;
  public const int k_cbMaxGameServerGameDescription = 64 /*0x40*/;
  public const int k_cbMaxGameServerName = 64 /*0x40*/;
  public const int k_cbMaxGameServerTags = 128 /*0x80*/;
  public const int k_cbMaxGameServerGameData = 2048 /*0x0800*/;
  public const int k_unSteamAccountIDMask = -1;
  public const int k_unSteamAccountInstanceMask = 1048575 /*0x0FFFFF*/;
  ...
  public const int k_cchGameExtraInfoMax = 64 /*0x40*/;
  public const int k_nSteamEncryptedAppTicketSymmetricKeyLen = 32 /*0x20*/;
  public const int k_cubSaltSize = 8;
  public const ulong k_GIDNil = 18446744073709551615 /*0xFFFFFFFFFFFFFFFF*/;
  public const ulong k_TxnIDNil = 18446744073709551615 /*0xFFFFFFFFFFFFFFFF*/;
  ...
  public const int STEAM_CONTROLLER_MAX_COUNT = 16 /*0x10*/;
  public const int STEAM_CONTROLLER_MAX_ANALOG_ACTIONS = 16 /*0x10*/;
  public const int STEAM_CONTROLLER_MAX_DIGITAL_ACTIONS = 128 /*0x80*/;
  public const int STEAM_CONTROLLER_MAX_ORIGINS = 8;
  public const ulong STEAM_CONTROLLER_HANDLE_ALL_CONTROLLERS = 18446744073709551615 /*0xFFFFFFFFFFFFFFFF*/;
  ...
  public const ushort MASTERSERVERUPDATERPORT_USEGAMESOCKETSHARE = 65535 /*0xFFFF*/;
  public const int INVALID_HTTPREQUEST_HANDLE = 0;
  public const byte k_nMaxLobbyKeyLength = 255 /*0xFF*/;
  public const int k_SteamMusicNameMaxLength = 255 /*0xFF*/;
  public const int k_SteamMusicPNGMaxLength = 65535 /*0xFFFF*/;
  public const int QUERY_PORT_NOT_INITIALIZED = 65535 /*0xFFFF*/;
