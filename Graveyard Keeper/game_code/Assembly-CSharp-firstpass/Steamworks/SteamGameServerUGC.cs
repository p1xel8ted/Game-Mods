...
public static class SteamGameServerUGC
{
    ...
    uint cchURLSize)
  {
    ...
    bool queryUgcPreviewUrl = NativeMethods.ISteamUGC_GetQueryUGCPreviewURL(CSteamGameServerAPIContext.GetSteamUGC(), handle, index, num, cchURLSize);
    ...
    uint cchMetadatasize)
  {
    ...
    bool queryUgcMetadata = NativeMethods.ISteamUGC_GetQueryUGCMetadata(CSteamGameServerAPIContext.GetSteamUGC(), handle, index, num, cchMetadatasize);
    ...
    out EItemPreviewType pPreviewType)
  {
    ...
    bool additionalPreview = NativeMethods.ISteamUGC_GetQueryUGCAdditionalPreview(CSteamGameServerAPIContext.GetSteamUGC(), handle, index, previewIndex, num1, cchURLSize, num2, cchOriginalFileNameSize, out pPreviewType);
    ...
    uint cchValueSize)
  {
    ...
    bool queryUgcKeyValueTag = NativeMethods.ISteamUGC_GetQueryUGCKeyValueTag(CSteamGameServerAPIContext.GetSteamUGC(), handle, index, keyValueTagIndex, num1, cchKeySize, num2, cchValueSize);
  ...
  public static bool AddRequiredTag(UGCQueryHandle_t handle, string pTagName)
  {
    ...
    using (InteropHelp.UTF8StringHandle pTagName1 = new InteropHelp.UTF8StringHandle(pTagName))
      return NativeMethods.ISteamUGC_AddRequiredTag(CSteamGameServerAPIContext.GetSteamUGC(), handle, pTagName1);
  }
  ...
  public static bool AddExcludedTag(UGCQueryHandle_t handle, string pTagName)
  {
    InteropHelp.TestIfAvailableGameServer();
    using (InteropHelp.UTF8StringHandle pTagName1 = new InteropHelp.UTF8StringHandle(pTagName))
      return NativeMethods.ISteamUGC_AddExcludedTag(CSteamGameServerAPIContext.GetSteamUGC(), handle, pTagName1);
  }
  ...
  public static bool SetLanguage(UGCQueryHandle_t handle, string pchLanguage)
  {
    ...
    using (InteropHelp.UTF8StringHandle pchLanguage1 = new InteropHelp.UTF8StringHandle(pchLanguage))
      return NativeMethods.ISteamUGC_SetLanguage(CSteamGameServerAPIContext.GetSteamUGC(), handle, pchLanguage1);
  }
  ...
  public static bool SetCloudFileNameFilter(UGCQueryHandle_t handle, string pMatchCloudFileName)
  {
    ...
    using (InteropHelp.UTF8StringHandle pMatchCloudFileName1 = new InteropHelp.UTF8StringHandle(pMatchCloudFileName))
      return NativeMethods.ISteamUGC_SetCloudFileNameFilter(CSteamGameServerAPIContext.GetSteamUGC(), handle, pMatchCloudFileName1);
  }
  ...
  public static bool SetSearchText(UGCQueryHandle_t handle, string pSearchText)
  {
    ...
    using (InteropHelp.UTF8StringHandle pSearchText1 = new InteropHelp.UTF8StringHandle(pSearchText))
      return NativeMethods.ISteamUGC_SetSearchText(CSteamGameServerAPIContext.GetSteamUGC(), handle, pSearchText1);
  }
  ...
  public static bool AddRequiredKeyValueTag(UGCQueryHandle_t handle, string pKey, string pValue)
  {
    ...
    using (InteropHelp.UTF8StringHandle pKey1 = new InteropHelp.UTF8StringHandle(pKey))
    {
      using (InteropHelp.UTF8StringHandle pValue1 = new InteropHelp.UTF8StringHandle(pValue))
        return NativeMethods.ISteamUGC_AddRequiredKeyValueTag(CSteamGameServerAPIContext.GetSteamUGC(), handle, pKey1, pValue1);
    }
  }
  ...
  public static bool SetItemTitle(UGCUpdateHandle_t handle, string pchTitle)
  {
    ...
    using (InteropHelp.UTF8StringHandle pchTitle1 = new InteropHelp.UTF8StringHandle(pchTitle))
      return NativeMethods.ISteamUGC_SetItemTitle(CSteamGameServerAPIContext.GetSteamUGC(), handle, pchTitle1);
  }
  ...
  public static bool SetItemDescription(UGCUpdateHandle_t handle, string pchDescription)
  {
    ...
    using (InteropHelp.UTF8StringHandle pchDescription1 = new InteropHelp.UTF8StringHandle(pchDescription))
      return NativeMethods.ISteamUGC_SetItemDescription(CSteamGameServerAPIContext.GetSteamUGC(), handle, pchDescription1);
  }
  ...
  public static bool SetItemUpdateLanguage(UGCUpdateHandle_t handle, string pchLanguage)
  {
    InteropHelp.TestIfAvailableGameServer();
    using (InteropHelp.UTF8StringHandle pchLanguage1 = new InteropHelp.UTF8StringHandle(pchLanguage))
      return NativeMethods.ISteamUGC_SetItemUpdateLanguage(CSteamGameServerAPIContext.GetSteamUGC(), handle, pchLanguage1);
  }
  ...
  public static bool SetItemMetadata(UGCUpdateHandle_t handle, string pchMetaData)
  {
    ...
    using (InteropHelp.UTF8StringHandle pchMetaData1 = new InteropHelp.UTF8StringHandle(pchMetaData))
      return NativeMethods.ISteamUGC_SetItemMetadata(CSteamGameServerAPIContext.GetSteamUGC(), handle, pchMetaData1);
  }
  ...
  {
    InteropHelp.TestIfAvailableGameServer();
    return NativeMethods.ISteamUGC_SetItemTags(CSteamGameServerAPIContext.GetSteamUGC(), updateHandle, (IntPtr) new InteropHelp.SteamParamStringArray(pTags));
  }
  ...
  public static bool SetItemContent(UGCUpdateHandle_t handle, string pszContentFolder)
  {
    ...
    using (InteropHelp.UTF8StringHandle pszContentFolder1 = new InteropHelp.UTF8StringHandle(pszContentFolder))
      return NativeMethods.ISteamUGC_SetItemContent(CSteamGameServerAPIContext.GetSteamUGC(), handle, pszContentFolder1);
  }
  ...
  public static bool SetItemPreview(UGCUpdateHandle_t handle, string pszPreviewFile)
  {
    ...
    using (InteropHelp.UTF8StringHandle pszPreviewFile1 = new InteropHelp.UTF8StringHandle(pszPreviewFile))
      return NativeMethods.ISteamUGC_SetItemPreview(CSteamGameServerAPIContext.GetSteamUGC(), handle, pszPreviewFile1);
  }
  ...
  public static bool RemoveItemKeyValueTags(UGCUpdateHandle_t handle, string pchKey)
  {
    ...
    using (InteropHelp.UTF8StringHandle pchKey1 = new InteropHelp.UTF8StringHandle(pchKey))
      return NativeMethods.ISteamUGC_RemoveItemKeyValueTags(CSteamGameServerAPIContext.GetSteamUGC(), handle, pchKey1);
  }
  ...
  public static bool AddItemKeyValueTag(UGCUpdateHandle_t handle, string pchKey, string pchValue)
  {
    ...
    using (InteropHelp.UTF8StringHandle pchKey1 = new InteropHelp.UTF8StringHandle(pchKey))
    {
      using (InteropHelp.UTF8StringHandle pchValue1 = new InteropHelp.UTF8StringHandle(pchValue))
        return NativeMethods.ISteamUGC_AddItemKeyValueTag(CSteamGameServerAPIContext.GetSteamUGC(), handle, pchKey1, pchValue1);
    }
  }
    ...
    EItemPreviewType type)
  {
    InteropHelp.TestIfAvailableGameServer();
    using (InteropHelp.UTF8StringHandle pszPreviewFile1 = new InteropHelp.UTF8StringHandle(pszPreviewFile))
      return NativeMethods.ISteamUGC_AddItemPreviewFile(CSteamGameServerAPIContext.GetSteamUGC(), handle, pszPreviewFile1, type);
  }
  ...
  public static bool AddItemPreviewVideo(UGCUpdateHandle_t handle, string pszVideoID)
  {
    ...
    using (InteropHelp.UTF8StringHandle pszVideoID1 = new InteropHelp.UTF8StringHandle(pszVideoID))
      return NativeMethods.ISteamUGC_AddItemPreviewVideo(CSteamGameServerAPIContext.GetSteamUGC(), handle, pszVideoID1);
  }
    ...
    string pszPreviewFile)
  {
    InteropHelp.TestIfAvailableGameServer();
    using (InteropHelp.UTF8StringHandle pszPreviewFile1 = new InteropHelp.UTF8StringHandle(pszPreviewFile))
      return NativeMethods.ISteamUGC_UpdateItemPreviewFile(CSteamGameServerAPIContext.GetSteamUGC(), handle, index, pszPreviewFile1);
  }
    ...
    string pszVideoID)
  {
    InteropHelp.TestIfAvailableGameServer();
    using (InteropHelp.UTF8StringHandle pszVideoID1 = new InteropHelp.UTF8StringHandle(pszVideoID))
      return NativeMethods.ISteamUGC_UpdateItemPreviewVideo(CSteamGameServerAPIContext.GetSteamUGC(), handle, index, pszVideoID1);
  }
  ...
  public static SteamAPICall_t SubmitItemUpdate(UGCUpdateHandle_t handle, string pchChangeNote)
  {
    ...
    using (InteropHelp.UTF8StringHandle pchChangeNote1 = new InteropHelp.UTF8StringHandle(pchChangeNote))
      return (SteamAPICall_t) NativeMethods.ISteamUGC_SubmitItemUpdate(CSteamGameServerAPIContext.GetSteamUGC(), handle, pchChangeNote1);
  }
    ...
    out uint punTimeStamp)
  {
    ...
    bool itemInstallInfo = NativeMethods.ISteamUGC_GetItemInstallInfo(CSteamGameServerAPIContext.GetSteamUGC(), nPublishedFileID, out punSizeOnDisk, num, cchFolderSize, out punTimeStamp);
  ...
  public static bool BInitWorkshopForGameServer(DepotId_t unWorkshopDepotID, string pszFolder)
  {
    ...
    using (InteropHelp.UTF8StringHandle pszFolder1 = new InteropHelp.UTF8StringHandle(pszFolder))
      return NativeMethods.ISteamUGC_BInitWorkshopForGameServer(CSteamGameServerAPIContext.GetSteamUGC(), unWorkshopDepotID, pszFolder1);
  }
