...
public static class SteamRemoteStorage
{
  public static bool FileWrite(string pchFile, byte[] pvData, int cubData)
  {
    ...
    using (InteropHelp.UTF8StringHandle pchFile1 = new InteropHelp.UTF8StringHandle(pchFile))
      return NativeMethods.ISteamRemoteStorage_FileWrite(CSteamAPIContext.GetSteamRemoteStorage(), pchFile1, pvData, cubData);
  }
  ...
  public static int FileRead(string pchFile, byte[] pvData, int cubDataToRead)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchFile1 = new InteropHelp.UTF8StringHandle(pchFile))
      return NativeMethods.ISteamRemoteStorage_FileRead(CSteamAPIContext.GetSteamRemoteStorage(), pchFile1, pvData, cubDataToRead);
  }
  ...
  public static SteamAPICall_t FileWriteAsync(string pchFile, byte[] pvData, uint cubData)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchFile1 = new InteropHelp.UTF8StringHandle(pchFile))
      return (SteamAPICall_t) NativeMethods.ISteamRemoteStorage_FileWriteAsync(CSteamAPIContext.GetSteamRemoteStorage(), pchFile1, pvData, cubData);
  }
  ...
  public static SteamAPICall_t FileReadAsync(string pchFile, uint nOffset, uint cubToRead)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchFile1 = new InteropHelp.UTF8StringHandle(pchFile))
      return (SteamAPICall_t) NativeMethods.ISteamRemoteStorage_FileReadAsync(CSteamAPIContext.GetSteamRemoteStorage(), pchFile1, nOffset, cubToRead);
  }
  ...
  public static bool FileForget(string pchFile)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchFile1 = new InteropHelp.UTF8StringHandle(pchFile))
      return NativeMethods.ISteamRemoteStorage_FileForget(CSteamAPIContext.GetSteamRemoteStorage(), pchFile1);
  }
  ...
  public static bool FileDelete(string pchFile)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchFile1 = new InteropHelp.UTF8StringHandle(pchFile))
      return NativeMethods.ISteamRemoteStorage_FileDelete(CSteamAPIContext.GetSteamRemoteStorage(), pchFile1);
  }
  ...
  public static SteamAPICall_t FileShare(string pchFile)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchFile1 = new InteropHelp.UTF8StringHandle(pchFile))
      return (SteamAPICall_t) NativeMethods.ISteamRemoteStorage_FileShare(CSteamAPIContext.GetSteamRemoteStorage(), pchFile1);
  }
  ...
  public static bool SetSyncPlatforms(string pchFile, ERemoteStoragePlatform eRemoteStoragePlatform)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchFile1 = new InteropHelp.UTF8StringHandle(pchFile))
      return NativeMethods.ISteamRemoteStorage_SetSyncPlatforms(CSteamAPIContext.GetSteamRemoteStorage(), pchFile1, eRemoteStoragePlatform);
  }
  ...
  public static UGCFileWriteStreamHandle_t FileWriteStreamOpen(string pchFile)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchFile1 = new InteropHelp.UTF8StringHandle(pchFile))
      return (UGCFileWriteStreamHandle_t) NativeMethods.ISteamRemoteStorage_FileWriteStreamOpen(CSteamAPIContext.GetSteamRemoteStorage(), pchFile1);
  }
  ...
  public static bool FileExists(string pchFile)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchFile1 = new InteropHelp.UTF8StringHandle(pchFile))
      return NativeMethods.ISteamRemoteStorage_FileExists(CSteamAPIContext.GetSteamRemoteStorage(), pchFile1);
  }
  ...
  public static bool FilePersisted(string pchFile)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchFile1 = new InteropHelp.UTF8StringHandle(pchFile))
      return NativeMethods.ISteamRemoteStorage_FilePersisted(CSteamAPIContext.GetSteamRemoteStorage(), pchFile1);
  }
  ...
  public static int GetFileSize(string pchFile)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchFile1 = new InteropHelp.UTF8StringHandle(pchFile))
      return NativeMethods.ISteamRemoteStorage_GetFileSize(CSteamAPIContext.GetSteamRemoteStorage(), pchFile1);
  }
  ...
  public static long GetFileTimestamp(string pchFile)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchFile1 = new InteropHelp.UTF8StringHandle(pchFile))
      return NativeMethods.ISteamRemoteStorage_GetFileTimestamp(CSteamAPIContext.GetSteamRemoteStorage(), pchFile1);
  }
  ...
  public static ERemoteStoragePlatform GetSyncPlatforms(string pchFile)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchFile1 = new InteropHelp.UTF8StringHandle(pchFile))
      return NativeMethods.ISteamRemoteStorage_GetSyncPlatforms(CSteamAPIContext.GetSteamRemoteStorage(), pchFile1);
  }
    ...
    out CSteamID pSteamIDOwner)
  {
    InteropHelp.TestIfAvailableClient();
    IntPtr ppchName1;
    bool ugcDetails = NativeMethods.ISteamRemoteStorage_GetUGCDetails(CSteamAPIContext.GetSteamRemoteStorage(), hContent, out pnAppID, out ppchName1, out pnFileSizeInBytes, out pSteamIDOwner);
      ...
      using (InteropHelp.UTF8StringHandle pchPreviewFile1 = new InteropHelp.UTF8StringHandle(pchPreviewFile))
      {
        using (InteropHelp.UTF8StringHandle pchTitle1 = new InteropHelp.UTF8StringHandle(pchTitle))
        {
          using (InteropHelp.UTF8StringHandle pchDescription1 = new InteropHelp.UTF8StringHandle(pchDescription))
            return (SteamAPICall_t) NativeMethods.ISteamRemoteStorage_PublishWorkshopFile(CSteamAPIContext.GetSteamRemoteStorage(), pchFile1, pchPreviewFile1, nConsumerAppId, pchTitle1, pchDescription1, eVisibility, (IntPtr) new InteropHelp.SteamParamStringArray(pTags), eWorkshopFileType);
        }
      }
    }
  }
    ...
    string pchFile)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchFile1 = new InteropHelp.UTF8StringHandle(pchFile))
      return NativeMethods.ISteamRemoteStorage_UpdatePublishedFileFile(CSteamAPIContext.GetSteamRemoteStorage(), updateHandle, pchFile1);
  }
    ...
    string pchPreviewFile)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchPreviewFile1 = new InteropHelp.UTF8StringHandle(pchPreviewFile))
      return NativeMethods.ISteamRemoteStorage_UpdatePublishedFilePreviewFile(CSteamAPIContext.GetSteamRemoteStorage(), updateHandle, pchPreviewFile1);
  }
    ...
    string pchTitle)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchTitle1 = new InteropHelp.UTF8StringHandle(pchTitle))
      return NativeMethods.ISteamRemoteStorage_UpdatePublishedFileTitle(CSteamAPIContext.GetSteamRemoteStorage(), updateHandle, pchTitle1);
  }
    ...
    string pchDescription)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchDescription1 = new InteropHelp.UTF8StringHandle(pchDescription))
      return NativeMethods.ISteamRemoteStorage_UpdatePublishedFileDescription(CSteamAPIContext.GetSteamRemoteStorage(), updateHandle, pchDescription1);
  }
  ...
  {
    InteropHelp.TestIfAvailableClient();
    return NativeMethods.ISteamRemoteStorage_UpdatePublishedFileTags(CSteamAPIContext.GetSteamRemoteStorage(), updateHandle, (IntPtr) new InteropHelp.SteamParamStringArray(pTags));
  }
    ...
    string pchChangeDescription)
  {
    ...
    using (InteropHelp.UTF8StringHandle pchChangeDescription1 = new InteropHelp.UTF8StringHandle(pchChangeDescription))
      return NativeMethods.ISteamRemoteStorage_UpdatePublishedFileSetChangeDescription(CSteamAPIContext.GetSteamRemoteStorage(), updateHandle, pchChangeDescription1);
  }
  ...
  {
    InteropHelp.TestIfAvailableClient();
    return (SteamAPICall_t) NativeMethods.ISteamRemoteStorage_EnumerateUserSharedWorkshopFiles(CSteamAPIContext.GetSteamRemoteStorage(), steamId, unStartIndex, (IntPtr) new InteropHelp.SteamParamStringArray(pRequiredTags), (IntPtr) new InteropHelp.SteamParamStringArray(pExcludedTags));
  }
    ...
    using (InteropHelp.UTF8StringHandle pchVideoAccount1 = new InteropHelp.UTF8StringHandle(pchVideoAccount))
    {
      using (InteropHelp.UTF8StringHandle pchVideoIdentifier1 = new InteropHelp.UTF8StringHandle(pchVideoIdentifier))
      {
        using (InteropHelp.UTF8StringHandle pchPreviewFile1 = new InteropHelp.UTF8StringHandle(pchPreviewFile))
        {
          ...
          {
            using (InteropHelp.UTF8StringHandle pchDescription1 = new InteropHelp.UTF8StringHandle(pchDescription))
              return (SteamAPICall_t) NativeMethods.ISteamRemoteStorage_PublishVideo(CSteamAPIContext.GetSteamRemoteStorage(), eVideoProvider, pchVideoAccount1, pchVideoIdentifier1, pchPreviewFile1, nConsumerAppId, pchTitle1, pchDescription1, eVisibility, (IntPtr) new InteropHelp.SteamParamStringArray(pTags));
          }
        }
      }
    }
  ...
  {
    InteropHelp.TestIfAvailableClient();
    return (SteamAPICall_t) NativeMethods.ISteamRemoteStorage_EnumeratePublishedWorkshopFiles(CSteamAPIContext.GetSteamRemoteStorage(), eEnumerationType, unStartIndex, unCount, unDays, (IntPtr) new InteropHelp.SteamParamStringArray(pTags), (IntPtr) new InteropHelp.SteamParamStringArray(pUserTags));
  }
    ...
    uint unPriority)
  {
    ...
    using (InteropHelp.UTF8StringHandle pchLocation1 = new InteropHelp.UTF8StringHandle(pchLocation))
      return (SteamAPICall_t) NativeMethods.ISteamRemoteStorage_UGCDownloadToLocation(CSteamAPIContext.GetSteamRemoteStorage(), hContent, pchLocation1, unPriority);
  }
}
