...
public static class SteamUserStats
{
  ...
  public static bool GetStat(string pchName, out int pData)
  {
    ...
    using (InteropHelp.UTF8StringHandle pchName1 = new InteropHelp.UTF8StringHandle(pchName))
      return NativeMethods.ISteamUserStats_GetStat(CSteamAPIContext.GetSteamUserStats(), pchName1, out pData);
  }
  ...
  public static bool GetStat(string pchName, out float pData)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchName1 = new InteropHelp.UTF8StringHandle(pchName))
      return NativeMethods.ISteamUserStats_GetStat0(CSteamAPIContext.GetSteamUserStats(), pchName1, out pData);
  }
  ...
  public static bool SetStat(string pchName, int nData)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchName1 = new InteropHelp.UTF8StringHandle(pchName))
      return NativeMethods.ISteamUserStats_SetStat(CSteamAPIContext.GetSteamUserStats(), pchName1, nData);
  }
  ...
  public static bool SetStat(string pchName, float fData)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchName1 = new InteropHelp.UTF8StringHandle(pchName))
      return NativeMethods.ISteamUserStats_SetStat0(CSteamAPIContext.GetSteamUserStats(), pchName1, fData);
  }
    ...
    double dSessionLength)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchName1 = new InteropHelp.UTF8StringHandle(pchName))
      return NativeMethods.ISteamUserStats_UpdateAvgRateStat(CSteamAPIContext.GetSteamUserStats(), pchName1, flCountThisSession, dSessionLength);
  }
  ...
  public static bool GetAchievement(string pchName, out bool pbAchieved)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchName1 = new InteropHelp.UTF8StringHandle(pchName))
      return NativeMethods.ISteamUserStats_GetAchievement(CSteamAPIContext.GetSteamUserStats(), pchName1, out pbAchieved);
  }
  ...
  public static bool SetAchievement(string pchName)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchName1 = new InteropHelp.UTF8StringHandle(pchName))
      return NativeMethods.ISteamUserStats_SetAchievement(CSteamAPIContext.GetSteamUserStats(), pchName1);
  }
  ...
  public static bool ClearAchievement(string pchName)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchName1 = new InteropHelp.UTF8StringHandle(pchName))
      return NativeMethods.ISteamUserStats_ClearAchievement(CSteamAPIContext.GetSteamUserStats(), pchName1);
  }
    ...
    out uint punUnlockTime)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchName1 = new InteropHelp.UTF8StringHandle(pchName))
      return NativeMethods.ISteamUserStats_GetAchievementAndUnlockTime(CSteamAPIContext.GetSteamUserStats(), pchName1, out pbAchieved, out punUnlockTime);
  }
  ...
  public static int GetAchievementIcon(string pchName)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchName1 = new InteropHelp.UTF8StringHandle(pchName))
      return NativeMethods.ISteamUserStats_GetAchievementIcon(CSteamAPIContext.GetSteamUserStats(), pchName1);
  }
  ...
  public static string GetAchievementDisplayAttribute(string pchName, string pchKey)
  {
    ...
    using (InteropHelp.UTF8StringHandle pchName1 = new InteropHelp.UTF8StringHandle(pchName))
    {
      using (InteropHelp.UTF8StringHandle pchKey1 = new InteropHelp.UTF8StringHandle(pchKey))
        return InteropHelp.PtrToStringUTF8(NativeMethods.ISteamUserStats_GetAchievementDisplayAttribute(CSteamAPIContext.GetSteamUserStats(), pchName1, pchKey1));
    }
  }
    ...
    uint nMaxProgress)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchName1 = new InteropHelp.UTF8StringHandle(pchName))
      return NativeMethods.ISteamUserStats_IndicateAchievementProgress(CSteamAPIContext.GetSteamUserStats(), pchName1, nCurProgress, nMaxProgress);
  }
  ...
  public static bool GetUserStat(CSteamID steamIDUser, string pchName, out int pData)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchName1 = new InteropHelp.UTF8StringHandle(pchName))
      return NativeMethods.ISteamUserStats_GetUserStat(CSteamAPIContext.GetSteamUserStats(), steamIDUser, pchName1, out pData);
  }
  ...
  public static bool GetUserStat(CSteamID steamIDUser, string pchName, out float pData)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchName1 = new InteropHelp.UTF8StringHandle(pchName))
      return NativeMethods.ISteamUserStats_GetUserStat0(CSteamAPIContext.GetSteamUserStats(), steamIDUser, pchName1, out pData);
  }
  ...
  public static bool GetUserAchievement(CSteamID steamIDUser, string pchName, out bool pbAchieved)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchName1 = new InteropHelp.UTF8StringHandle(pchName))
      return NativeMethods.ISteamUserStats_GetUserAchievement(CSteamAPIContext.GetSteamUserStats(), steamIDUser, pchName1, out pbAchieved);
  }
    ...
    out uint punUnlockTime)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchName1 = new InteropHelp.UTF8StringHandle(pchName))
      return NativeMethods.ISteamUserStats_GetUserAchievementAndUnlockTime(CSteamAPIContext.GetSteamUserStats(), steamIDUser, pchName1, out pbAchieved, out punUnlockTime);
  }
    ...
    ELeaderboardDisplayType eLeaderboardDisplayType)
  {
    ...
    using (InteropHelp.UTF8StringHandle pchLeaderboardName1 = new InteropHelp.UTF8StringHandle(pchLeaderboardName))
      return (SteamAPICall_t) NativeMethods.ISteamUserStats_FindOrCreateLeaderboard(CSteamAPIContext.GetSteamUserStats(), pchLeaderboardName1, eLeaderboardSortMethod, eLeaderboardDisplayType);
  }
  ...
  public static SteamAPICall_t FindLeaderboard(string pchLeaderboardName)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchLeaderboardName1 = new InteropHelp.UTF8StringHandle(pchLeaderboardName))
      return (SteamAPICall_t) NativeMethods.ISteamUserStats_FindLeaderboard(CSteamAPIContext.GetSteamUserStats(), pchLeaderboardName1);
  }
    ...
    out bool pbAchieved)
  {
    ...
    int achievedAchievementInfo = NativeMethods.ISteamUserStats_GetMostAchievedAchievementInfo(CSteamAPIContext.GetSteamUserStats(), num, unNameBufLen, out pflPercent, out pbAchieved);
    ...
    out bool pbAchieved)
  {
    InteropHelp.TestIfAvailableClient();
    IntPtr num = Marshal.AllocHGlobal((int) unNameBufLen);
    int achievedAchievementInfo = NativeMethods.ISteamUserStats_GetNextMostAchievedAchievementInfo(CSteamAPIContext.GetSteamUserStats(), iIteratorPrevious, num, unNameBufLen, out pflPercent, out pbAchieved);
    pchName = achievedAchievementInfo != -1 ? InteropHelp.PtrToStringUTF8(num) : (string) null;
    Marshal.FreeHGlobal(num);
    return achievedAchievementInfo;
  }
  ...
  public static bool GetAchievementAchievedPercent(string pchName, out float pflPercent)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchName1 = new InteropHelp.UTF8StringHandle(pchName))
      return NativeMethods.ISteamUserStats_GetAchievementAchievedPercent(CSteamAPIContext.GetSteamUserStats(), pchName1, out pflPercent);
  }
  ...
  public static bool GetGlobalStat(string pchStatName, out long pData)
  {
    ...
    using (InteropHelp.UTF8StringHandle pchStatName1 = new InteropHelp.UTF8StringHandle(pchStatName))
      return NativeMethods.ISteamUserStats_GetGlobalStat(CSteamAPIContext.GetSteamUserStats(), pchStatName1, out pData);
  }
  ...
  public static bool GetGlobalStat(string pchStatName, out double pData)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchStatName1 = new InteropHelp.UTF8StringHandle(pchStatName))
      return NativeMethods.ISteamUserStats_GetGlobalStat0(CSteamAPIContext.GetSteamUserStats(), pchStatName1, out pData);
  }
  ...
  public static int GetGlobalStatHistory(string pchStatName, long[] pData, uint cubData)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchStatName1 = new InteropHelp.UTF8StringHandle(pchStatName))
      return NativeMethods.ISteamUserStats_GetGlobalStatHistory(CSteamAPIContext.GetSteamUserStats(), pchStatName1, pData, cubData);
  }
  ...
  public static int GetGlobalStatHistory(string pchStatName, double[] pData, uint cubData)
  {
    InteropHelp.TestIfAvailableClient();
    using (InteropHelp.UTF8StringHandle pchStatName1 = new InteropHelp.UTF8StringHandle(pchStatName))
      return NativeMethods.ISteamUserStats_GetGlobalStatHistory0(CSteamAPIContext.GetSteamUserStats(), pchStatName1, pData, cubData);
  }
}
