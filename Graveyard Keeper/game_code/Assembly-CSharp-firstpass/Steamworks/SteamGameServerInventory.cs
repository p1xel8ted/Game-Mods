...
public static class SteamGameServerInventory
{
    ...
    ref uint punValueBufferSizeOut)
  {
    ...
    {
      bool resultItemProperty = NativeMethods.ISteamInventory_GetResultItemProperty(CSteamGameServerAPIContext.GetSteamInventory(), resultHandle, unItemIndex, pchPropertyName1, num, ref punValueBufferSizeOut);
    ...
    ref uint punValueBufferSizeOut)
  {
    ...
    using (InteropHelp.UTF8StringHandle pchPropertyName1 = new InteropHelp.UTF8StringHandle(pchPropertyName))
    {
      bool definitionProperty = NativeMethods.ISteamInventory_GetItemDefinitionProperty(CSteamGameServerAPIContext.GetSteamInventory(), iDefinition, pchPropertyName1, num, ref punValueBufferSizeOut);
    ...
    string pchPropertyName)
  {
    InteropHelp.TestIfAvailableGameServer();
    using (InteropHelp.UTF8StringHandle pchPropertyName1 = new InteropHelp.UTF8StringHandle(pchPropertyName))
      return NativeMethods.ISteamInventory_RemoveProperty(CSteamGameServerAPIContext.GetSteamInventory(), handle, nItemID, pchPropertyName1);
  }
    ...
    string pchPropertyValue)
  {
    ...
    using (InteropHelp.UTF8StringHandle pchPropertyName1 = new InteropHelp.UTF8StringHandle(pchPropertyName))
    {
      using (InteropHelp.UTF8StringHandle pchPropertyValue1 = new InteropHelp.UTF8StringHandle(pchPropertyValue))
        return NativeMethods.ISteamInventory_SetProperty(CSteamGameServerAPIContext.GetSteamInventory(), handle, nItemID, pchPropertyName1, pchPropertyValue1);
    }
  }
    ...
    bool bValue)
  {
    InteropHelp.TestIfAvailableGameServer();
    using (InteropHelp.UTF8StringHandle pchPropertyName1 = new InteropHelp.UTF8StringHandle(pchPropertyName))
      return NativeMethods.ISteamInventory_SetProperty0(CSteamGameServerAPIContext.GetSteamInventory(), handle, nItemID, pchPropertyName1, bValue);
  }
    ...
    long nValue)
  {
    InteropHelp.TestIfAvailableGameServer();
    using (InteropHelp.UTF8StringHandle pchPropertyName1 = new InteropHelp.UTF8StringHandle(pchPropertyName))
      return NativeMethods.ISteamInventory_SetProperty1(CSteamGameServerAPIContext.GetSteamInventory(), handle, nItemID, pchPropertyName1, nValue);
  }
    ...
    float flValue)
  {
    InteropHelp.TestIfAvailableGameServer();
    using (InteropHelp.UTF8StringHandle pchPropertyName1 = new InteropHelp.UTF8StringHandle(pchPropertyName))
      return NativeMethods.ISteamInventory_SetProperty2(CSteamGameServerAPIContext.GetSteamInventory(), handle, nItemID, pchPropertyName1, flValue);
  }
