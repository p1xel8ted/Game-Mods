...
// Type: FlowCanvas.Nodes.Flow_HasItemCountInInventory
...
public class Flow_HasItemCountInInventory : MyFlowNode
{
  ...
  public override void RegisterPorts()
  {
    ...
    this.AddValueOutput<int>("Item count", (ValueHandler<int>) (() => this.item_count));
    this.AddFlowInput("In", (FlowHandler) (f =>
    {
      ...
      {
        this.item_count = worldGameObject.data.GetItemsCount(item_id);
        flow_out.Call(f);
      }
    }));
  }
