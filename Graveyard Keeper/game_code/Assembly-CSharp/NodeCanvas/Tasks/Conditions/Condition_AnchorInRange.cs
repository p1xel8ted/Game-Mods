...
// Type: NodeCanvas.Tasks.Conditions.Condition_AnchorInRange
...
public class Condition_AnchorInRange : WGOBehaviourCondition
{
  ...
  public override string info => "Anchor in range " + this.range?.ToString();
  ...
  public override bool OnCheck()
  {
    ...
    if (!((Object) anchorObj == (Object) null))
      return this.self_wgo.IsInRange(anchorObj, this.range.value);
