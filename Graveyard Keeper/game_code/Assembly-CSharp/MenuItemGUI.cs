...
public class MenuItemGUI : MonoBehaviour
{
  ...
  public void Init(BaseMenuGUI menu)
  {
    ...
    this._gamepad_item.SetCallbacks(new GJCommons.VoidDelegate(this.OnOver), (GJCommons.VoidDelegate) (() => this.OnOut()), new GJCommons.VoidDelegate(this.OnMenuItemSelect));
  ...
  [CompilerGenerated]
  public void \u003CInit\u003Eb__16_0() => this.OnOut();

  [CompilerGenerated]
  public void \u003COnOut\u003Eb__25_0()
  {
    if (this._overed)
      return;
    this.gamepad_frame.Deactivate<UIWidget>();
