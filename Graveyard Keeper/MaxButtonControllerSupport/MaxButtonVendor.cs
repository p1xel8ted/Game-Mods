...
public class MaxButtonVendor
{
    ...
    public static void AddMaxButton(ref ItemCountGUI itemCountGUI, ref ItemCountGUI.PriceCalculateDelegate priceCalculateDelegate)
    {
        ...
        EventDelegate.Add(uiButton.onClick, delegate { SetMaxPrice(ref _slider); });
    }
