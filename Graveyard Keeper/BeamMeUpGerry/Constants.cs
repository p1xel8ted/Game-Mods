...
{
    public const string Hearthstone = "hearthstone";
    ...
    internal const string ZoneFlatUnderWaterflow = "flat_under_waterflow";
    ...
    internal const string NorthCoal = "north_coal";
}