...
[list]
[*][size=3]Shows the element (e.g. Chaos, Life etc.) of an item that it will decompose into when put into one of the alchemy stations (the Mill / Mixer / Distillation Cube).[/size]
[*][size=3]You need to have researched/studied the original item prior.[/size]
[*][size=3]Text color can be modified via the F1 interface. No game restart needed.[/size]
[*][size=3]All game languages supported.[/size]
[/list]

[img]https://staticdelivery.nexusmods.com/mods/2696/images/86/86-1722151990-1193603996.png[/img]
...
[size=3][url=https://github.com/p1xel8ted/Game-Mods/tree/main/Graveyard%20Keeper/src/DecompDelight]GitHub[/url][/size]