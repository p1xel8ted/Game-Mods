...
[list]
[*][size=3]It enables the player to harvest multiple garden plots simultaneously (of the same type).[/size]
[*][size=3]Requires the "Farmer" perk to be unlocked first.[/size]
[/list]

[youtube]ji4_r1Vizgk[/youtube]
...
[size=3][url=https://github.com/p1xel8ted/Game-Mods/tree/main/Graveyard%20Keeper/src/WheresMaVeggies]GitHub[/url][/size]