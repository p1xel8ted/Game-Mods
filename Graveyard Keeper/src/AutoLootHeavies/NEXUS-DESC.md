...
[size=4][b]What[/b][/size]

[list]
[*]Teleport timber, stone, marble and ore to the nearest stockpile that has storage space available.
[*]If they're all full, it will teleport them to a designated dump site or drop the item on the ground, depending on your settings.
[*]Teleporting can be toggled with the 6 key.
[*]Dump sites can be set with the 7, 8 and 9 keys. Stand where you want the site to be, and press the button.
[*]Keybinds can be modified in the config file.
[*]It costs 3 energy to teleport an item.
[*]Dump sites are filled in a grid from top left to bottom right.
[*]
[img]https://staticdelivery.nexusmods.com/mods/2696/images/51/51-1653564460-478624433.png[/img][/list]
...
[size=3][url=https://github.com/p1xel8ted/Game-Mods/tree/main/Graveyard%20Keeper/src/AutoLootHeavies]GitHub[/url][/size]