...
- Added keybind (default: 6) to toggle teleportation on/off during gameplay
- Fixed hotkeys and input features not working for some users
- Improved compatibility across different BepInEx versions

## 3.5.1

- Fixed teleportation and item dropping breaking after exiting to main menu and reloading a save
- Fixed potential stuck-on-head issue caused by stale stockpile references
- Fixed a crash that could occur when dropping an item while not carrying anything overhead
- Fixed item size not being restored correctly after auto-looting
