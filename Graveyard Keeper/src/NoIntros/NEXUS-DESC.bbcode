...
[size=3]It makes the game think it has no logos to play, so it doesn't and continues loading the game.[/size]
...
[size=3][url=https://github.com/p1xel8ted/Game-Mods/tree/main/Graveyard%20Keeper/src/NoIntros]GitHub[/url][/size]