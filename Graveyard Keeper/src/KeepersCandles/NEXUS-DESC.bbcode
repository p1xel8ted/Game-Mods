...
[list]
[*][size=3]Candles never run out and are always lit when placed into a candelabra.[/size]
[*][size=3]To change the candle, you need to stand near it and press C or Up on the D-Pad.[/size]
[*][size=3]When removing a candle, you get it back in your inventory.[/size]
[*][size=3]Keybinds and distance to remove can be changed via the F1 interface.[/size]
[/list]
...
[size=3][url=https://github.com/p1xel8ted/Game-Mods/tree/main/Graveyard%20Keeper/src/KeepersCandles]GitHub[/url][/size]