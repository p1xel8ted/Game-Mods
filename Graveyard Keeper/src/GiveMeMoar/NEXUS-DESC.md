...
[list]
[*][size=3]Apply a multiplier to:[/size]
[size=3]- Tech Points
- Faith
- Donations
- Happiness
...
[size=3][url=https://github.com/p1xel8ted/Game-Mods/tree/main/Graveyard%20Keeper/src/GiveMeMoar]GitHub[/url][/size]