...
[list]
[*][size=3]By default, the zombie garden and vineyard output fewer seeds than input, so if you never use the manual garden, you eventually run out. This mod attempts to make it a 1:1 relationship, 9/10 though it ends in a total gain.[/size]
[/list]
...
[size=3][url=https://github.com/p1xel8ted/Game-Mods/tree/main/Graveyard%20Keeper/src/TheSeedEqualizer]GitHub[/url][/size]