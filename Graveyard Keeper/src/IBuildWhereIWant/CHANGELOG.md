...
- Fixed build list duplicating and causing UI freezes when unlocking new technologies
- Fixed two-step buildings not completing when placed outside their normal zone
