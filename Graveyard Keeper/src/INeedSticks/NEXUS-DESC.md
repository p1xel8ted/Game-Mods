...
[list]
[*][size=3]Adds the "Wooden stick" drop as a craftable item to the Circular saw.[/size]
[*][size=3]Drops 12 per craft. Requires 1 Log.[/size]
[*][size=3]Uses 10 energy per craft.[/size]
[/list]

[youtube]65fM1KRvlbA[/youtube]
...
[size=3][url=https://github.com/p1xel8ted/Game-Mods/tree/main/Graveyard%20Keeper/src/INeedSticks]GitHub[/url][/size]