...
[size=3]Skips the confirm dialogue when you choose a body part on the autopsy table. There is no going back once you've selected it, so be sure.[/size]
...
[size=3][url=https://github.com/p1xel8ted/Game-Mods/tree/main/Graveyard%20Keeper/src/AddStraightToTable]GitHub[/url][/size]