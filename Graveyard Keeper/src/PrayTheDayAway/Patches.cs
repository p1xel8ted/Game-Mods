...
public partial class Plugin
{
    ...
    public static void PrayCraftGUI_OnFinishedPrayBuffAnimation()
    {
        ...
        if (NotifyOnPrayerLoss.Value && LostPrayerItem)
        {
            ...
            var bubbleType = GJL.IsEastern()
                ? SpeechBubbleGUI.SpeechBubbleType.Think
                : SpeechBubbleGUI.SpeechBubbleType.InfoBox;
            MainGame.me.player.Say(msg, null, false, bubbleType, SmartSpeechEngine.VoiceID.None, true);
        }
    }
    ...
    public static void PrayCraftGUI_OnMiddlePrayBuffAnimation()
    {
        ...
        if (PrayerItem != null && ShowPrayerItem)
        {
            ...
            PrayerItem.definition.item_size = 1;
            DropCollectGUI.OnDropCollected(PrayerItem);
            PrayerItem.definition.item_size = originalSize;
    ...
    public static void PrayCraftGUI_OnPrayButtonPressed(PrayCraftGUI __instance)
    {
        ...
        ProcessCraftDoodad(__instance._selected_item);
        GoFast();
    }
    ...
    public static bool WorldGameObject_Interact(WorldGameObject __instance)
    {
