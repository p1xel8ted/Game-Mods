...
[list]
[*][size=3]Run sermons multiple times a day (as much as you want).[/size]
[*][size=3]Run sermons every day if you so wish.[/size]
[*][size=3]Running a sermon more than once will result in losing the faith item (excluding the most basic one)[/size]
[*][size=3]Alternate Mode = Instead of losing the prayer, it has a 20%/40%/60% chance to downgrade a tier.[/size]
[*][size=3]'Cheat Mode' setting. Pray multiple times a day, no loss, or gain. Other settings do nothing (except for speed) while cheat mode is on.[/size]
[*][size=3]Speed up time while a sermon is running.[/size]
[/list]
...
[size=3][url=https://github.com/p1xel8ted/Game-Mods/tree/main/Graveyard%20Keeper/src/PrayTheDayAway]GitHub[/url][/size]