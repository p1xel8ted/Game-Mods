...
public class Plugin : BaseUnityPlugin
{
    ...
    private static void EvictVisitors()
    {
        ...
        Log.LogInfo($"Starting to evict {churchVisitors.Count} visitors. Hang tight while I work. Game may appear to hang depending on quantity of visitors.");
    ...
    private static void EvictVisitorsButton(ConfigEntryBase entry)
    {
        ...
        {
            var button = GUILayout.Button(Lang.Get("EvictButton"), GUILayout.ExpandWidth(true));
            if (button)
            {
