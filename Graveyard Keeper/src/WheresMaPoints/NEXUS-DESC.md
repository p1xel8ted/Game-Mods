...
[list]
[*][size=3]Tech/XP points no longer spawn and are added straight to the player's XP (excess uncollected points are massive performance sink.)[/size]
[*][size=3]Displays a short alert above the keeper's head (similar to energy usage) when a point is received. This can be disabled.[/size]
[/list]
...
[size=3][url=https://github.com/p1xel8ted/Game-Mods/tree/main/Graveyard%20Keeper/src/WheresMaPoints]GitHub[/url][/size]