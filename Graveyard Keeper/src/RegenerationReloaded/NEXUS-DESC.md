...
[list]
[*][size=3]Adds life and energy regeneration every X seconds.[/size]
[*][size=3]The default is 2 life and 1 energy every 5 seconds.[/size]
[*][size=3]It also shows the energy/life gains above the keeper's head. (Can be disabled in the config)[/size]
[*][size=3]Press F1 in game to open configuration window (assuming you've used the BepInEx pack below).[/size]
[/list]
...
[size=3][url=https://github.com/p1xel8ted/Game-Mods/tree/main/Graveyard%20Keeper/src/RegenerationReloaded]GitHub[/url][/size]