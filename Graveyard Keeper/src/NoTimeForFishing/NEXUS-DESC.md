...
[size=3]Removes the mini-game, hooks fish instantly and auto-loots the bobber. The only thing the player has to do is cast.[/size]
...
[size=3][url=https://github.com/p1xel8ted/Game-Mods/tree/main/Graveyard%20Keeper/src/NoTimeForFishing]GitHub[/url][/size]