...
[size=3]Shifts the "New game" save slot to the bottom of the list, so no more starting a new game in a hurry.[/size]
...
[size=3][url=https://github.com/p1xel8ted/Game-Mods/tree/main/Graveyard%20Keeper/src/NewGameAtBottom]GitHub[/url][/size]