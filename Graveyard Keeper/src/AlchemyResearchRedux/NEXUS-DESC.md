...
[list]
[*][size=3]Remake of [url=https://www.nexusmods.com/graveyardkeeper/mods/34]Alchemy Research[/url] by [url=https://www.nexusmods.com/graveyardkeeper/users/73074048]UrbanVibes[/url].[/size]
[*][size=3]Shows a preview of a mix of ingredients when using the alchemy mixers if you've learnt/researched something with those materials.[/size]
[*][size=3]Recipes already learnt/researched are added to your known recipes so that you don't have to manually craft once for it to appear in the preview.[/size]
[/list]
...
[size=3][url=https://github.com/p1xel8ted/Game-Mods/tree/main/Graveyard%20Keeper/src/AlchemyResearchRedux]GitHub[/url][/size]