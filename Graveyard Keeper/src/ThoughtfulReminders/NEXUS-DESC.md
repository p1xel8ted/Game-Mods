...
[list]
[*][size=3]When the day changes over (a little after technically), the keeper will have thought about what day it is and any special events. You can toggle the events part on and off in the config.[/size]
[*][size=3]You can choose between thought bubbles or floaty text.[/size]
[*][size=3]The thought is triggered just as NPCs are exiting their homes to go about their day.[/size]
[/list]

[size=3][b]Languages[/b]
...
**The game doesn't support the font for these languages for the standard floaty text, so users using these languages will get speech bubbles instead.[/size]
...
[size=3][url=https://github.com/p1xel8ted/Game-Mods/tree/main/Graveyard%20Keeper/src/ThoughtfulReminders]GitHub[/url][/size]