...
[list]
[*][size=3]Allows you to use the Left and Right triggers to set the craft amount to minimum and maximum.[/size]
[*][size=3]Allows you to use the Left and Right triggers in the vendor item price window will set the amount to maximum/minimum.[/size]
[/list]
[size=4][b]Note[/b][/size]

[size=3]Large values will cause the game to appear to hang. This is the game, not the mod.[/size]
...
[size=3][url=https://github.com/p1xel8ted/Game-Mods/tree/main/Graveyard%20Keeper/src/MaxButtonControllerSupport]GitHub[/url][/size]