...
{
    public static bool GerryCinematicPlaying { get; set; }
    ...
    public static float TimeOfDayFloat => TimeOfDay.me == null ? 0f : TimeOfDay.me.GetTimeK();
    ...
    public static void TalkingToNpc(bool setTalkingToNpc)
    {
