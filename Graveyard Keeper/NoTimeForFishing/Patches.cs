...
public static class Patches
{
    ...
    public static void FishingGUI_UpdateWaitingForBite_Prefix(ref FishingGUI __instance) //, ref float ____waiting_for_bite_delay)
    {
        __instance._waiting_for_bite_delay = 0f;
