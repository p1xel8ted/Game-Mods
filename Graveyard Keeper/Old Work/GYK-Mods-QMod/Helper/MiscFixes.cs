...
namespace Helper
{
    ...
    internal class MiscFixes
    {
        ...
        [HarmonyPrefix]
        [HarmonyPatch(typeof(DynamicLights), nameof(DynamicLights.SearchForLightsInNewObject), typeof(GameObject))]
        public static bool DynamicLights_SearchForLightsInNewObject(ref GameObject go)
        {
            ...
            Parallel.ForEach(go.GetComponentsInChildren<Light>(true), light =>
            {
                ...
                if (groundLight != null)
                {
                    DynamicLights._lights_ground.Add(light);
                ...
                else
                {
                    ...
                    if (dynamicLight != null)
                    {
                        ...
                        DynamicLights._lights_default.Add(light);
