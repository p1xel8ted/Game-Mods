namespace AlchemyResearchRedux
{
    public class AlchemyRecipe
    {
        ...
        // public string WorkstationObjectID { get; set; } = string.Empty;
        ...
        // private static bool IsEmptyOrNull(string value)
        // {
        //     return string.IsNullOrEmpty(value) || value == string.Empty;
        // }
        //
        // private static bool AreGooItems(string item1, string item2)
        // {
        //     return item1.StartsWith("goo_") && item2.StartsWith("goo_");
        // }
